...
For more information on the schedule types, refer to the <a href="https://www.rudderstack.com/docs/cloud-extract-sources/destination-settings/">Destination Settings</a> guide.
</div>
