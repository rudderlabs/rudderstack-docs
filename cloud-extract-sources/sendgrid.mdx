...
- **Table prefix**: RudderStack uses this prefix to create a table in your data warehouse and load all your Sendgrid data into it.
- **Schedule Settings**: Select your schedule type. RudderStack gives you three options to ingest the data from Sendgrid:
    - **Basic**: RudderStack runs the syncs at the specified time interval. 
    - **CRON**: RudderStack runs the syncs based on the user-defined CRON expression.
    - **Manual**: You are required to run the syncs manually.

<div class="infoBlock">

For more information on the schedule types, refer to the <a href="#faq">FAQ</a> section below.
</div>
...
Sendgrid is now configured as a source. RudderStack will start ingesting data from Sendgrid as per the specified schedule. 
