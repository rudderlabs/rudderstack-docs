...
For more details, refer to the Intercom [**support page**](https://help-desk-migration.com/help/get-intercom-personal-access-tokens/).
...
If you come across any issues while configuring Intercom as a source in RudderStack, you can [**contact us**](mailto:%20docs@rudderstack.com) or start a conversation in our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) community.
