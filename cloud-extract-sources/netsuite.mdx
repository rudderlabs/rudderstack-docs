...
This document guides you in setting up NetSuite as a source in RudderStack. Once configured, RudderStack automatically ingests your specified NetSuite data, which can then be routed to your RudderStack-supported data warehouse destination.
...
You will also need to enable token-based authentication for your NetSuite account in order to generate tokens and authenticate the [SuiteTalk API](https://www.netsuite.com/portal/developers/resources/suitetalk-documentation.shtml).
...
<img src="../assets/cloud-extract-sources/netsuite-settings-3.png" alt="Consume key/token in Netsuite" />
...
<img src="../assets/cloud-extract-sources/netsuite-settings-6.png" alt="Adding an employee in Netsuite" />
...
<img src="../assets/cloud-extract-sources/netsuite-settings-9.png" alt="Account ID in Netsuite" />
...
<img src="../assets/cloud-extract-sources/netsuite-settings-12.png" alt="Selecting import data" />
