...
<img src="../assets/cloud-extract-sources/netsuite-settings-1.png" alt="Token based Authentication in Netsuite" />

### Creating an integration

Next, create an integration record for RudderStack to uniquely identify RudderStack in your NetSuite account.

<img src="../assets/cloud-extract-sources/netsuite-settings-2.png" alt="New integration in Netsuite" />
