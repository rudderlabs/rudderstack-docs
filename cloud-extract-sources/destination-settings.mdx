...
description: >-
 Detailed technical description of the different destinations settings for configuring the Cloud Extract sources.
---

# Destination Settings

This guide details the common destination settings to be configured while setting up your Cloud Extract sources.
...
RudderStack uses your specified table prefix to create a table in your data warehouse and load all your Sendgrid data into it.

<div class="infoBlock">

If you do not specify this field, RudderStack sets the source name as the table name, by default.
</div>
