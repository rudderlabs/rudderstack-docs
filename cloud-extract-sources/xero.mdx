...
<img src="../../../images/assets/2 (14).png" alt="Select Xero" />

- Assign a name to your source, and click on **Next**.

<img src="../../../images/assets/3 (12).png" alt="Assign a name" />

### Setting Up the Connection

- Under **Create new account**, click on **Connect with Xero** and authenticate RudderStack with your Xero account.

<img src="../../../images/assets/screen-shot-2021-02-23-at-6.27.30-pm.png" alt="Connect with Xero" />
...
<img src="../../../images/assets/screen-shot-2021-02-23-at-6.27.16-pm.png" alt="Report Starting Month" />
...
<img src="../../../images/assets/screen-shot-2021-02-23-at-6.27.53-pm.png" alt="Sync Starting At" />

### Selecting the Data to Import

- Finally, select the appropriate data columns to import. To import all the data, simply click on **Select All**.

<img src="../../../images/assets/screen-shot-2021-02-23-at-6.28.10-pm.png" alt="Select All" />
...
<img src="../../../images/assets/screen-shot-2021-02-23-at-6.28.27-pm.png" alt="Add Destinations" />
