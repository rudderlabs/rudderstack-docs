...
If you have already connected RudderStack to your Google Ads account, your credentials should appear automatically under <strong>Choose an account</strong>.
</div>
...
- **Custom GAQL Queries**: Enter the custom GAQL query you used for building the report. 
    - **Custom Query**: Enter your custom GAQL query here.
