...
<img src="../assets/cloud-extract-sources/g-ads-connection-settings-3.png" alt="Connection settings" />

- - **Custom GAQL Queries**: This widget lets you create custom GAQL query for building a report. 
    ...
    You can observe your custom GAQL query displayed in the query box as you select the relevant options from the dropdown. You can also use the **Reset** and **Edit query** buttons to reset the query or change the query respectively.
