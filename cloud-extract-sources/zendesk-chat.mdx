...
<img src="../assets/2 (13).png" alt="Cloud Sources" />

- Assign a name to your source, and click on **Next**.

<img src="../assets/3 (9).png" alt="Assign a name" />
...
<img src="../assets/4 (11).png" alt="Connect with Zendesk Chat" />
...
<img src="../assets/5 (12).png" alt="Sync Starting At" />
...
<img src="../assets/6 (11).png" alt="Select data to import" />
...
<img src="../assets/7 (8).png" alt="Add Destination" />
...
If you come across any issues while configuring Zendesk Chat as a source on the RudderStack dashboard, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation in our [Slack](https://rudderstack.com/join-rudderstack-slack-community) community; we will be happy to talk to you!
