...
<div class="infoBlock">
  ...
  To get your Zendesk subdomain, go to the **Admin Center** and click on the **Account** icon. You will find your Zendesk subdomain under **Appearance** - **Branding** - **Subdomain** section. For more information, check the FAQs below.
</div>
