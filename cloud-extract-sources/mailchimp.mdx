...
<!--<img src="../assets/2 (20).png" />-->

<img src="../assets/2 (20).png" alt="Directory" />
...
<img src="../assets/3 (18).png" alt="Mailchimp" />

### Specifying Connection Credentials

- Next, click on the **Connect with Mailchimp** option, as shown:

<!--<img src="../assets/4 (17).png" />-->

<img src="../assets/4 (17).png" alt="Connect with Mailchimp" />
...
<!--<img src="../assets/5 (18).png" />-->

<img src="../assets/5 (18).png" alt="Authorize RudderStack" />
...
<!--<img src="../assets/6 (16).png" />-->

<img src="../assets/6 (16).png" alt="Earliest Campaign Year" />
...
<img src="../assets/7 (11).png" alt="Google Analytics" />
...
<img src="../assets/8 (5).png" alt="Ingest via RudderStack" />
...
<img src="../assets/9 (3).png" alt="Add Destinations" />
...
If you come across any issues while configuring Mailchimp as a source on the RudderStack dashboard, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation in our [Slack](https://rudderstack.com/join-rudderstack-slack-community) community; we will be happy to talk to you!
