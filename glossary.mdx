...
Setting up a connection involves adding a [source](https://www.rudderstack.com/docs/rudderstack-cloud/sources/#adding-a-source) and [destination](https://www.rudderstack.com/docs/rudderstack-cloud/destinations/#adding-a-destination) in RudderStack.
