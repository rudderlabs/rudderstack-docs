...
You can view the live events for the cloud mode destinations only. For more information, refer to the <a href="https://www.rudderstack.com/docs/connections/rudderstack-connection-modes/">Connection Modes</a> guide.
</div>
