...
This feature is available only in <a href="https://app.rudderstack.com/signup?type=freetrial">RudderStack Cloud</a>.
</div>

<div class="warningBlock">

You can view the live events for the cloud mode destinations only. For more information on sending events via the cloud mode, refer to the <a href="https://www.rudderstack.com/docs/connections/rudderstack-connection-modes/">Connection Modes</a> guide.
</div>
