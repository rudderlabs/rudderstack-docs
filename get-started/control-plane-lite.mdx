...
* Export the workspace configuration from the dashboard by following the steps in the [**Exporting Workspace Configuration**](https://rudderstack.com/docs/rudderstack-open-source/control-plane-lite/#exporting-workspace-configuration) section above.
...
* Once you have completed these steps above successfully, [**send test events**](https://www.rudderstack.com/docs/get-started/installing-and-setting-up-rudderstack/sending-test-events/) to verify the installation.
...
In case you come across any issues while setting up your self-hosted control plane using Control Plane Lite, you can [**contact us**](mailto:%20docs@rudderstack.com) or start a conversation in our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) community.
