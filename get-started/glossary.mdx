...
For more information on the RudderStack event spec, refer to [event spec](https://rudderstack.com/docs/rudderstack-api/api-specification/rudderstack-spec/) guide.
...
For more information on this feature, refer to the [documentation](https://rudderstack.com/docs/rudderstack-cloud/teammates/).
