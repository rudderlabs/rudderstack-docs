...
6. From the list of destinations, choose the destination you want to configure for the source. RudderStack currently supports over 150 destinations, including [event stream](https://www.rudderstack.com/docs/destinations/) and [warehouse](https://www.rudderstack.com/docs/data-warehouse-integrations/) destinations.
