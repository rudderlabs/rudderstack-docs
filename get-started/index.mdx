...
2. Click on **Add Source** to set up a data source.
...
4. Add destination by clicking on **Add Destination** > **Create New Destination**. 
...
The connection between JavaScript source and Google Analytics destination  will look like below in the 'Connections' option:

<img src="../assets/general/connection.png" alt="Connection on RudderStack dashboard" />

## See also

- [**RudderStack Cloud**](https://rudderstack.com/docs/rudderstack-cloud/) - Know more about sources, destinations, and connections
- [**Live Events**](https://rudderstack.com/docs/rudderstack-cloud/live-events/) - Verify data flowing through RudderStack in real-time
...
- [**Send Data in 5 Minutes Using RudderStack**](https://rudderstack.com/blog/how-to-send-data-in-5-minutes-using-rudderstack/)
