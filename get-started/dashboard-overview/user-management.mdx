...
Refer to the <a href="https://rudderstack.com/pricing/">RudderStack Pricing</a> page for the complete list of the supported features or <a href="http://app.rudderstack.com/upgrade">log in</a> to upgrade now.
</div>

## Inviting a user in the workspace

To invite a user in your current workspace, follow these steps:

- Click on the **Teammates** option in the left navigation bar and click on **Invite Teammate**, as shown:
...
| Role | Description |
| :----| :-----------|
| View-only | This user has read-only access to all the options in the workspace. |
| Read-write | This user has complete access to all the RudderStack workspace options included in the plan except team management (adding / removing users and modifying user permissions). |
| Admin | This user has complete access to all the RudderStack features and options as a part of the plan, including team management. |
...
Refer to the following guides to learn more about these features:
<li>
...
- Cannot sync the Cloud Extract and Reverse ETL sources
...
Refer to the following guides for more information on these options:
<li><a href="https://rudderstack.com/docs/connections/">Connections</a></li>
<li><a href="https://rudderstack.com/docs/transformations/">Transformations</a></li>  
</div>
...
- Can sync the Cloud Extract and Reverse ETL sources
- Can view all the details related to the sync, including the history of the syncs.
