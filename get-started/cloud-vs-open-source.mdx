...
| Maintaining event ordering | ✓ |  ✓ | <ul><li>For Cloud, this is an [Enterprise-only](https://www.rudderstack.com/enterprise-quote/) feature.</li><li>In an open source, multi-node setup, event ordering is supported but **not guaranteed**.</li></ul> |
