...
| Feature |  RudderStack Cloud | RudderStack Open Source | Comments |
| :--------| :-------------------| :--------------------------| :-----| 
| Ability to add other team members in the workspace | ✓ |  ✕  |  You can invite 3 members in your workspace in case of  [RudderStack Cloud Free](https://app.rudderstack.com/signup?type=freetrial), where 
