...
| :--------| :-------------------| :--------------------------| :-----|
| [Data plane setup](https://www.rudderstack.com/docs/rudderstack-open-source/installing-and-setting-up-rudderstack/) in your own environment |  ✕ |  ✓ | Cloud uses the RudderStack-hosted [data plane](https://www.rudderstack.com/docs/glossary/#data-plane). | 
