...
- Once added successfully, configure this plugin using the source write key and RudderStack server URL that you copied above. The default RudderStack server URL is configured to `https://hosted.rudderlabs.com`. Append **`v1/batch`** to this URL, as shown:
