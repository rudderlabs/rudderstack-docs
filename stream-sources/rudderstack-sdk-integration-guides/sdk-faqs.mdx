...
Yes, you can use the [Event filtering tool](https://www.rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/event-filtering/) to specify which events should be discarded or allowed to flow through by whitelisting or blacklisting them from the UI.
