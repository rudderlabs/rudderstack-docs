...
For a detailed explanation of the <code class="inline-code">identify</code> call, please refer to our <a href="https://rudderstack.com/docs/rudderstack-api/rudderstack-spec/identify/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">screen</code> call, please refer to our <a href="https://rudderstack.com/docs/rudderstack-api/rudderstack-spec/screen/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">group</code> call, please refer to our <a href="https://rudderstack.com/docs/rudderstack-api/rudderstack-spec/group/">RudderStack API Specification</a> guide.
...
For a detailed explanation of the <code class="inline-code">alias</code> call, please refer to our <a href="https://rudderstack.com/docs/rudderstack-api/rudderstack-spec/alias/">RudderStack API Specification</a> guide.
