...
You need to call <code class="inline-code">putAnonymousId</code> method before calling <code class="inline-code">getInstance</code>
...
On `Android` device you need to call <code class="inline-code">putAdvertisingId</code> method before calling <code class="inline-code">getInstance</code>
