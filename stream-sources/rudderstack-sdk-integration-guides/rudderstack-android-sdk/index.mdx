...
You can check the [GitHub codebase](https://github.com/rudderlabs/rudder-sdk-android) to get a more hands-on understanding of the SDK's architecture and working.
...
<img src="../../../../../images/assets/android-1.png" alt="writeKey" />
...
**As Bintray has a sunset from 1st may, we're moving our SDK to Maven Central. All versions, 1.0.10 onwards are available in Maven Central only.**
