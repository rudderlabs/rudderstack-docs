...
<img src="../../../assets/android-1.png" alt="writeKey" />
...
## Instructions for using SDK on applications that have <code class="inline-code">minSDKVersion</code> less than <code class="inline-code">20</code>

Rudder Server has been updated to <code class="inline-code">TLSv1.2+</code> and thus the SDK won't be able to support applications with <code class="inline-code">minSDKVersion</code> less than <code class="inline-code">20</code> by default. Please follow the below steps to add the support.

- Add the below dependency to the <code class="inline-code">build.gradle</code> file of your application.

```groovy
implementation 'com.google.android.gms:play-services-base:17.6.0'
```

- Add the function <code class="inline-code">tlsBackport()</code> in your <code class="inline-code">MainActivity</code> as shown below:
...
- Call the function <code class="inline-code">tlsBackport()</code> in the very beginning of your <code class="inline-code">onCreate()</code> method in the <code class="inline-code">MainActivity</code> as shown below:
...
For more details, please refer <a href="https://developer.android.com/reference/javax/net/ssl/SSLSocket.html#protocols">here</a>.
