...
The **RudderStack Android SDK** lets you track event data from your Android applications and send it to a variety of destinations.
...
If you come across any issue while using the Android SDK, you can open a new issue on our [**GitHub Issues page**](https://github.com/rudderlabs/rudder-sdk-android/issues).
