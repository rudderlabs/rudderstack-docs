...
RudderStack supports integrating the Android SDK with your Cast app. Follow <a href="https://developers.google.com/cast/docs/android_sender">these instructions</a> to build your Android sender app and add the Android SDK to it.
</div>
