...
- A `sender application` written for the Android platform.
...
- Finally, add the `RudderStack's Android SDK` in your Sender app.

<div class="infoBlock">

For `Default Media Receiver` app provide the following appID: `CastMediaControlIntent.DEFAULT_MEDIA_RECEIVER_APPLICATION_ID` in your Android Sender app. For more details refer to [Cast](https://developers.google.com/cast/docs/web_receiver#default_media_web_receiver) support.
