...
For a detailed information on each of these calls, refer to our [**RudderStack API Specification**](https://rudderstack.com/docs/rudderstack-api/api-specification/rudderstack-spec/) guide.
