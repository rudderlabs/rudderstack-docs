...
To flush your events on demand and make sure no events are left in the queue, you can use the SDK's `flush()` method.
...
This method blocks any new events until all the messages are flushed from the queue. Hence, you should avoid using it as a part of your request lifecycle.
</div>
