...
- Once signed up, set up a Python source in the dashboard. For more information, follow [**this guide**](https://rudderstack.com/docs/rudderstack-cloud/connections/). You should then see a **Write Key** for this source, as shown below:
