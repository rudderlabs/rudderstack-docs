...
<img src="https://img.shields.io/pypi/v/rudder-sdk-python.svg?style=flat" />
</a>
...
- Once signed up, set up a Python source in the dashboard. For more information, follow [**this guide**](https://www.rudderstack.com/docs/rudderstack-cloud/sources/#adding-a-source). You should then see a **Write Key** for this source, as shown below:
