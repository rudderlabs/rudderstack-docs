...
The **RudderStack React Native SDK** allows you to track event data from your React Native applications and send it to your preferred destinations supported by RudderStack.
...
If you come across any issue while using the React Native SDK, you can open a new issue on our [**GitHub Issues page**](https://github.com/rudderlabs/rudder-sdk-react-native/issues/new).
