...
You can also enable the automatic recording of screen views by passing <code class="inline-code">recordScreenViews</code> as <code class="inline-code">true</code> while initializing the <code class="inline-code">rudderClient</code>.  
The default value for <code class="inline-code">recordScreenViews</code> is <code class="inline-code">false</code>. 

To track the screen views in React Native SDK, you can use the following code snippet: 
