...
The <code class="inline-code">recordScreenViews</code> parameter records the screen views via the native Android <a href="https://developer.android.com/guide/components/activities/intro-activities" target="_blank">Activities</a> or the iOS <a href="https://developer.apple.com/documentation/uikit/view_controllers" target="_blank">View Controllers</a> only and <strong>not</strong> by the React Native SDK. 
</div>  

To track the screen views via the SDK, you can use the following code snippet:
