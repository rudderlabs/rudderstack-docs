...
<img src="../../../../images/assets/react-native(1).png" />
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        Fetches the config from <code class="inline-code">dashboard</code> after the specified
        time.
      </td>
      <td style="text-align:left">
        <code class="inline-code">2 hours</code>
      </td>
    </tr>
    <tr>
      <td style="text-align:left">
