...
<a href="https://rubygems.org/gems/rudder_analytics_sync" target="_blank" align="left">
<img src="https://img.shields.io/gem/v/rudder_analytics_sync.svg?style=flat" alt="Github Badge" class="githubBadge" />
</a>
...
- Once signed up, set up a Ruby source in the dashboard. For more information, follow [**this guide**](https://rudderstack.com/docs/connections/adding-source-and-destination-rudderstack/). You should then see a **Write Key** for this source, as shown below:
