...
This feature can be used for all the RudderStack destinations that support sending events via the [**device mode**](https://rudderstack.com/docs/connections/rudderstack-connection-modes/#device-mode)</a>.

<div class="infoBlock">

Event filtering is applicable only for <code class="inline-code">track</code> calls. In case of mobile SDKs, it also applies to the following application lifecycle events:
  <ul>
