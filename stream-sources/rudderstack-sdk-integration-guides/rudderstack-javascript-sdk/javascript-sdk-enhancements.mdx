...
The JavaScript SDK hosted at [**https://cdn.rudderlabs.com/v1/rudder-analytics.min.js**](https://cdn.rudderlabs.com/v1/rudder-analytics.min.js) sends the event payload using the **XHR** \(XMLHttpRequest\) API. 
