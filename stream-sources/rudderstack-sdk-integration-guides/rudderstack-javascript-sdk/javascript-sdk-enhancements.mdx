...
<div class="warningBlock">
  ...
  The <code class="inline-code">sendBeacon</code> version of the RudderStack JavaScript SDK located at <a href="https://cdn.rudderlabs.com/v2/rudder-analytics.min.js?transport=beacon">https://cdn.rudderlabs.com/v2/rudder-analytics.min.js?transport=beacon</a> and its XMLHTTP version - <a href="https://cdn.rudderlabs.com/v2/rudder-analytics.min.js">https://cdn.rudderlabs.com/v2/rudder-analytics.min.js?transport=beacon</a> is <strong>not supported</strong> anymore. 
</div>
