...
It is recommended to use the snippets mentioned above to use the JavaScript SDK with your website. However, you can also use this [**NPM module**](https://www.npmjs.com/package/rudder-sdk-js) with the new JavaScript SDK v1.1 architecture to package RudderStack directly into your project.
