...
While it is recommended to use the above-mentioned snippets to use the JavaScript SDK with your website, you can also use the [**NPM module**](https://www.npmjs.com/package/rudder-sdk-js) with the new SDK(v1.1) architecture to package RudderStack directly into your project where the integrations will be loaded dynamically.
