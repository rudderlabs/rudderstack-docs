...
| `test_rudder_cookie`      | Checks whether the cookie can be accessed or not. Once checked, the cookie is removed immediately.  |  `test_rudder_cookie:true` | Cleared automatically. |
