...
| `test_rudder_cookie`      | Checks whether the cookie can be accessed or not. Once checked, this cookie is removed immediately.  |  `test_rudder_cookie:true` | Cleared automatically. |
