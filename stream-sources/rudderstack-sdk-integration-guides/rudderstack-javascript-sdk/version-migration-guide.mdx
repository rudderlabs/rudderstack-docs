...
A visual representation of the structure above is as shown:
...
|:---------------------|:--------------------------------------------------------------------------|
| HubSpot              | https://cdn.rudderlabs.com/v3/js-integrations/HubSpot.min.js              |
...
| Braze                | https://cdn.rudderlabs.com/v3/js-integrations/Braze.min.js                |
