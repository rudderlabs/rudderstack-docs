...
<div class="infoBlock">
  ...
  Calling <code class="inline-code">reset()</code> or identifying a <code class="inline-code">userId</code> with the new traits will reset the earlier traits and update them with the new values.
</div>
