...
You can also use the NPM module with the new SDK(v1.1) architecture to package RudderStack directly into your project. For more information, refer to the <a href="https://www.rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/quick-start-guide/#alternative-installation-using-npm">Installation using NPM</a> section.
</div>
