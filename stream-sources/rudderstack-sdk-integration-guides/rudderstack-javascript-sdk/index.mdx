...
#### Capture anonymous ID automatically 
...
<div class="infoBlock">
  ...
  If the RudderStack `anonymousId` is already set in your browser, then <code class="inline-code">anonymousIdOptions</code> will not take effect.
</div>
