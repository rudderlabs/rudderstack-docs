...
- A `sender application` written for the Cast-supported web platform.
...
- Finally, add the `RudderStack's JavaScript SDK` in your Sender app.

<div class="infoBlock">

For `Default Media Receiver` app provide the following appID: `chrome.cast.media.DEFAULT_MEDIA_RECEIVER_APP_ID` in your Web Sender app. For more details refer to [Cast](https://developers.google.com/cast/docs/web_receiver#default_media_web_receiver) support.
