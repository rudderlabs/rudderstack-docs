...
RudderStack supports integrating the Android SDK with your Cast app. Follow <a href="https://developers.google.com/cast/docs/web_sender">these instructions</a> to build your web sender app. Then, add the JavaScript SDK to it.
</div>
