...
<div class="infoBlock">
   Instructions for using RudderStack Flutter SDK version < 2<code class="inline-code">CONTROL_PLANE_URL</code> can be found <a href="https://docs.rudderstack.com/stream-sources/rudderstack-sdk-integration-guides/rudder-flutter-sdk/rudder-flutter-sdk-v1.mdx">here</a>.
</div>
...
On `Android` device you need to call <code class="inline-code">setAdvertisingId</code> method before calling <code class="inline-code">initialize</code>
