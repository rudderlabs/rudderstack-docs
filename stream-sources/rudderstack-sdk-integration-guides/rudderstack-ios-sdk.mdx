...
<div class="successBlock">
  ...
  Starting from version <strong>1.1.0</strong>, the iOS SDK supports the <b>tvOS</b> platform.  You can now integrate the SDK with your tvOS apps and seamlessly track the user events seamlessly without the need for any additional configuration.
</div>
