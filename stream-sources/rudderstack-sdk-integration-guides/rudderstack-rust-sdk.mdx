...
Once added as the source, the event requests hit the RudderStack servers. RudderStack then routes the events to the destination platforms as configured by you.
