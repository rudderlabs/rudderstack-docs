...
- Once signed up, set up a Rust source in the dashboard. For more information, follow [**this guide**](https://rudderstack.com/docs/rudderstack-cloud/connections/). You should then see a **Write Key** for this source, as shown below:
  ...
  <ul>
    ...
    <li>
      ...
      <a href="https://rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/">
       ...
       via <a href="https://rudderstack.com/docs/rudderstack-connection-modes/#cloud-mode">
        cloud mode
      </a>)
    </li>
    <li>
