...
You need to call <code class="inline-code">setAnonymousId</code> before calling <code class="inline-code">getInstance</code>.
</div>
...
On iOS, you need to call the <code class="inline-code">putAdvertisingId</code> method before calling <code class="inline-code">getInstance()</code>.
</div>
