...
Not all the APIs provided in the Flutter SDK are applicable for the web. Refer to the 
</div>
...
This functionality is not available for the web. For more information, refer to the <a href="#flutter-sdk-api-not-available-for-web">Flutter SDK API not available for the web</a> section below.
</div>
...
- [`optOut`](#enablingdisabling-user-tracking-via-the-optout-api-gdpr-support)
