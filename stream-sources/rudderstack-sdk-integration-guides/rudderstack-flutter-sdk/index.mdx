...
If you are using an older version of the Flutter SDK (v1), then refer to <a href="https://rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-flutter-sdk/flutter-v1/">this</a> guide. <strong>Note that this SDK version will soon be deprecated.</strong>
</div>
