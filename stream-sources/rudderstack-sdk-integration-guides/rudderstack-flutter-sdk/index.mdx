...
| `isDebug` | - | - | - |
| `logLevel`              | `int`     | Controls the logs you want to see from the Flutter SDK.        | `RudderLogger.RudderLogLevel.NONE`                       |
| `mobileConfig` | - | - | Refer to the [`mobileConfig` parameters](#mobileconfig-parameters) section below. |
| `webConfig` | - | - | Refer to the [`webConfig` parameters](#mobileconfig-parameters) section below. |
