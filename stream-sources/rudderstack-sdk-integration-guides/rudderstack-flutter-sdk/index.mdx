...
If you are using an older version of the Flutter SDK (<1.2.0), then refer to <a href="https://rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-flutter-sdk/flutter-v1/">v1</a> guide. <strong>Note that this SDK version will soon be deprecated.</strong>
</div>
...
To install and use the Flutter SDK in your web app, you need to [add the RudderStack script](https://www.rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/quick-start-guide/#step-1-install-rudderstack-javascript-sdk) in the `<head>` section of your web page.

<div class="warningBlock">

Not all the APIs provided in the Flutter SDK are applicable for the web. Refer to the <a href="https://www.rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-flutter-sdk/#sdk-api-unavailable-for-web">SDK API unavailable for web</a> section for more information.
</div>
...
| `config`   | Object | Optional       | Contains the RudderStack client configuration. |
...
You can disable these events by calling <code class="inline-code">withTrackLifeCycleEvents(false)</code> on the <code class="inline-code">RudderConfigBuilder</code> object while initializing the RudderStack client. However, it is highly recommended to keep them enabled.
</div>
...
This functionality is not available for the web. For more information, refer to the <a href="https://www.rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-flutter-sdk/#sdk-api-unavailable-for-web">SDK API unavailable for web</a> section below.
</div>
...
### Passing destinations while initializing the SDK
...
### Passing destinations while making event calls
