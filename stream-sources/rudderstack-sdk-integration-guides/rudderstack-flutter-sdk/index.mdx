...
If you are using an older version of the Flutter SDK (v1), then refer to <a href="https://rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-flutter-sdk/flutter-v1/">this</a> guide.
</div>
...
<div class="infoBlock">
   The instructions for using the older RudderStack Flutter SDK versions (< v2) can be found <a href="https://docs.rudderstack.com/stream-sources/rudderstack-sdk-integration-guides/rudder-flutter-sdk/rudderstack-flutter-v1.mdx">here</a>.
</div>
...
You need to call <code class="inline-code">setAnonymousId</code> before calling <code class="inline-code">initialize</code>.
</div>
...
| `endPointUri`           | `string`  | Your data plane URL.                                                                                                                                                              | `https://api.rudderlabs.com` |
