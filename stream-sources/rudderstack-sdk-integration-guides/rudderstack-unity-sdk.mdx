...
The `screen` method lets you record your website's page views via users on their mobile screen. It also includes any additional relevant information about the screen.
