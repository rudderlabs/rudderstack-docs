...
Since the AMP source sends the data directly to the RudderStack backend, it supports only the cloud mode destinations. For more information on the cloud mode, refer to the <a href="https://rudderstack.com/docs/rudderstack-connection-modes/">RudderStack Connection Modes</a> guide.
</div>
...
Follow our <a href="https://rudderstack.com/docs/rudderstack-cloud/connections/">Adding a Source and Destination</a> guide for more information.
</div>
