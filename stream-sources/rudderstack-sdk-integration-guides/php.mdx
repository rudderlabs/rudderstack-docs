...
| **Protocol** | **Accepted Format**             | **SSL Option** | **SSL value** |
| :----------- | :------------------------------ | :------------- | :------------ |
| `https`      | `https://example.dataplane.com` | Optional       | true          |
| `https`      | `example.dataplane.com`         | Optional       | true          |
| `http`       | `http://example.dataplane.com`  | Required       | false         |
| `http`       | `example.dataplane.com`         | Required       | false         |
