...
RudderStack’s PHP SDK allows you to track your event data from your PHP applications and send it to your preferred destionations supported by RudderStack.
...
- Once signed up, set up an PHP source in the dashboard. For more information, follow [**this guide**](https://rudderstack.com/docs/connections/adding-source-and-destination-rudderstack/).  You should then see a **Write Key** for this source, as shown below:
...
RudderStack appends the HTTPS protocol to the data plane URL before sending the events to the server. For example if your data plane URL is <code class="inline-code">https://example.dataplane.com</code>, mention only <code class="inline-code">example.dataplane.com</code>.
</div>
...
For a detailed explanation of the <code class="inline-code">identify</code> call, refer to our <a href="https://rudderstack.com/docs/rudderstack-api/api-specification/rudderstack-spec/identify/">RudderStack API Specification</a> guide.
</div>
...
If you come across any issue while using the iOS SDK, you can open a new issue on our [**GitHub Issues page**](https://github.com/rudderlabs/rudder-php-sdk/issues/new).
