...
The **RudderStack .NET SDK** lets you track your customer event data from your .NET application and send the events to your preferred destinations supported by RudderStack.
...
Refer to <strong>The options parameter</strong> section below for more information on the <code class="inline-code">options</code> object and its fields.
</div>

## Track

The `track` call lets you record the user actions along with their associated properties. Each action is called an **event**.
...
If you come across any issue while using the .NET SDK, you can open a new issue on our [**GitHub Issues page**](https://github.com/rudderlabs/rudder-sdk-.net/issues/new).
