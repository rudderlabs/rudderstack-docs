...
<div class="successBlock">
  ...
  Starting from version <strong>1.1.0</strong>, the iOS SDK supports the <strong>tvOS</strong> platform. RudderStack also supports the <strong>watchOS</strong> platform starting from version <strong>1.3.0</strong>. You can now integrate the iOS SDK with your tvOS and watchOS apps and seamlessly track user events without the need for any additional configuration.
</div>
