...
- Once signed up, set up an iOS source in the dashboard. For more information, follow [**this guide**](https://rudderstack.com/docs/rudderstack-cloud/connections/).  You should then see a **Write Key** for this source, as shown below:
...
More information on the RudderStack device mode can be found in the <a href="https://rudderstack.com/docs/rudderstack-connection-modes/">RudderStack Connection Modes</a> guide.
</div>
