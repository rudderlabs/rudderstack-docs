...
[**Braze**](https://www.braze.com/) is an industry-leading customer engagement platform. It provides a cross-channel, data-driven platform to help you better understand your customers' in-app behavior and use the insights to improve your overall app experience, and increase engagement with them.
...
- Your Braze source is now configured. Note the source **Write key** - this will be required to configure the endpoint URL in the later steps.
...
The following table lists the properties included in the above-mentioned events:
