...
6. After installation, you should be able to see the app in the **Installed apps** section, as shown:
...
| :-----------------------------| :---------------------------| :-----------------------------|
| `customers_create`            | Customer is created.        | `customers/create`           | 
| `customers_update`            | Customer is updated.        | `customers/update`            | 
| `customers_disabled`          | Customer is disabled.       | `customers/disable`           | 
| `customers_enable`            | Customer is enabled.        | `customers/enable`            | 
...
| `orders_delete`               | Order was delted.           | `orders/delete`               |
...
For client-side tracking, RudderStack inserts a JavaScript tracking code into every page of the respective Shopify store.
</div>
