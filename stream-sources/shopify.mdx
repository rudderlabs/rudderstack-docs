...
- [**Log in**](https://apps.shopify.com/)  to your Shopify store.

- Search for RudderStack. On the app listing page, click on **Add app**.

- Install the app on your Shopify store.

<div class="infoBlock">

For more information on working with apps in Shopify, refer to this <a href="https://help.shopify.com/en/manual/apps/working-with-apps">Shopify help page</a>.
</div>
