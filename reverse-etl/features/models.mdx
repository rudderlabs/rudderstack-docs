...
<div class="infoBlock">
Once a model is created, you can use it to send the data from a warehouse source to a specified destination. For more information and detailed steps, refer to the <a href="https://www.rudderstack.com/docs/reverse-etl/common-settings/importing-data-using-models/">Importing Data using Models</a> guide.
</div>
