...
The upsert mode is supported for all destination connected to the above-mentioned Reverse ETL sources, except <a href="https://www.rudderstack.com/docs/destinations/advertising/fb-custom-audience/">Facebook Custom Audience</a>.
</div>
