...
You can create a model in the RudderStack dashboard and use it while connecting a Reverse ETL source to a destination. For detailed steps on how to create a model, refer to the <a href="https://www.rudderstack.com/docs/warehouse-actions/features/models/">Models</a> guide.
</div>
