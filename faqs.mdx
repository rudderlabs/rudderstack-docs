...
If you come across any issue that is not listed in this guide, feel free to start a conversation in our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) community.
</div>
...
* If you're using the **open-source** version of RudderStack, you are required to set up your own Data Plane by [**installing and setting up RudderStack**](https://rudderstack.com/docs/rudderstack-open-source/installing-and-setting-up-rudderstack/) in your preferred environment. 
...
Yes, you can use the [**Control Plane Lite**](https://rudderstack.com/docs/rudderstack-open-source/control-plane-lite/) utility to self-host the control plane and configure your sources and destinations. Refer to the **Control Plane Lite** section below for more information/FAQs.
...
#### 1. How do I add user transformations in RudderStack?

RudderStack lets you implement your own custom transformations that leverage the event data to implement specific use-cases based on your business requirements. To add transformations in RudderStack, follow this [**guide**](https://rudderstack.com/docs/transformations/#adding-a-transformation).

#### 2. Can I apply a transformation on a source configured in RudderStack?
