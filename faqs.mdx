...
title: "FAQ"
description: >-
  Answers to the generally asked questions about RudderStack - including the core functionality, setup, features, and more.
---
...
To get the data plane URL depending on your RudderStack plan:

* If you're using **RudderStack Open Source**, you are required to set up your own data plane by [installing and setting up RudderStack](https://rudderstack.com/docs/rudderstack-open-source/installing-and-setting-up-rudderstack/) in your preferred environment. 
...
* If you're using [RudderStack Cloud](https://app.rudderstack.com/signup?type=freetrial), the data plane URL is provided in the dashboard at the top of the **Connections** page.
* If you're using [RudderStack Pro/Enterprise](https://rudderstack.com/pricing), [contact us](https://rudderstack.com/join-rudderstack-slack-community) for the data plane URL with the email ID you used to sign up for RudderStack.
...
Go to the **Events** tab in the destination's page to see the event-related metrics, as shown below:
...
For more information, refer to the <a href="https://www.rudderstack.com/docs/transformations/api-access-token/">Personal Access Tokens</a> guide.
</div>
...
You can refer to the [Warehouse Schema](https://rudderstack.com/docs/data-warehouse-integrations/warehouse-schemas/) guide for details on how RudderStack generates the schemas in the warehouse.
