...
- Connecting / disconnecting an object with other objects. For example, source to destination, source to tracking plan, transformation to destination, model to reverse ETL source, etc.
