...
RudderStack Cloud users with <Link to="/dashboard-guides/teammates/#read-write-user">Read-Write</Link> or <Link to="/dashboard-guides/teammates/#admin">Admin</Link> permissions can create a personal access tokens in their workspace and use them.
