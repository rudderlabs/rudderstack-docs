---
title: "Audit Logs"
description: Track user activities in your RudderStack workspace audit logs.
---
...
For the audit logs related to a specific source or destination, you can go to the source/destination details page and click the **Audit Logs** option, as shown:
