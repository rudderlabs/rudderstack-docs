---
title: "Sources"
description: Configure your sources in RudderStack Cloud.
---
...
RudderStack classifies the sources into following
  ...
  <ul>
    <li>
      <Link to="/sources/event-streams/">Event Streams</Link>
    </li>
    <li>
...
- **Write Key**: Required to send the data from your source. For example, you can load the <Link to="/sources/event-streams/sdks/rudderstack-javascript-sdk/">RudderStack JavaScript SDK</Link> on your website to track and collect the events by running the following snippet:
