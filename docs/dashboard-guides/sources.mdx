...
RudderStack classifies the sources into following
  ...
  <ul>
    <li>
      <Link to="/sources/cloud-apps/">Cloud Apps</Link>
    </li>
    <li>
...
- **Write Key**: Required to send the data from your source. For example, you can load the <Link to="/sources/sdks/rudderstack-javascript-sdk/">RudderStack's JavaScript SDK</Link> on your website to track and collect the events by running the following snippet:
