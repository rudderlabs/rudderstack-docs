...
RudderStack's notifications feature lets you turn on data delivery alerts for sources, cloud destinations, and warehouse destinations. Users may subscribe/unsubscribe to alerts for a particular resource once your admin enables alerts for the resource.
