...
To enable the alerting service, you must have <Link to="/dashboard-guides/user-management/#role-permissions">admin permissions</Link>.
...
<div class="infoBlock">
The **Enable Notifications** option is only available to users with admin privileges.
</div>

## Manage alerts

To manage the individual alerts per connection, navigate to **Settings** > *Notifications*.
