...
description: Invite and set permissions for teammates in RudderStack Cloud.
---
...
Check <a href="https://rudderstack.com/pricing/">RudderStack pricing plans</a> for the complete list of the supported features or to upgrade your <a href="https://app.rudderstack.com/profile/billing">free plan</a>.
</div>
...
1. Click the **Settings** option in the left navigation bar. 
2. Select **Teammates** and click **Invite Teammate**.

<img src="../assets/rs-cloud/invite-teammates.png" />

3. Enter the **Email** and select the permissions you want to assign to the user. Then, click **Invite**.
...
| <Link to="/destinations/overview/">Destinations</Link> | Yes  | No  | No     | No     |
...
| <Link to="/destinations/overview/">Destinations</Link>    | Yes  | Yes | Yes    | Yes    |
