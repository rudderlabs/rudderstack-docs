...
6. Click on **Create New Transformation** if you want to add a <Link to="/features/transformations/">transformation</Link>. Otherwise, click **Continue** to configure the destination successfully.
