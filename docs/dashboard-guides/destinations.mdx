...
- **Syncs**: This tab gives you the metrics on all the data syncs associated with the different sources connected to the destination. These metrics include:
  - The source name
  - Name of the schema associated with the sync
  - Timestamp of the first event in the upload batch
  - Timestamp of the last event in the upload batch
