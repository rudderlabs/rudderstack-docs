...
It displays the general account settings like name, email and password. You can also change your account name and password, set up and enforce two-factor authentication.

You can also add a <Link to="/dashboard-guides/personal-access-token/">Personal Access Token</Link> required to use the RudderStack APIs.
