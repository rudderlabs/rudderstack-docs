---
title: "Live Events"
description: Use our Live Events feature to view your source and destination events in real-time.
---
...
<div class="warningBlock">
Your destination should be configured in cloud mode to view the live events.  Refer to the <Link to="/destinations/rudderstack-connection-modes/">Connection Modes</Link> guide for more information on cloud mode.
</div>
