...
Braze uses RudderStack's [Event Stream](https://www.rudderstack.com/docs/stream-sources/#rudderstack-event-streams) functionality to send events to RudderStack. These events can then be transformed and routed to your preferred destinations, including your data warehouse.
