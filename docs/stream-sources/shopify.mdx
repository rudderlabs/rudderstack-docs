...
- In the <Link to="/rudderstack-cloud/rudderstack-connection-modes/#cloud-mode">Connection Modes</Link>, RudderStack subscribes to the Shopify webhooks to consume data from Shopify. The data collected from Shopify web has the following signature in the payload:
