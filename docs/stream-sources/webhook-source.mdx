...
Add and test your webhook URL. You can use the <Link to="/rudderstack-cloud/live-events/#source-live-events">Live Events</Link> functionality to view the events tracked in real time.
</div>
