...
Follow our guide on <a href="https://rudderstack.com/docs/rudderstack-cloud/destinations/#adding-a-destination">Adding a Destination</a> for more details.
</div>
...
Remember to add and test your webhook URL. You can use the <Link to="/rudderstack-cloud/live-events/#source-live-events">Live Events</Link> functionality to view the events tracked in real time.
</div>
