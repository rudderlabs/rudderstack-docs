...
<img src="https://img.shields.io/nuget/v/RudderAnalytics.svg?style=flat" alt="Github Badge" class="githubBadge" />
</a>
...
- Once signed up, set up a .NET source in the dashboard. For more information, follow [**this guide**](https://www.rudderstack.com/docs/rudderstack-cloud/sources/#adding-a-source).  You should then see a **Write Key** for this source, as shown below:
