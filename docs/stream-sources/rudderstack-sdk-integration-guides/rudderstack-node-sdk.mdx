...
<a href="https://www.npmjs.com/package/@rudderstack/rudder-sdk-node" target="_blank" align="left">
<img src="https://img.shields.io/npm/v/@rudderstack/rudder-sdk-node.svg?style=flat" alt="Github Badge" class="githubBadge" />
</a>
...
- Once signed up, set up a Node.js source in the dashboard. For more information, follow [**this guide**](https://www.rudderstack.com/docs/rudderstack-cloud/sources/#adding-a-source). You should then see a **Write Key** for this source, as shown below:
