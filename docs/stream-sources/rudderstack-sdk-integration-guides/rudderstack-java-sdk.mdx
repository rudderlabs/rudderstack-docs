...
<a href="https://search.maven.org/search?q=a:rudderanalytics-client" target="_blank" align="left">
<img src="https://img.shields.io/maven-metadata/v.svg?label=Maven%20Central&metadataUrl=https%3A%2F%2Frepo1.maven.org%2Fmaven2%2Fcom%2Frudderstack%2Fsdk%2Fjava%2Frudderanalytics-client%2Fmaven-metadata.xml" alt="Github Badge" class="githubBadge" />
</a>
...
- Once signed up, set up a Java source in the dashboard. For more information, follow [**this guide**](https://www.rudderstack.com/docs/rudderstack-cloud/sources/#adding-a-source).  You should then see a **Write Key** for this source, as shown below:
