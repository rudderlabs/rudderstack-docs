...
RudderStack's client-side event filtering feature lets you specify which events should be discarded or allowed to flow through by allowlisting or blacklisting them.
...
If you choose the <strong>Allowlist</strong> option for event filtering, any events specified in the <strong>Blacklist</strong> field will be ignored.
</div>
...
If you choose the <strong>Blacklist</strong> option for event filtering, any events specified in the <strong>Allowlist</strong> field will be ignored.
</div>
