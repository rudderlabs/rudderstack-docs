...
The latest version of **JavaScript SDK (v1.1)** is lightweight, efficient, and optimized when compared to v1:

|Features|v1.1|v1|
|---------|--|----|
|Size|34 KB<sup>*</sup>|114 KB<sup>*</sup>|
|[Device mode]() destination SDKs|Loaded dynamically as per the source configuration in the dashboard.| Bundled with the core SDK.|

<div class="infoBlock">
The SDK size may vary in the future as more functionalities are added.
</div>
