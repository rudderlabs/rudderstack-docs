...
<strong>This documentation is written for the iOS SDK v1.6.0 and below</strong>. <br /><br />
...
You can also integrate the iOS SDK with your tvOS and watchOS apps and seamlessly track user events without any additional configuration. 

The SDK supports tvOS starting from version <strong>1.1.0</strong>. watchOS is supported starting from the SDK version <strong>1.3.1</strong>.
</div>
