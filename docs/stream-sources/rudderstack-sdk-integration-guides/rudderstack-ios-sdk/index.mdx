...
iOS SDK supports the `flush()` API. It retrieves all the messages present in the database, divides them into individual batches and flushes them to the Rudder Server.
