...
[option putIntegrationWithFactory:[<RudderIntegrationFactory> instance] isEnabled:<BOOLEAN>];
```
</span>
      </TabPanel>
      <TabPanel>
...
option.putIntegration(with: <RudderIntegrationFactory>.instance(), isEnabled:<BOOLEAN>);
```
</span>
      </TabPanel>
    </TabPanels>
