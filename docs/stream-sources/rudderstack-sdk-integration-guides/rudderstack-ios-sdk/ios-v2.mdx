...
The **RudderStack iOS SDK** lets you track your customer event data from your iOS, macOS, tvOS, and watchOS applications and send it to your specified destinations via RudderStack.

<div class="infoBlock">

<ul>
  <li>tvOS is supported starting from <strong>v1.1.0</strong></li>
  <li>watchOS is supported from <strong>v1.3.1</strong></li>
  <li>macOS is supported from <strong>v2.0.0</strong></li>
</ul>
</div>
