...
With the iOS SDK, you need not call the individual destination's API in your app to implement the push notifications support; calling the SDK's push notification APIs is sufficient.
