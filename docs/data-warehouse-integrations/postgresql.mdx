...
Refer to the <a href="https://rudderstack.com/docs/data-warehouse-integrations/warehouse-schemas/">Warehouse Schemas</a> guide for more information on how the events are mapped to the PostgreSQL tables.
</div>
...
<div class="infoBlock">
With the JSON columns feature, you can now ingest semi-structured event data not defined by a fixed schema. For more information on this feature, refer to the <Link to="/data-warehouse-integrations/json-column-support/">JSON Column Support</Link> guide.
</div>
...
If your deployment is in the EU region, you can allowlist only the following two IPs:
<ul>
<li>3.66.99.198</li>
<li>3.64.201.167</li>
</ul>
...
- Make sure you have set up the [required user permissions](https://rudderstack.com/docs/data-warehouse-integrations/postgresql#setting-user-permissions-in-postgresql) for your PostgreSQL instance.
- Check if your database is accessible to RudderStack by [allowlisting the RudderStack IPs](#ips-to-be-allowlisted).
