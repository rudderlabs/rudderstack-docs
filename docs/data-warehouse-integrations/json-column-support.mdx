...
| BigQuery | String | <ul><li>[Documentation](https://cloud.google.com/bigquery/docs/reference/standard-sql/json_functions)</li><li><Link to="#how-can-i-use-the-json-column-feature-in-bigquery">FAQ</Link></li></ul> |
