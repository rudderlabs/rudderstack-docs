...
If the above steps take too long to complete, you can halt the warehouse operations in the interim. For more information, refer to this <Link to="/data-warehouse-integrations/warehouse-faqs/#how-do-i-avoid-lags-in-data-syncs-while-heavy-loads-are-running-on-my-datawarehouse">FAQ</Link>.
</div>
