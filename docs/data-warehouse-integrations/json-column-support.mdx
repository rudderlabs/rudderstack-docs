...
| Warehouse | Reference |
| :-----------| :----------|
| Redshift | [Documentation](https://docs.aws.amazon.com/redshift/latest/dg/r_SUPER_type.html) |
| BigQuery | <ul><li>[Documentation](https://cloud.google.com/bigquery/docs/reference/standard-sql/json_functions)</li><li><Link to="#how-can-i-use-the-json-column-feature-in-bigquery">FAQ</Link></li></ul> |
| PostgreSQL | [Documentation](https://www.postgresql.org/docs/current/datatype-json.html) |
| Snowflake | [Documentation](https://docs.snowflake.com/en/sql-reference/data-types-semistructured.html#variant) |
