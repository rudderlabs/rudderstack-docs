...
| Second sync onwards   | ABC | XYZ | SS | ABC | The namespace, source name and customDataset prefix have been modified. The namespace is given priority and set as the schema name.|
