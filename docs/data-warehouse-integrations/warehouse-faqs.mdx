...
<table>
  ...
  <tr>
    <td style="width: 50%;"><code class="inline-code">RSERVER_WAREHOUSE_REDSHIFT_MAX_PARALLEL_LOADS</code></td>
  ...
  <tr>
    <td style="width: 50%;"><code class="inline-code">RSERVER_WAREHOUSE_STAGING_FILES_BATCH_SIZE</code></td>
  ...
  <tr>
    <td style="width: 50%;"><code class="inline-code">RSERVER_WAREHOUSE_NO_OF_WORKERS</code></td>
   ...
   <tr>
    <td style="width: 50%;"><code class="inline-code">warehouse_slave.replicaCount</code></td>
   ...
   <tr>
    <td style="width: 50%;"><code class="inline-code">RSERVER_WAREHOUSE_NO_OF_SLAVE_WORKER_ROUTINES</code></td>
