...
To set up an Azure Synapse Analytics user, you require an Azure subscription for the SQL Data Warehouse. Additionally, you need to [create a schema (dedicated SQL pool)](https://docs.microsoft.com/en-us/azure/synapse-analytics/sql-data-warehouse/create-data-warehouse-portal) in Azure Synapse. 
