...
description: Configure your tracking plan with our tracking plan spreadsheet.
---
...
3. Click the **RudderStack Tracking Plan** > **Create Tracking Plan from Existing Source Events** option in the top bar to create a new Tracking Plan.
...
3. Click **RudderStack Tracking Plan** > **Download Tracking Plan from RudderStack** in the top bar. 
