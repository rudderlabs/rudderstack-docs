...
<div class="infoBlock">
Currently, RudderStack supports identity resolution only for the <Link to="/destinations/warehouse-destinations/bigquery/">Google BigQuery</Link> and <Link to="/destinations/warehouse-destinations/snowflake/">Snowflake</Link> warehouse destinations.
</div>
