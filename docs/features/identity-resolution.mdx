...
If you are using the merge call **for warehouse operations**, not to worry: it will continue to work for the foreseeable future. We would encourage you to consider joining our upcoming beta program for user profiles when available in 2023. Contact your RudderStack Account Manager for details.
</div>
