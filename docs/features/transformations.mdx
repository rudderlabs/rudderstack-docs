...
<div class="successBlock">
  ...
  Transformations can be used across your <a href="https://rudderstack.com/docs/stream-sources/">Event Stream</a>, <a href="https://rudderstack.com/docs/reverse-etl/">Reverse ETL</a> and <a href="https://rudderstack.com/docs/cloud-extract-sources/">Cloud Extract</a> pipelines.
</div>
...
To know more about the Cloud mode in RudderStack, check out the <a href="https://rudderstack.com/docs/rudderstack-cloud/rudderstack-connection-modes">RudderStack Connection Modes</a> guide.
</div>
