...
<div class="infoBlock">
For details on each feature's definition, refer to the <Link to="#feature-definitions">Feature definitions</Link> section below.
</div>
...
You can define the features in the `profiles.yaml` file as follows:
