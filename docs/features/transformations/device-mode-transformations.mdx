...
You can use RudderStack's Transformations feature with the [device mode destinations](https://github.com/rudderlabs/rudder-sdk-js/tree/production/src/integrations) like Firebase, Hotjar, etc. 
