...
You can use RudderStack's Transformations feature with the [device mode destinations](https://github.com/rudderlabs/rudder-sdk-js/tree/production/integrations) like Firebase, Hotjar, etc. 
...
<li><strong>You can write device mode transformations only in JavaScript</strong>. Python support will be added soon.</li>
</ul>
</div>
