...
The `transformEvent` function takes two inputs:
...
<div class="infoBlock">
For more information on <code class="inline-code">metadata</code>, refer to the <Link to="#accessing-metadata">Accessing metadata</Link> section below.
</div>
