...
The RudderStack Cloud **Free** and **Starter** plans let you create 5 JavaScript transformations. However, there is no limit on this number in the **Growth** and **Enterprise** plans. Refer to the <a href="https://www.rudderstack.com/pricing/">Pricing</a> page for more information.

<div class="infoBlock">
Python support for creating transformations is only available for the <strong>Growth</strong> and <strong>Enterprise</strong> plans.
</div>

#### Are there any sample user transformations I can refer to?

Yes - refer to the [Sample RudderStack Transformations](https://github.com/rudderlabs/sample-user-transformers) GitHub repository.
