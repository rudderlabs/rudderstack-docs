...
3. Click on **Generate new token**, as shown:

<img src="../assets/rudderstack-api/new-personal-access-token.png" alt="New personal access token in RudderStack dashboard" />
...
The RudderStack Cloud users only with [Read-Write](https://www.rudderstack.com/docs/rudderstack-cloud/teammates/#read-write) or [Admin](https://www.rudderstack.com/docs/rudderstack-cloud/teammates/#admin) access permissions can create their own access tokens and use them.
