...
is shown in the following code snippet. You can check our other [**SDKs**](https://rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/) for more examples.
