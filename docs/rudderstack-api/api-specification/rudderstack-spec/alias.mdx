...
<div class="successBlock">
  ...
  <ul>
    ...
    <li>
      ...
      supported by the <a href="https://rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/">
        JavaScript SDK
      </a> via <a href="https://rudderstack.com/docs/rudderstack-cloud/rudderstack-connection-modes/#cloud-mode">
        Cloud Mode
      </a>)
    </li>
    <li>
...
The corresponding event that generates the above payload via the <Link to="/sources/sdks/rudderstack-javascript-sdk/">JavaScript SDK</Link>
is as shown:
