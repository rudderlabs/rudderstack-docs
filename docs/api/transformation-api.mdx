...
You need to generate a personal access token to make any API calls. For more information, refer to the <Link to="/dashboard-guides/personal-access-token/">Personal Access Token</Link> guide.
</div>
...
<div class="successBlock">
We also support <Link to="/features/transformations/">user-specific transformations</Link> for real-time operations, such as aggregation and sampling.
</div>
...
<div class="successBlock">
We will be using these two terms <strong>Published</strong> and <strong>Revisions</strong> for transformations and libraries throughout our docs.
</div>
