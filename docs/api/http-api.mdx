...
* <Link to="/destinations/streaming-destinations/amplitude/">Amplitude</Link> (only supported by the <Link to="/sources/event-streams/sdks/rudderstack-javascript-sdk/">JavaScript SDK</Link> via <Link to="/destinations/rudderstack-connection-modes/#cloud-mode">cloud mode</Link>.
