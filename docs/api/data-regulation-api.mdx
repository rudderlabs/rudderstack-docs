...
For all the above-mentioned destinations, you can delete a user by specifying the <code class="inline-code">userId</code> in the event. Except for <strong>Redis</strong> and <strong>S3</strong>, you can also specify a custom identifier (optional) in the event in addition to the <code class="inline-code">userId</code>.
</div>
