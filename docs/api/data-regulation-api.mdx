...
The API lets you specify the users for whom you want to set the data regulation. These users can be identified either by their `userId` or any other custom key.
