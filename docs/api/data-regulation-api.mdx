...
The Data Regulation API is applicable only for the destinations configured to sent events using the <Link to="/tmp-destinations/rudderstack-connection-modes/#cloud-mode">cloud mode</Link>.
</div>
...
<ul>
  <li><Link to="/tmp-destinations/streaming-destinations/amplitude/">Amplitude</Link></li>
  <li><Link to="/tmp-destinations/streaming-destinations/braze/">Braze</Link></li>
  <li><Link to="/tmp-destinations/streaming-destinations/intercom/">Intercom</Link></li>
  <li><Link to="/tmp-destinations/streaming-destinations/amazon-s3/">S3</Link></li>
  <li><Link to="/tmp-destinations/streaming-destinations/redis/">Redis</Link></li>
</ul>
</div>
...
<div class="warningBlock">
It is recommended to provide the user's <code class="inline-code">phone</code> and <code class="inline-code">email</code> <strong>at your own discretion and only if it is required</strong>.
</div>
