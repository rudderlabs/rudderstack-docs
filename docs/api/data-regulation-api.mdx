...
You can delete a user by specifying the <code class="inline-code">userId</code> or any custom identifier in the event for all the above-mentioned destinations except <strong>Redis</strong> and <strong>S3</strong>. For <strong>Redis</strong> and <strong>S3</strong>, RudderStack supports deleting a user only by specifying the <code class="inline-code">userId</code>.
</div>
...
<div class="infoBlock">
<strong>Only <code class="inline-code">userId</code> is a mandatory field</strong>. In addition, you can pass any custom key to identify a user as per your requirement.
</div>
