...
<div class="infoBlock">
Refer to the <Link to="/tmp-destinations/warehouse-destinations/warehouse-schema/">Warehouse Schema</Link> guide for more information on how the events are mapped to the tables in Redshift.
</div>
...
- **Choose your storage provider**: If **Use RudderStack-managed object storage** is disabled in the dashboard, you can enter the relevant <Link to="/tmp-destinations/streaming-destinations/amazon-s3#setting-up-amazon-s3">Amazon S3 bucket storage settings</Link>.
