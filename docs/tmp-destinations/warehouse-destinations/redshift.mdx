...
<div class="infoBlock">
Refer to the <a href="https://rudderstack.com/docs/data-warehouse-integrations/warehouse-schemas/">Warehouse Schema</a> guide for more information on how the events are mapped to the tables in Redshift.
</div>
