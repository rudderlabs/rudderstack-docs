...
<div class="infoBlock">
Refer to the <Link to="/tmp-destinations/warehouse-destinations/warehouse-schema/">Warehouse Schema</Link> guide for information on how the events are mapped to the Snowflake tables.
</div>
...
<Tabs>
  ...
  <TabPanels>
    ...
    <ul>
      ...
      <li><strong>AWS Secret Access Key</strong>:  Enter the AWS secret access key.  Refer to this <Link to="/tmp-destinations/streaming-destinations/amazon-s3#permissions">Permissions</Link> section for more information. </li>
    ...
    <ul>
      ...
      <li><strong>Azure Blob Storage Account Key</strong>:  Enter the account key for your Azure container.  Refer to the <Link to="/tmp-destinations/streaming-destinations/microsoft-azure-blob-storage#setting-up-azure-blob-storage">Blob Storage settings</Link> section for more information. </li>
    </ul>
    </TabPanel>
    <TabPanel>
    <ul>
