...
<div class="infoBlock">
If you would like to use the entire functionality of Appcues like displaying flows, checklists, and surveys, use <strong>Appcues device mode</strong> and not <strong>cloud mode</strong>.
</div>
