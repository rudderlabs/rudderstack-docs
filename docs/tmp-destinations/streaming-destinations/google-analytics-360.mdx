...
<div class="infoBlock">
For details on the supported events and other additional features refer to the <Link to="/tmp-destinations/streaming-destinations/google-analytics-ga/">Google Analytics documentation</Link>.
</div>
...
<div class="infoBlock">
For more information and other FAQs, refer to the <Link to="/tmp-destinations/streaming-destinations/google-analytics-ga/">Google Analytics documentation</Link>.
</div>
