---
title: "Slack"
description: Step-by-step guide on sending your event data from RudderStack to Slack. as a destination in RudderStack
---
...
<img src="../../assets/event-stream-destinations/traits-slack.png" alt="Allowlisted traits" />
