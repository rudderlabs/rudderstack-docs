...
The <Link to="https://www.rudderstack.com/docs/rudderstack-api/api-specification/rudderstack-spec/identify/">`identify`</Link> call lets you create or update a user in LaunchDarkly.
...
The <Link to="https://www.rudderstack.com/docs/rudderstack-api/api-specification/rudderstack-spec/track/">`track`</Link> call lets you record user events and send them to LaunchDarkly as custom conversion metrics for your experiments.

<div class="warningBlock">

As mentioned above, you must call <code class="inline-code">identify</code> before making any <code class="inline-code">track</code> calls to LaunchDarkly.
</div>
