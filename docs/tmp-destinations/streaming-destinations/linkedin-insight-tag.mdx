...
<div class="warningBlock">
This integration is a device mode-only destination for the web (JavaScript) source. For more information on the RudderStack device mode, refer to the <Link to="/tmp-destinations/rudderstack-connection-modes/">RudderStack Connection Modes</Link> guide.
</div>
