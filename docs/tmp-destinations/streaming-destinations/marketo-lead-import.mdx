...
This destination is ideal for your <a href="https://rudderstack.com/docs/sources/reverse-etl/">Reverse ETL</a> sources, as it only accepts <code class="inline-code">identify</code> events.
</div>
