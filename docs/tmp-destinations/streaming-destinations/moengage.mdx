      ...
      <TabPanel>
        <ol>
         ...
         <li>Enable <strong>Background mode</strong> by navigating to <strong>Targets</strong> > <strong>Select Your App</strong> > <strong>Signing & Capabilities</strong> > <strong>Select Background Modes</strong>. Then, check <strong>Remote notifications</strong>.</li>
          ...
          <li>Finally, implement the relevant methods in your <code class="inline-code">AppDelegate</code> file by referring to <Link to="/sources/sdks/rudderstack-ios-sdk/ios-v2/#supporting-push-notifications-for-device-mode-destinations">this section</Link>.</li>
