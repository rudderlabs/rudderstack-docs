...
RudderStack lets you send your event data to Google Analytics 4 via the <Link to="/tmp-destinations/rudderstack-connection-modes/#cloud-mode">cloud mode</Link>.
