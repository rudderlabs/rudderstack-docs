...
RudderStack supports Google Tag Manager as a destination and enables you to send events to the **GTM dataLayer** using the [**JavaScript SDK**](https://www.rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/).
