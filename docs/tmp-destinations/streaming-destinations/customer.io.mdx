...
<div class="infoBlock">
For more information on this setting, refer to the <Link to="/sources/sdks/rudderstack-javascript-sdk/consent-managers/onetrust/">OneTrust Consent Manager</Link> guide.
</div>
...
If you have turned on the screen views in your app implementation from the <Link to="/sources/sdks/rudderstack-ios-sdk/">iOS</Link> or <Link to="/sources/sdks/rudderstack-android-sdk/">Android</Link> SDK, they will be registered as `Viewed <screen_name> Screen` under the **Activities** tab for the user. 
