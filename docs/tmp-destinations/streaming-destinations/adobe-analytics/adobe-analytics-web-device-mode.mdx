...
<div class="infoBlock">
Refer to the <Link to="/tmp-destinations/streaming-destinations/adobe-analytics/setting-up-adobe-analytics-in-rudderstack/#connection-settings">Dashboard Settings</Link> guide for more information on these settings.
</div>
