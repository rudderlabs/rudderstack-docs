...
2. RudderStack sets the timestamp according to the <Link to="/tmp-destinations/streaming-destinations/adobe-analytics/setting-up-adobe-analytics-in-rudderstack/#connection-settings">dashboard settings</Link>.
