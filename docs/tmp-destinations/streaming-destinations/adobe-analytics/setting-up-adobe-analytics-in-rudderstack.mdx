...
- **Adobe Heartbeat Settings**: This setting is used to map your RudderStack video events to Adobe Heartbeat Events. Find more information on how this mapping is done in the <Link to="/tmp-destinations/streaming-destinations/adobe-analytics/adobe-analytics-heartbeat/">Adobe Analytics Heartbeat Measurement</Link> page.
