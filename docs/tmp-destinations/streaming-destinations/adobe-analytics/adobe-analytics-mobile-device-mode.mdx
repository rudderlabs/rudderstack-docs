...
Mobile <Link to="/tmp-destinations/rudderstack-connection-modes/#device-mode">device mode</Link> refers to using the Android or iOS SDK to send your events directly to Adobe Analytics.
</div>
...
For mobile device mode, RudderStack currently does not support the <Link to="/tmp-destinations/streaming-destinations/adobe-analytics/adobe-analytics-heartbeat/#initialize-heartbeat">Initialize Heartbeat</Link> and <Link to="/tmp-destinations/streaming-destinations/adobe-analytics/adobe-analytics-heartbeat/#heartbeat-playhead-update">Heartbeat Playhead Update</Link> video events.
</div>
