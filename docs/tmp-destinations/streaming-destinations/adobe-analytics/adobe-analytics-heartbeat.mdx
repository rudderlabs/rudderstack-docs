...
<div class="infoBlock">
The <Link to="/tmp-destinations/streaming-destinations/adobe-analytics/setting-up-adobe-analytics-in-rudderstack/#connection-settings">RudderStack dashboard settings</Link> also has a toggle for SSL which, if enabled, will send the Heartbeat Tracking URL in the HTTPS mode.
</div>
...
<div class="infoBlock">
The properties mapped in the <Link to="#standard-video-metadata">Standard Video Metadata</Link> section below will also be set.
</div>
