...
Here is an example of an **`identify`** event with traits from [RudderStack JavaScript SDK](https://rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk) and how it is stored in Redis.
