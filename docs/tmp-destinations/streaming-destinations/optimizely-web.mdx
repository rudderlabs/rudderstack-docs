...
description: Step-by-step guide on sending your event data from RudderStack to Optimizely Web
---
...
Please follow our <a href="https://www.rudderstack.com/docs/rudderstack-cloud/sources/#adding-a-source">Adding a Source</a> guide to know how to add a source in RudderStack.
...
If you come across any issues while configuring Optimizely Web with RudderStack, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation in our [Slack](https://rudderstack.com/join-rudderstack-slack-community) community; we will be happy to talk to you!
