...
Similarly, you can also make <Link to="/event-spec/standard-events/screen/">`screen`</Link> calls. However, this is supported only in the <Link to="/tmp-destinations/rudderstack-connection-modes/#cloud-mode">cloud mode</Link>.
