...
- **Use device-mode to send events**: Enable this option to send events via the <Link to="/tmp-destinations/rudderstack-connection-modes/#device-mode">device mode</Link>.
