...
<div class="infoBlock">
When sending events via the device mode, RudderStack lets you specify which events should be discarded or allowed to flow through. For more information, refer to the <Link to="/sources/sdks/event-filtering/">Client-side Event Filtering</Link> guide.
</div>
