---
title: "Gainsight PX"
description: Step-by-step guide on sending your event data from RudderStack to Gainsight PX.
---
...
<div class="infoBlock">
Find the open source transformer code for this destination in the <a href="https://github.com/rudderlabs/rudder-transformer/tree/dest-gainsight-px">GitHub repository</a>.
</div>
