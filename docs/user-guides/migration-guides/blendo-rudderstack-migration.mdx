...
You can use the `useBlendoCasing` integration option to retain the column names as Blendo infrastructure. The following sample snippet shows how to retain the Blendo column names for Delta Lake destination:
