...
You can set values for the following Snowplow configuration objects. If not set, the default values are assigned.
...
The <a href="https://docs.snowplow.io/docs/collecting-data/collecting-from-own-applications/mobile-trackers/tracking-events/#session"><code class="inline-code">SessionConfiguration</code></a> class can be used to capture the sessions which help to track of the user activity in the app.
...
The <a href="https://docs.snowplow.io/docs/collecting-data/collecting-from-own-applications/mobile-trackers/tracking-events/"><code class="inline-code">TrackerConfiguration</code></a> class can be used to capture information about the device and the app as shown:
...
The <a href="https://docs.snowplow.io/docs/collecting-data/collecting-from-own-applications/mobile-trackers/tracking-events/"><code class="inline-code">SubjectConfiguration</code></a> class can be used to capture basic information about the user and the app which is attached on all events as context entity.

<div class="warningBlock">
Snowplow does not provide any call to identify a user. Although, RudderStack sends an the <Link to="/event-spec/standard-events/identify/"><code class="inline-code">identify</code></Link> call if you provide the <code class="inline-code">SubjectConfiguration</code> while initializing the SDK. If not provided, a user is not identified. 
</div>
...
The below table lists the corresponding class names in Snowplow and RudderStack which need to be updated based on your platform:
...
You can migrate your existing events data from RudderStack to Snowplow as described below:
...
Snowplow supports identifying a user by passing the <code class="inline-code">setUserId</code> property. A Snowplow event including the <code class="inline-code">setUserId</code> property triggers the <Link to="/event-spec/standard-events/identify"><code class="inline-code">identify</code></Link> call in RudderStack JavaScript SDK.

<div class="infoBlock">
RudderStack only supports the v2 Snowplow JavaScript tracker.
</div>

In the below sample call, <code class="inline-code">john.doe@email.com</code> is the <code class="inline-code">userId</code> and the <code class="inline-code">firstName</code>, <code class="inline-code">lastName</code>, and <code class="inline-code">city</code> are the user traits.
<span>
...
RudderStack SDKs support the following types of Snowplow events to track users:
...
RudderStack sends a <Link to="/event-spec/standard-events/track/">track</Link> call for Snowplow events containing the <a href="https://docs.snowplow.io/docs/collecting-data/collecting-from-own-applications/mobile-trackers/tracking-events/#creating-a-structured-event"><code class="inline-code">Structured</code></a> class.

In the below example, RudderStack maps <code class="inline-code">Action_example</code> to RudderStack event name and the rest of the properties, like <code class="inline-code">Category_example</code>, <code class="inline-code">label</code>, <code class="inline-code">value</code>, etc. to the RudderStack properties.
...
This is not an automatic lifecycle event. Hence, the properties like <code class="inline-code">version</code>, <code class="inline-code">build</code>, etc. are not present under <code class="inline-code">properties</code>.
      ...
      <TabPanel>
        RudderStack JavaScript SDK supports the following types of Snowplow events to track the users:
        <ul>
          <li>Custom structured events</li>
          <li>Custom self described events (unstructured events)</li>
          </ul>
      
        Snowplow's <code class="inline-code">trackStructEvent</code> and <code class="inline-code">trackSelfDescribingEvent</code> calls let you capture user events along with the associated properties. They trigger the track call in RudderStack JavaScript SDK.
<br/><br/>
...
In the above example, the <code class="inline-code">trackSelfDescribingEvent</code> method tracks the Order Completed event along with other information like <code class="inline-code">revenue</code>, <code class="inline-code">currency</code>, and the <code class="inline-code">user_actual_id</code>, etc.
<br/><br/>
...
<div class="infoBlock">
The <code class="inline-code">action</code> field is mandatory.
</div>
      </TabPanel>
    </TabPanels>
</Tabs>
...
<Tabs>
  <TabList>
    ...
    <TabPanels>
      <TabPanel>
Snowplow's <a href="https://docs.snowplow.io/docs/collecting-data/collecting-from-own-applications/mobile-trackers/tracking-events/#creating-a-structured-event"><code class="inline-code">ScreenView</code></a> class captures whenever a new screen is loaded. A Snowplow event including the <code class="inline-code">ScreenView</code> class triggers the <Link to="/event-spec/standard-events/screen/">screen</Link> call in the RudderStack Android SDK.
<br/><br/>
 RudderStack maps the <code class="inline-code">previousName</code> to RudderStack event name and the rest of the properties, like <code class="inline-code">screenId</code>, <code class="inline-code">previousName</code>, <code class="inline-code">previousId</code>, etc. to the RudderStack properties.
...
Snowplow's <a href="https://docs.snowplow.io/docs/collecting-data/collecting-from-own-applications/mobile-trackers/tracking-events/#creating-a-structured-event"><code class="inline-code">ScreenView</code></a> class captures whenever a new screen is loaded. A Snowplow event including the <code class="inline-code">ScreenView</code> class triggers the <Link to="/event-spec/standard-events/screen/">screen</Link> call in the RudderStack iOS SDK.
...
```
      ...
      <TabPanel>
        Snowplow's <code class="inline-code">trackPageView</code> call lets you record your website's page views with any additional relevant information about the viewed page.<br/><br/>
        A Snowplow event including the <code class="inline-code">trackPageView</code> call triggers the <Link to="/event-spec/standard-events/screen/">screen</Link> call in RudderStack JavaScript SDK.
        <br/>
        <br/>
...
In the above sample snippet, the page title and <Link to="/event-spec/standard-events/common-fields/#contextual-fields">contextual information</Link> is captured.
      </TabPanel>
    </TabPanels>
</Tabs>
