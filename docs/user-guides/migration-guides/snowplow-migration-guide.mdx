...
RudderStack supports setting values for the following Snowplow configuration objects. If not set, the default values are assigned.
...
The <a href="https://docs.snowplow.io/docs/collecting-data/collecting-from-own-applications/mobile-trackers/tracking-events/#session"><code class="inline-code">SessionConfiguration</code></a> class can be used to capture the sessions which help to track of the user activity in the app as shown:
...
Snowplow does not provide any call to identify a user. Although, RudderStack sends an the <Link to="/event-spec/standard-events/identify/"><code class="inline-code">identify</code></Link> call if you initialize <code class="inline-code">SubjectConfiguration</code> while initializing the SDK. If not initialized, the user is not identified. 
</div>
...
You can migrate your existing events from RudderStack to Snowplow as described below:
...
<div class="infoBlock">
RudderStack supports only the v2 Snowplow JavaScript tracker.
</div>
...
This is not an automatic lifecycle event. Hence, the properties like <code class="inline-code">version</code>, <code class="inline-code">build</code>, etc. are not present under <code class="inline-code">properties</code>.
      ...
      <TabPanel>
        RudderStack JavaScript SDK supports the Snowplow's <code class="inline-code">trackStructEvent</code> and <code class="inline-code">trackSelfDescribingEvent</code> calls to track the users. They capture user events along with their associated properties and trigger the <Link to="/event-spec/standard-events/track/"><code class="inline-code">track</code></Link> call in RudderStack JavaScript SDK.
<br/><br/>
...
In the above example, the <code class="inline-code">trackSelfDescribingEvent</code> method tracks the <code class="inline-code">Order Completed</code> event along with other information like <code class="inline-code">revenue</code>, <code class="inline-code">currency</code>, and <code class="inline-code">user_actual_id</code>, etc.
<br/><br/>
...
In the above example, the <code class="inline-code">trackStructEvent</code> method tracks the <code class="inline-code">Order Completed</code> event along with other information like <code class="inline-code">label</code>, <code class="inline-code">property</code>, and <code class="inline-code">value</code>, etc.
...
<br/><br/>
 RudderStack maps the <code class="inline-code">previousName</code> to RudderStack event name and the rest of the properties, like <code class="inline-code">screenId</code>, <code class="inline-code">previousType</code>, <code class="inline-code">previousId</code>, etc. to the RudderStack properties.
...
```
      ...
      <TabPanel>
        Snowplow's <code class="inline-code">trackPageView</code> call lets you record your website's page views with any additional relevant information about the viewed page. A Snowplow event including the <code class="inline-code">trackPageView</code> call triggers the <Link to="/event-spec/standard-events/screen/">screen</Link> call in RudderStack JavaScript SDK.
        <br/>
        <br/>
...
In the above code snippet, page title and <Link to="/event-spec/standard-events/common-fields/#contextual-fields">contextual information</Link> is captured.
      </TabPanel>
    </TabPanels>
</Tabs>
