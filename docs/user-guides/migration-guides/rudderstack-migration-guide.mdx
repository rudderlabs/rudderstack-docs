...
<div class="infoBlock">
For the minified version of the above script, refer to the <Link to="/sources/sdks/rudderstack-javascript-sdk/">RudderStack JavaScript SDK</Link> guide. 
</div>
...
<div class="infoBlock">
For more information on how to enable the <code class="inline-code">anonymousIdOptions</code> object, refer to the <Link to="/sources/sdks/rudderstack-javascript-sdk/#capturing-anonymousid-automatically">Capturing anonymousId automatically</Link> section.
</div>
