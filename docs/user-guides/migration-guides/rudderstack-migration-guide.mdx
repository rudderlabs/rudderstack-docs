...
description: Migrate from Segment to RudderStack.
---
...
If you need more support or want us to manage your hosting, you can [contact us](mailto:support@rudderstack.com).
