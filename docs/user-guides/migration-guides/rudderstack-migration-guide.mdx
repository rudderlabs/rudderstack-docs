...
After creating a [RudderStack](https://app.rudderstack.com/signup?type=freetrial) account, you will see the following dashboard containing your <Link to="/get-started/glossary/#data-plane-url">data plane URL</Link>:
...
<div class="infoBlock">
For the minified version of the above script, refer to the <a href="https://www.rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/quick-start-guide/">RudderStack JavaScript SDK</a> guide. 
</div>
...
<div class="infoBlock">
For more information on how to enable the <code class="inline-code">anonymousIdOptions</code> object, refer to the <a href="https://www.rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/#capturing-anonymousid-automatically">Capturing anonymousId automatically</a> section.
</div>
