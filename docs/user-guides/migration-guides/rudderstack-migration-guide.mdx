...
<div class="infoBlock">
For more information on how to enable the <code class="inline-code">anonymousIdOptions</code> object, refer to the <Link to="/sources/event-streams/sdks/rudderstack-javascript-sdk/#capturing-anonymousid-automatically">Capturing anonymousId automatically</Link> section.
</div>
