...
<img src="../../assets/user-guides/rudderstack-data-plane-url.png" alt="RudderStack data plane URL" />
...
<div class="infoBlock">
For more information on how to enable the <code class="inline-code">anonymousIdOptions</code> object, refer to the <a href="https://www.rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/#capturing-anonymousid-automatically">Capturing anonymousId automatically</a> section.
</div>
