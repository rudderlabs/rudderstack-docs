...
<div class="infoBlock">
For more information on how to enable the <code class="inline-code">anonymousIdOptions</code> object, refer to the <Link to="/sources/sdks/rudderstack-javascript-sdk/load-js-sdk/#anonymousidoptions">Capturing anonymousId automatically</Link> section.
</div>
