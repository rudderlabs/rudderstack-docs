...
You can ignore the Node counterpart as it's legacy. We have a separate <a href="https://rudderstack.com/docs/sources/sdks/rudderstack-node-sdk">Node.js SDK</a> for sending events to RudderStack (in the server-side connection mode)
