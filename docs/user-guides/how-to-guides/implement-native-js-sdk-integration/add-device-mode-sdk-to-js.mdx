...
<div class="infoBlock">
You can ignore the Node counterpart as it's legacy. We have a separate <Link to="/sources/event-streams/sdks/rudderstack-node-sdk/">Node.js SDK</Link> for sending events to RudderStack (in the server-side connection mode)
</div>
