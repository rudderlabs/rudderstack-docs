...
To <Link to="/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/version-migration-guide/#case-3-self-hosting-rudderstacks-cdn">load a device-mode SDK</Link> (for example, Google Analytics), you can use the following URL: 

```html
<script>
rudderanalytics.load(WRITE_KEY, DATA_PLANE_URL, {
    destSDKBaseURL: "https://subdomain.yourdomain.com/v1.1/js-integrations/GA.min.js"
});
</script>
```
...
The correct custom domain URL to <Link to="/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/version-migration-guide/#case-3-self-hosting-rudderstacks-cdn">load a device-mode SDK</Link> (for example, Google Analytics) should be in the following format: 
