...
<div class="infoBlock">
Refer to this <Link to="/sources/sdks/rudderstack-javascript-sdk/faq/#how-to-check-if-the-data-is-being-transmitted-to-the-desired-destinations">JavaScript SDK FAQ</Link> for more information on verifying the flow of events.
</div>
