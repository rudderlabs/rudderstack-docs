...
This guide contains the steps to use your own domain to route the events or proxy the <Link to="/sources/sdks/rudderstack-javascript-sdk/">RudderStack JavaScript SDK</Link> via your own CDN. 
...
<div class="infoBlock">
If you are using an older version of the JavaScript SDK (v1), refer to the <Link to="/sources/sdks/rudderstack-javascript-sdk/version-migration-guide/">Version Migration Guide</Link> to migrate to v1.1.
</div>
...
<div class="infoBlock">
Refer to this <Link to="/sources/sdks/rudderstack-javascript-sdk/js-sdk-faqs/#how-to-check-if-the-data-is-being-transmitted-to-the-desired-destinations">JavaScript SDK FAQ</Link> for more information on verifying the flow of events.
</div>
...
The correct custom domain URL to <Link to="/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/version-migration-guide/#case-3-self-hosting-rudderstacks-cdn">load a device-mode SDK</Link> should be in the following format: 
