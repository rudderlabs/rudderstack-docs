...
This feature is supported for all the destinations that support sending data via the <Link to="/tmp-destinations/rudderstack-connection-modes/#cloud-mode">cloud mode</Link>, including <Link to="/tmp-destinations/warehouse-destinations/">warehouse destinations</Link>.
</div>
...
<div class="infoBlock">
You will need to add a transformation that populates the configuration values for the payload path. Refer to the <Link to="#use-case">use-case</Link> below for more information.
</div>
...
<div class="infoBlock">
Follow our guide on <Link to="/dashboard-guides/destinations/#adding-a-destination">Adding a Destination</Link> guide for more information.
</div>
