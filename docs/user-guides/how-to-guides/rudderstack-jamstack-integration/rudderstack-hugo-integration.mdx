...
This guide will help you integrate RudderStack with your Hugo site using the <Link to="/sources/sdks/rudderstack-javascript-sdk/">RudderStack JavaScript SDK</Link>. On successful integration, you can track and send real-time user events to your preferred destinations via RudderStack.
