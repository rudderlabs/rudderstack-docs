...
<div class="infoBlock">
For detailed technical documentation and troubleshooting guide on the RudderStack's JavaScript SDK, refer to <Link to="/sources/sdks/rudderstack-javascript-sdk/">JavaScript SDK</Link>.
</div>
