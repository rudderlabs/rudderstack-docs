...
plugins: [
  {
    ...
    options: {
      ...
      // Rudderstack docs:
      //   - https://rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/#31-load
      dataPlaneUrl: `https://override-rudderstack-endpoint`,
      // Add a `controlPlaneUrl` property if you are self-hosting the Control Plane
      // Rudderstack docs:
      //   - https://rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/#311-self-hosted-control-plane
...
For detailed technical documentation and troubleshooting guide on the RudderStack’s JavaScript SDK, refer to <a href="https://rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk">JavaScript documentation</a>.
