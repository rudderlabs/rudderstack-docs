...
description: Integrate RudderStack with your Svelte app for event tracking.
---

This guide will help you integrate RudderStack with your Svelte app using the <Link to="/sources/event-streams/sdks/rudderstack-javascript-sdk/">RudderStack JavaScript SDK</Link>. On successful integration, you can track and send real-time user events to your preferred destinations via RudderStack.
