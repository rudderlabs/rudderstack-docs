...
description: >-
  Step-by-step guide on integrating RudderStack with your Svelte app for event tracking.
---

This guide will help you integrate RudderStack with your Svelte app using the <Link to="/sources/sdks/rudderstack-javascript-sdk/">RudderStack JavaScript SDK</Link>. On successful integration, you can track and send real-time user events to your preferred destinations via RudderStack.

To set up the event stream on your Svelte app, you need to perform the following steps:

1. <Link to="#integrating-the-javascript-sdk-with-your-svelte-app">Integrate the JavaScript SDK with your Svelte app and set up the tracking code</Link>
2. <Link to="#configuring-a-destination-in-rudderstack">Configure a destination in RudderStack</Link>
3. <Link to="#deploying-your-svelte-app-and-verifying-the-event-stream">Deploy your Svelte app and verify the events</Link>
...
2. <Link to="#installing-and-configuring-the-javascript-sdk-in-your-svelte-app">Installing and configuring the JavaScript SDK in your Svelte app</Link>
