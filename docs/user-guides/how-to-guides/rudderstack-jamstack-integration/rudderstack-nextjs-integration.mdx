...
If you are using an older version of the JavaScript SDK (v1), refer to the <Link to="/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/version-migration-guide">Version Migration Guide</Link> to migrate to v1.1.
</div>
...
Refer to the sample Next.js app in the [RudderStack Sample Applications](https://github.com/rudderlabs/rudder-samples/tree/master/javascript/sample-next-app) repository for more information.
</div>
...
1. In your Next.js project folder, go to the `pages` folder and create a new `rudderInitialize.js` file with the following code: 
...
2. In the same `pages` folder, open the `index.js` file and add the following code snippet:
...
Refer to the sample Next.js app in the [RudderStack Sample Applications](https://github.com/rudderlabs/rudder-analytics-next) repository for more information.
</div>
