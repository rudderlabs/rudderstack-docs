...
description: Integrate RudderStack with your Next.js app for event tracking.
---
...
<div class="infoBlock">
Refer to the sample Next.js app in the [RudderStack Sample Applications](https://github.com/rudderlabs/rudder-analytics-next/tree/main/sample-next-app) repository for more information.
</div>
