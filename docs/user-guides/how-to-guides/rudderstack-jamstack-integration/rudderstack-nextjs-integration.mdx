...
Refer to the sample Next.js app in the <a href="https://github.com/rudderlabs/rudder-samples/tree/master/javascript/sample-next-app">RudderStack Sample Applications</a> repository for more information.
</div>
