...
Refer to the sample Next.js app in the [RudderStack Sample Applications]([https://github.com/rudderlabs/rudder-samples/tree/master/javascript/sample-next-app](https://github.com/rudderlabs/rudder-analytics-next/tree/main/sample-next-app-npm)) repository for more information.
</div>
