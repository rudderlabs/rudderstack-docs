...
1. Download the [JavaScript SDK](https://cdn.rudderlabs.com/v1.1/rudder-analytics.min.js) and save it as `rudder-analytics.min.js`. Also, download the [corresponding map file](https://cdn.rudderlabs.com/v1.1/rudder-analytics.min.js.map) which is automatically saved as `rudder-analytics.min.js.map`
