...
2. Download the required device mode destination SDK file from https://cdn.rudderlabs.com/v1.1/js-integrations/&lt;destination_name&gt;.min.js. Also, download the source map file for the corresponding destination from: https://cdn.rudderlabs.com/v1.1/js-integrations/&lt;destination_name&gt;.min.js.map.
