...
2. Download the required device mode destination SDK files from https://cdn.rudderlabs.com/v1.1/js-integrations/&lt;destination_name&gt;.min.js. Also, download the source map file for the corresponding destination from: https://cdn.rudderlabs.com/v1.1/js-integrations/&lt;destination_name&gt;.min.js.map.
...
<div class="infoBlock"> 
This option is recommended, as providing a custom name for the core JavaScript SDK file (instead of <code class="inline-code">rudder-analytics.min.js</code>) can help overcome ad-blockers, if any.
</div>
