...
RudderStack integrates seamlessly with AWS Lambda, allowing you to use any lambda function to transform your event streams and route them to the <Link to="/tmp-destinations/overview/">destinations</Link> of your choice.
