...
To best understand some of the terms covered in this guide, we recommend going through the <Link to="/resources/rudderstack-architecture/">RudderStack Architecture</Link> first.
</div>
...
<div class="infoBlock">
For more information on the Processor, Gateway, and Router modules of the RudderStack backend, refer to the <Link to="/resources/rudderstack-architecture/">RudderStack Architecture</Link>.
</div>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        Enables or disables the backup. This is set to <code class="inline-code">false</code> in the <Link to="/user-guides/administrators-guide/high-availability/#rudderstack-server-running-modes">Degraded</Link> mode.
      </td>
      <td style="text-align:center">
...
<div class="infoBlock">
You can ignore these settings if you don't have any <Link to="/tmp-destinations/warehouse-destinations/">Warehouse Destinations</Link> configured in RudderStack.
</div>
