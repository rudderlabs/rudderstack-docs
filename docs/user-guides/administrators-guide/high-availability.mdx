...
Please refer to our <Link to="/user-guides/administrators-guide/alerting/">alerting guide</Link> to learn more about the various configuring alerts in RudderStack.
