...
The <a href="https://www.okta.com/integrations/rudderstack/">Okta RudderStack app</a> is now available on the <strong>Okta Integration Network (OIN)</strong>. Now you can add the SSO integration through <a href="https://www.okta.com/integrations/rudderstack/">OIN</a> without having to follow the steps listed in this guide.
</div>
