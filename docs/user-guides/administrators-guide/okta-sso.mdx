...
In the **Sign On** section of the RudderStack SSO app, copy the **Identity Provider metadata** URL present under the **View Setup Instructions** button, as shown below. **Copy and share this URL with the RudderStack team** to enable SSO for your organization.
