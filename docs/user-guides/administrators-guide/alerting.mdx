...
<div class="infoBlock">
To learn more about the different running modes in RudderStack, please check our guide on the <Link to="/user-guides/administrators-guide/high-availability/#rudderstack-server-running-modes">RudderStack Server Running Modes</Link>.
</div>
