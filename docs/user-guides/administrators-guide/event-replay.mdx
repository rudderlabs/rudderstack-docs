...
<Tabs>
  ...
  <TabPanels>
    ...
    <ul>
      ...
      <li><a href="mailto:%20support@rudderstack.com">Contact the customer success team</a> to share your S3 bucket name, <strong>AWS access key ID</strong>, and <strong>AWS secret access key</strong>.</li>      
      </ul>
    </TabPanel>
    <TabPanel>
    <ul>
      ...
      <li><a href="mailto:%20support@rudderstack.com">Contact the customer success team</a> to share your bucket name and the credentials JSON.</li>
    </ul>
    </TabPanel>
    <TabPanel>
    <ul>
      ...
      <li><a href="mailto:%20support@rudderstack.com">Contact the customer success team</a> to share your account name, <strong>container</strong>, and <strong>access key</strong>.</li>
    </ul>
    </TabPanel>
    <TabPanel>
    <ul>
      ...
      <li><a href="mailto:%20support@rudderstack.com">Contact the customer success team</a> to share your <strong>access key ID</strong> and <strong>secret access key</strong>.</li>
    </ul>
    </TabPanel>
  </TabPanels>
</Tabs>
