...
No, it is highly recommended to [contact the customer success team](mailto:%20support@rudderstack.com) to replay the events to avoid any unfavorable circumstances.
