...
### Can I replay the events myself from object storage without contacting the customer success team?

It is highly recommended to [contact the customer success team](mailto:%20support@rudderstack.com) to replay the events.

However, as a workaround, you can use the RudderStack API to replay the historical events by batching them together and sending them to the required source. 
