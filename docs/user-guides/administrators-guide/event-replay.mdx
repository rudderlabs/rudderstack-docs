...
To learn more about these data retention options, refer to the <Link to="/dashboard-guides/data-retention/#data-retention-options">Data Management</Link> guide.
...
Depending on how you store your event data (**RudderStack-hosted storage** or your **own object storage**), you can [contact the Customer Success team](mailto:%20support@rudderstack.com) to safely replay your events and avoid any unfavorable circumstances.
