...
- **RudderStack S3 Storage**: Event data is stored in RudderStack's Amazon S3 bucket on a rolling 30-day basis, that is, RudderStack deletes the event data 30 days after it was stored.
...
**RudderStack storage**: If your event data is stored in RudderStack's Amazon S3 bucket, it is highly recommended to [contact our customer success team](mailto:%20support@rudderstack.com) to replay the events to avoid any unfavorable circumstances.

**Own object storage**: If your event data is stored in your own object storage, you can replay the events on your own. If you need more information or help, feel free to [contact our customer success team](mailto:%20support@rudderstack.com).
