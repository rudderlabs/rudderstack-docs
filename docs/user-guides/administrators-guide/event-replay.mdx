...
Depending on the way you store the event data, you can choose any of the below to replay your events:

**RudderStack storage**: If your event data is stored in RudderStack's Amazon S3 bucket, then it is highly recommended to [contact the customer success team](mailto:%20support@rudderstack.com) to replay the events to avoid any unfavorable circumstances.

**Your own object storage**: If your event data is stored in your own object storage, then ... 
