...
**Own object storage**: If your event data is stored in your own object storage, you can replay the event data on your own. If you need more information or help, [contact our customer success team](mailto:%20support@rudderstack.com).
