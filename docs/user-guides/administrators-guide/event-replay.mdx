...
To know more about these data retention options, refer to the <Link to="/dashboard-guides/data-retention/#data-retention-options">Data Management</Link> guide.
