...
3. Under **Sign on methods**, choose **Bookmark-only**. Set the **Login URL** to `https://app.rudderstack.com/sso?domain=<your_website>.com`, where `<your_website>` is your organization's web domain. Retain the rest of the settings and click **Done**. 

<img src="../../../assets/user-guides/rudderstack-okta-sso-6.png" alt="Bookmark sign on method and Login URL" />

## SCIM configuration

You can automatically grant RudderStack access to your users by <Link to="/user-guides/administrators-guide/okta-sso/scim-configuration">configuring SCIM provisioning</Link> in Okta.