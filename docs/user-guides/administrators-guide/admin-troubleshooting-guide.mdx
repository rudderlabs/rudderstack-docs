...
<div class="successBlock">
You can restart the server in the normal mode by updating the <code class="inline-code">/data/rudderstack/recovery_data.json</code> or <code class="inline-code">/tmp/recovery_data.json</code> and setting the Mode to "normal".
</div>
...
For any other issues or bugs that you might encounter, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation in our [Slack](https://rudderstack.com/join-rudderstack-slack-community) community, and we will be happy to help!
