...
At RudderStack, we strive to make our deployment simple. To get started, go through our guide on <Link to="/tmp-get-started/rudderstack-open-source/data-plane-setup/">Setting up your own data plane</Link> on the platform of your choice.
...
To stay up to date, we highly recommend using the Docker images. If you are an enterprise customer and need the latest binaries, [contact us](https://rudderstack.com/contact/).
