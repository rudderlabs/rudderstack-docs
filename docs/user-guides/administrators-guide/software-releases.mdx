...
At RudderStack, we strive to make our deployment simple. To get started, go through our guide on <Link to="/get-started/rudderstack-open-source/data-plane-setup/">Setting up your own data plane</Link> on the platform of your choice.
