...
| ACS (Consumer) URL Validator | `^https:VVauth2\.rudderstack\.comVsamI2VidpresponseV\S` |
...
9. To add a custom parameter, simply click the **+** button, enter the **Field name**, and select the value from the dropdown, as shown:
