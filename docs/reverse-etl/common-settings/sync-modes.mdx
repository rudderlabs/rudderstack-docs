...
<div class="infoBlock">
<Link to="/reverse-etl/amazon-redshift/">Redshift</Link>, <Link to="/reverse-etl/postgresql/">PostgreSQL</Link>, <Link to="/reverse-etl/snowflake/">Snowflake</Link>, and <Link to="/reverse-etl/google-bigquery/">BigQuery</Link> warehouse sources support syncing data via both these sync modes whereas <Link to="/reverse-etl/amazon-redshift/">Databricks</Link> supports syncing data only via upsert sync mode.
</div>
...
The upsert mode is supported for all destinations connected to the above-mentioned Reverse ETL sources, except <Link to="/destinations/advertising/fb-custom-audience/">Facebook Custom Audience</Link>.
</div>
...
<div class="infoBlock">
 ...
 This mode is currently supported only for the <Link to="/destinations/advertising/fb-custom-audience/">Facebook Custom Audience</Link> destination connected to the above-mentioned Reverse ETL sources.
</div>
