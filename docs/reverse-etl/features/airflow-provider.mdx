...
For more information on generating an access token, refer to the <a href="https://rudderstack.com/docs/rudderstack-api/personal-access-tokens/">Personal Access Tokens</a> guide.
</div>
