...
[MySQL](https://www.mysql.com/) is an open source relational DBMS. It provides services to run your OLTP, OLAP, and machine learning workloads directly on your database with high scalability and reliability.
