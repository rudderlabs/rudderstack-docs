...
To obtain the **Host**, **Path**, and **Port** number required to set up Databricks source in RudderStack, follow these steps:
...
1. Log into the [Azure portal](https://portal.azure.com/).
2. Select the required Databricks resource and click **Launch Workspace**.
3. Go to **Settings** > **User Settings** to generate a new personal access token, as shown:
