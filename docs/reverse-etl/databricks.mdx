...
<div class="infoBlock">
This document assumes the Databricks cluster is set up using <a href="https://docs.microsoft.com/en-us/azure/databricks/clusters/create">Azure</a>. The setup instructions for the other major cloud providers will be updated soon.
</div>
