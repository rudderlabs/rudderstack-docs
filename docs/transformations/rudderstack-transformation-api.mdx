...
You need to generate a personal access token to make any API calls. For more information, refer to the <a href="https://rudderstack.com/docs/rudderstack-api/personal-access-tokens/">Personal Access Tokens</a> guide.
</div>
