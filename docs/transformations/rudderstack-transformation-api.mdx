...
You need to generate a personal access token to make any API calls. For more information, refer to the <Link to="/rudderstack-api/personal-access-tokens/">Personal Access Tokens</Link> guide.
</div>
