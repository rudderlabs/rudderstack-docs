...
It's easy-to-use <Link to="/sources/event-streams/sdks/">SDKs</Link>, <Link to="/sources/event-streams/cloud-apps/">Cloud Apps</Link>, <Link to="/sources/extract/">Cloud Extract integrations</Link>, <Link to="/features/transformations/">transformations</Link>, and expansive library of <Link to="/destinations/overview/">destinations</Link> makes building customer data pipelines for both event streaming and cloud-to-warehouse ELT simple.
