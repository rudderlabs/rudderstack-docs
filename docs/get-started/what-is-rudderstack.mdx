...
Event data captured by RudderStack is sent, often in real time, to the marketing, analytics, data warehouse/lake and other destinations that you configure.
