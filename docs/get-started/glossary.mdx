...
The workspace token uniquely identifies your RudderStack workspace. You can find it by logging in to your [RudderStack dashboard](https://app.rudderstack.com/) and going to **Settings** > **Company**, as shown:
