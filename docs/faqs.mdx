...
Yes, you can set the desired folder name in the **Prefix** input field while configuring your BigQuery destination. For more information, refer to the <Link to="/destinations/warehouse-destinations/google-bigquery/#configuring-google-bigquery-destination-in-rudderstack">BigQuery setup guide</Link>.
