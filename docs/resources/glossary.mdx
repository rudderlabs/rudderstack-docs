...
For information on Control Plane Lite and how to use it, refer to the <Link to="/tmp-get-started/rudderstack-open-source/control-plane-lite/">Control Plane Lite</Link> guide.
...
* <Link to="/tmp-get-started/rudderstack-cloud/">RudderStack Cloud</Link>: RudderStack hosts both control plane and data plane
* <Link to="/tmp-get-started/rudderstack-open-source/">RudderStack Open Source</Link>: RudderStack hosts the control plane and the user hosts the data plane. Alternatively, the user hosts both the control plane and the data plane.
...
- If you're using <Link to="/tmp-get-started/rudderstack-open-source/">RudderStack Open Source</Link>, you are required to <Link to="/tmp-get-started/rudderstack-open-source/data-plane-setup/">set up your own data plane</Link> in your preferred environment.
...
Refer to the <Link to="/tmp-destinations/overview/">Destinations</Link> guide for the complete list of the supported destinations.
...
For more information on the various Event Streams sources supported by RudderStack, refer to the <Link to="/sources/cloud-apps/">Cloud Apps</Link> guide.
...
RudderStack offers SDK support for your web, mobile, and server-side sources and lets you track your event data seamlessly.
 ...
 For the SDK-specific documentation, refer to the <Link to="/sources/sdks/">SDK Integration Guides</Link>.
...
For more information on how to set up these warehouse destinations, refer to the <Link to="/tmp-destinations/warehouse-destinations/">Warehouse Destinations</Link> guide.
...
Refer to the <Link to="/tmp-destinations/warehouse-destinations/warehouse-schema/">Warehouse Schema</Link> guide for more details.
