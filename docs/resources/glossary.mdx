...
This ID is required when setting up an IAM role for RudderStack for authenticating all the AWS-based destinations. For more information, refer to the <Link to="/destinations/aws-iam-role-for-rudderstack/">Creating an AWS IAM Role for RudderStack</Link> guide.
