...
RudderStack uses the workspace ID for the internal tracking of the data.

This ID is required when setting up a IAM role for RudderStack required for authenticating all the AWS-based destinations. For more information, refer to the <Link to="/dashboard-guides/overview/#company">Dashboard Overview</Link> guide.
...
To get the workspace token, log into your [RudderStack dashboard](https://app.rudderstack.com/) and go to **Settings** > **Company**, as shown:
