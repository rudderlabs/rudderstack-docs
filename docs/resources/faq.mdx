...
<div class="warningBlock">
The self-hosted control plane setup using Control Plane Lite does not support features like <Link to="/transformations/">Transformations</Link> and <Link to="/rudderstack-cloud/live-events/">Live Events Debugger</Link>, which are included in the <a href="https://app.rudderstack.com">RudderStack-hosted control plane (web app)</a>.
</div>
