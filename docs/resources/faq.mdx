...
<div class="infoBlock">
For more information on the SDK-specific retry and backoff logic, refer to the <Link to="/sources/sdks/faq/#what-is-the-rudderstack-retry-and-backoff-logic-after-the-connection-fails">SDK FAQ</Link> guide.
</div>
