...
If you come across any issues while configuring Bing Ads as a source on the RudderStack dashboard, you can [**contact us**](mailto:%20docs@rudderstack.com) or start a conversation in our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) community.
