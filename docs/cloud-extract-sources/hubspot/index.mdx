...
1. Select the appropriate **HubSpot software** from the dropdown, as shown:

<img src="../../assets/cloud-extract-sources/hubspot-connection-settings-1.png" alt="HubSpot connection settings" />

2. Click on **Connect with HubSpot** and give RudderStack the necessary permissions to access the HubSpot data.
