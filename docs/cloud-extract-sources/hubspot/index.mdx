...
This version of the HubSpot source will be deprecated soon. Refer to the <a href="https://www.rudderstack.com/docs/cloud-extract-sources/hubspot-v2/">HubSpot v2</a> guide for the latest documentation.
</div>
