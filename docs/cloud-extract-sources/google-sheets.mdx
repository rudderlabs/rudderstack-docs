...
1. Click on **Connect with Google Sheets** and grant RudderStack the necessary permissions to access your Google Sheets data.

<img src="../assets/cloud-extract-sources/google-sheets-connection-settings-2.png" alt="Sendgrid credentials" />
