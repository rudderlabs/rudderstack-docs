...
- **Historical data**: Specify the timeframe where RudderStack will fetch all the historical data during the first sync.
- **Attribution window**: Specify the timeframe for any subsequent data syncs.

<div class="warningBlock">

RudderStack will not sync the data older than the selected timeframes.
</div>
