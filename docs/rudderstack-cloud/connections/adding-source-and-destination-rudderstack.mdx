...
title: "Adding a Destination"
description: >-
  Step-by-step guide on Adding a Destination in RudderStack to track
...
<div class="successBlock">
  Refer to the <a href="https://rudderstack.com/docs/rudderstack-cloud/connections/">Connections</a> guide to read more about
...
<div class="successBlock">
  ...
  For more information on sources in RudderStack, refer to the <a href="https://rudderstack.com/docs/rudderstack-cloud/connections/">Connections</a> guide.
</div>
...
<div class="successBlock">
  ...
  <ul>
    <li>
      <a href="https://rudderstack.com/docs/sources/cloud-apps/">Event Streams</a>
    </li>
    <li>
      <a href="https://rudderstack.com/docs/sources/extract/">Cloud Extract</a>
    </li>
    <li>
...
<div class="successBlock">
  ...
  For more information on destinations in RudderStack, refer to the <a href="https://rudderstack.com/docs/rudderstack-cloud/connections/">Connections</a> guide.
</div>
