...
| :------------- | :----- | :------- | :------------------------------- |
| `user_id` <span style="color: #4D4DFF;font-size:12px;">Required</span>     | String |  The developer identification for your user                                                                                 |
| `event` <span style="color: #4D4DFF;font-size:12px;">Required</span>        | String |  Name of the event being performed by the user                                                                              |
...
| **Field**      | **Type** | **Description**                  |
| :------------- | :------- | :---------------------------------------- | :-------------------------------- |
| `anonymousId` <span style="color: #4D4DFF;font-size:12px;">Required, if <strong>userId</strong> is absent.</span> | String   |  Sets the user ID for cases where there is no unique identifier for the user.  |
| `userId`   <span style="color: #4D4DFF;font-size:12px;">Required, if <strong>anonymousId</strong> is absent.</span>    | String   | Unique identifier for a particular user in your database.      |
| `context`      | Object   |  Dictionary of information that provides context about a message. However, it is not directly related to the API call.      |
| `integrations` | Object   |  A dictionary containing the destinations to be either enabled or disabled.                                                 |
| `name`   <span style="color: #4D4DFF;font-size:12px;">Required</span>        | String         | Name of the page being viewed.                                                                                             |
...
| `context`      | Object   | Dictionary of information that provides context about a message. However, it is not directly related to the API call.      |
| `integrations` | Object   |  A dictionary containing the destinations to be either enabled or disabled.                                                 |
| `groupId` <span style="color: #4D4DFF;font-size:12px;">Required</span>     | String   | Unique identifier of the group, as present in your database.                                                               |
...
| `context`      | Object   | Dictionary of information that provides context about a message. However, it is not directly related to the API call. |
| `integrations` | Object   | A dictionary containing the destinations to be either enabled or disabled.                                            |
| `previousId` <span style="color: #4D4DFF;font-size:12px;">Required</span>  | String    | The previous unique identifier of the user.                                                                           |
| `traits`       | Object   | Dictionary of the properties or traits associated with the group, such as `email` or `name`.                          |
| `timestamp`    | Date     | The timestamp of the message's arrival.                                                                               |
