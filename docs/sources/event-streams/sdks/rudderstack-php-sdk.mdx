...
|  `max_queue_size`           | Number      | Max size of the queue. The default value is 10000. |
...
|  `curl_timeout `       | Number | Timeout for the curl connections. The default value is 0, that is, infinite. |
...
| `context`      | Object |  An optional dictionary of information that provides context about the message. It is not directly related to the API call.      |
| `timestamp`    | Date   |  The timestamp of the message's arrival.                                                                                    |
