...
| :---- | :---- |
| <Link to="/sources/event-streams/sdks/rudderstack-javascript-sdk/">JavaScript</Link> | <ul><li><strong>v1</strong> - <a href="https://github.com/rudderlabs/rudder-sdk-js/releases/tag/v1.16.0">1.16.0</a> (CDN)</li><li><strong>v1.1</strong> - <a href="https://github.com/rudderlabs/rudder-sdk-js/releases/tag/v2.15.0">2.15.0</a> (CDN & NPM)</li></ul> |
