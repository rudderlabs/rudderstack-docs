...
The RudderStack Node.js SDK provides the following parameters which can be passed during the SDK initialization:
...
The following initialization parameters are only available for RudderStack Node.js SDK **v2 and above**:
...
| `retryCount`           | Integer   | 3                               | Number of times a request is retried by axios if failed.  |
