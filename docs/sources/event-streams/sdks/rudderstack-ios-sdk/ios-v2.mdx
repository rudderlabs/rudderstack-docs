---
title: "iOS v2"
description: Use the RudderStack iOS SDK to send events from your iOS/macOS/tvOS/watchOS apps to various destinations.
---
...
<div class="infoBlock">
Refer to the <a href="https://github.com/rudderlabs/rudder-sdk-ios/tree/master-v2">GitHub codebase</a> to get a more hands-on understanding of the SDK.
</div>

<a href="https://github.com/rudderlabs/rudder-sdk-ios/tree/master-v2"><img align="left" src="https://img.shields.io/badge/dynamic/json?color=blue&label=pod&query=%24.version&url=https%3A%2F%2Fraw.githubusercontent.com%2Frudderlabs%2Frudder-sdk-ios%2Fmaster-v2%2Fpackage.json" /></a>
...
<ol>
  ...
  <li>In <strong>Dependency Rule</strong>, select  <strong>Up to Next Major Version</strong> and enter the value as <strong>2.2.5</strong>, as shown:</li>

<img src="../../../../assets/event-stream-sources/spm-dependency-rule-v2.png" alt="SPM dependency rule" />
