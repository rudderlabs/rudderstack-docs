...
| `automaticSessionTracking` | `boolean` | Determines if the SDK automatically tracks the user sessions. | `true` |
| `sessionTimeout` | Integer | Maximum inactivity period before the session expires. | `300000 ms` |
