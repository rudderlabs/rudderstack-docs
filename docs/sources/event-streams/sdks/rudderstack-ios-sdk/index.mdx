...
For example, if automatic screen recording is enabled and you set the `ViewController` name to `HomeViewController`, then the SDK sets the screen name to `Home`.
