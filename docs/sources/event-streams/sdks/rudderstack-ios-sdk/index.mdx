...
| `autoSessionTracking` | `boolean` | Determines if the SDK automatically tracks the user sessions. | `true` |
| `sessionTimeout` | `int` | Maximum inactivity period before the session expires. | `300000 ms` |
