...
<div class="infoBlock">
Since the AMP source sends the data directly to the RudderStack backend, it supports only cloud mode destinations. For more information on cloud mode, refer to the <a href="https://rudderstack.com/docs/destinations/rudderstack-connection-modes/">RudderStack Connection Modes</a> guide.
</div>
