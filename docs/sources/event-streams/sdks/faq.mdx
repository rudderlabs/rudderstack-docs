...
For more information on how RudderStack handles overriding <code class="inline-code">anonymousId</code>, please refer to our <a href="https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/supported-api/#overriding-anonymous-id">docs</a>.
</div>
