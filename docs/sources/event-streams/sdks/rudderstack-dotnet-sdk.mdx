---
title: ".NET"
description: Use RudderStack’s .NET SDK to send events to various destinations.
---
...
- Once signed up, <Link to="/dashboard-guides/sources/#adding-a-source">set up a .NET source</Link> in the dashboard. You should be able to see a **Write Key** for this source, as shown below:

<img src="../../../assets/event-stream-sources/dotnet-write-key-new.png" alt=".NET source write key" />
...
The gzip compression feature is enabled in the .NET SDK by default from versions starting `2.0.0`.
</div>
...
The <code class="inline-code">Gzip Compression</code> feature requires <a href="https://github.com/rudderlabs/rudder-server">rudder-server</a> <strong>version 1.4 or higher</strong>. Otherwise, your events might fail.
</div>
...
Refer to <a href="https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-dotnet-sdk/#the-options-parameter">The options parameter</a> section below for more information on the <code class="inline-code">options</code> object and its fields.
</div>
