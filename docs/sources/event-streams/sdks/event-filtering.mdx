...
You can use this feature for all RudderStack destinations that support sending events via <a href="https://rudderstack.com/docs/destinations/rudderstack-connection-modes/#device-mode">device mode</a>.
</div>
