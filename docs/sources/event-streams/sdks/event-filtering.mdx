...
You can use this feature for all the RudderStack destinations that support sending events via the <a href="https://rudderstack.com/docs/destinations/rudderstack-connection-modes/#device-mode">device mode</a>.
</div>
