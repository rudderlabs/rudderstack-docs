...
RudderStack supports a few canonical names for destinations. You can find more information regarding these canonical names in the <a href="https://www.rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk#common-destination-names">common destination names</a> section of the SDK documentation.
