...
- <a href="https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/version-migration-guide/">Migrating to JavaScript SDK v1.1</a>
...
The JavaScript SDK stores persistent user data in the cookies. For more information on these cookies, refer to the <a href="https://www.rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/data-storage-cookies/">Data Storage in Cookies</a> guide.

</div>

<div class="successBlock">

The JavaScript SDK now supports integration with the OneTrust consent manager and lets you map OneTrust cookie/consent groups to RudderStack's consent purposes. For more information on the OneTrust integration, refer to <a href="https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/consent-managers/onetrust/">this guide</a>.

</div>

## Installing the SDK

To quickly set up and start using the RudderStack JavaScript SDK, go through our [**quick start guide**](https://www.rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/quick-start-guide/).
...
Refer to <a href="https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/javascript-sdk-enhancements/#sendbeacon-as-a-transport-mechanism">this section</a> for more details on using the Beacon transport mechanism.
...
<div class="infoBlock">
  ...
  to{" "}
  <a href="https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/consent-managers/">
    this section
  </a>
  .
</div>
...
The JavaScript SDK provides `anonymousIdOptions` object in the [`load()`](https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/#the-options-parameter) call options. It automatically captures the anonymous ID from a source and sets it as Rudderstack’s `anonymousId`.
...
You can refer to the <a href="https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/#common-destination-names">Common destination names</a> for the naming conventions for the destinations.
...
Refer to the [**FAQs**](https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/faq/) section for solutions to some of the commonly faced issues while using the JavaScript SDK on your website.
