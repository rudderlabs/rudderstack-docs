...
If you are self-hosting the control plane using the <Link to="/get-started/rudderstack-open-source/control-plane-lite/#using-rudderstack-sdks">Control Plane Lite</Link> utility, the `load` call should be made as below:
