...
<div class="infoBlock">
Refer to the <a href="https://docs.rudderstack.com/sources/event-streams/sdks/rudderstack-javascript-sdk/filtering/#filtering-destinations">Filtering selective destinations</a> guide for more information on filtering the destinations.
</div>
