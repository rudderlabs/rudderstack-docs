...
The below section covers detailed steps to migrate to JavaScript SDK v1.1 depending on your approach for JavaScript SDK v1 installation.

### Forwarding/proxying the RudderStack CDN

<div class="successBlock">
Refer to the <Link to="/user-guides/how-to-guides/custom-domains/#setup-for-serving-the-sdk">Custom Domains</Link> guide to use a custom domain to forward or proxy the JavaScript SDK via your own CDN.
</div>
...
<div class="successBlock">
Refer to the <Link to="/user-guides/how-to-guides/self-hosting-js-sdk/">How to host RudderStack JavaScript SDK on your CDN/Storage</Link> guide for detailed steps on how to self-host the JavaScript SDK via your CDN.
</div>

- If your JavaScript SDK file name is `rudder-analytics.min.js` and:
