...
- If you have self-hosted the JavaScript SDK in the below recommnended structure:

  <img src="../../../../assets/js-sdk-recommended-folder-structure.png" alt="Recommended structure for self-hosting RudderStack's CDN" />

  <br/>

  Meaning, the file name of the JavaScript SDK is `rudder-analytics.min.js`, and the device mode destination SDKs are located next to the core SDK file under the `js-integrations` directory, update the script tag as shown:
