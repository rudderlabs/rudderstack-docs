...
The **JavaScript SDK  v1.1** is a lightweight, more efficient, and optimized version of the <Link to="/sources/event-streams/sdks/rudderstack-javascript-sdk/">RudderStack JavaScript SDK</Link> and offers the following features:
