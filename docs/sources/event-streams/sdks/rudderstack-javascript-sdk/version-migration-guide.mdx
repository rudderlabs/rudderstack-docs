...
- If the file name of your self-hosted JavaScript SDK is `rudder-analytics.min.js`, and:
  - The device mode destination SDKs are located next to the core SDK file under the `js-integrations` directory, update the script tag as shown:
