...
<div class="warningBlock">
Refer to the <Link to="/event-spec/ecommerce-events-spec/">Ecommerce Events Specification</Link> for more information on the ecommerce events captured by RudderStack.
</div>
