...
<div class="warningBlock">
Refer to the <Link to="/event-spec/ecommerce-events-spec/">E-Commerce Events Specification</Link> guide for more information on the ecommerce events captured by RudderStack.
</div>
