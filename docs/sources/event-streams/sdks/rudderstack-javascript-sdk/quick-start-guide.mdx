...
| Method           | Description                                          |
| :--------------- | :--------------------------------------------------- |
| <Link to="/sources/event-streams/sdks/rudderstack-javascript-sdk/load-js-sdk/#loading-javascript-sdk">`load()`</Link>     | Loads `analytics.js` with the specified write key. |
