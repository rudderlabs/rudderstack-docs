...
<img src="../../../../assets/event-stream-sources/javascript-setup.png" alt="JavaScript source write key" />

<div class="successBlock">
The SDK installation snippet (seen above) contains both the <Link to="/resources/glossary/#write-key">write key</Link> and <Link to="/dashboard-guides/overview/#data-plane-url">data plane URL</Link>, by default.
</div>
