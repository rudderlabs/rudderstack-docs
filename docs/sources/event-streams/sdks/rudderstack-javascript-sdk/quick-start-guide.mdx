...
- Once signed up, <Link to="/dashboard-guides/sources/#adding-a-source">set up a JavaScript source</Link> in the dashboard. You should be able to see a **Write Key** for this source, as shown below:

<img src="../../../../assets/event-stream-sources/javascript-write-key.png" alt="JavaScript source write key" />
...
The <strong>Setup</strong> tab in the RudderStack dashboard (seen above) has an SDK installation snippet containing both the write key and the data plane URL. You can use it to integrate the JavaScript SDK into your website.
</div>
...
- Makes the `page()`call to track the page view. It auto-captures properties such as `path`, `referrer`, `search`, `title`, and `URL`. If you want to override them, refer to the [**`page`**](https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/#page) API method.
...
- To get the source write key, follow [**this guide**](https://www.rudderstack.com/docs/get-started/rudderstack-open-source/sending-test-events#get-the-source-write-key).
- To get the data plane URL, follow [**this guide**](https://www.rudderstack.com/docs/get-started/rudderstack-open-source/data-plane-setup#what-is-a-data-plane-url-where-do-i-get-it).
...
In the above example, the user-related information like the `userId` and `email` along with the [**contextual information**](https://rudderstack.com/docs/event-spec/standard-events/common-fields/#javascript-sdk) is captured.
...
For more information, refer to the <a href="https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/#identify">Identify</a> section of the SDK documentation.
...
For more information on the JavaScript SDK API methods, refer to the <a href="https://www.rudderstack.com/docs/get-started/rudderstack-open-source/data-plane-setup#what-is-a-data-plane-url-where-do-i-get-it">JavaScript SDK APIs</a> section of the SDK documentation.
