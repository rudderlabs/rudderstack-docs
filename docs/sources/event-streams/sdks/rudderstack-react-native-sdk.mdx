...
<img src="../../../assets/event-stream-sources/reactnative-write-key-new.png" alt="React Native source write key" />
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:left">
        <code class="inline-code">trackAppLifecycleEvents</code>
      </td>
      <td style="text-align:left">
...
You can disable these events by passing <code class="inline-code">trackAppLifecycleEvents</code> as <code class="inline-code">false</code> in the configuration object. However, we recommend keeping them enabled.
</div>
