---
title: "Go"
description: Use RudderStack’s Go SDK to send events to various destinations.
---
...
- Once signed up, <Link to="/dashboard-guides/sources/#adding-a-source">set up a Go source</Link> in the dashboard. You should be able to see a **Write Key** for this source, as shown below:

<img src="../../../assets/event-stream-sources/go-write-key-new.png" alt="Go source write key" />
