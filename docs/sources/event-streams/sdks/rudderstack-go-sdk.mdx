...
You can install the RudderStack Go SDK via the `go get` command. 

<div class="warningBlock">
It is highly recommended to use a tool like <a href="https://github.com/tools/godep">Godep</a> to avoid the issues related to any breaking API changes introduced between major versions of the library.
</div>
...
| `maxConcurrentRequests` | Integer   | Maximum number of parallel goroutines to be spawned.          |
