...
<img src="../../../assets/event-stream-sources/cordova-write-key-new.png" alt="Cordova source write key" />
...
Check the <a href="https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-cordova-sdk/#configuring-your-options-object">Configuring the options object</a> section below for detailed information on the parameters you can send in the <code class="inline-code">options</code> object.
</div>
