...
RudderStack lets you enable automatic recording of screen views while initializing the Flutter SDK. This feature automatically triggers a `screen` call for every screen view activity on the app.

By default, automatic screen recording is **disabled** in the Flutter SDK. To enable it, follow these steps:
