---
title: "Ruby"
description: Use RudderStack’s Ruby SDK to send events to various destinations.
---
...
- Once signed up, <Link to="/dashboard-guides/sources/#adding-a-source">set up a Ruby source</Link> in the dashboard. You should be able to see a **Write Key** for this source, as shown below:

<img src="../../../assets/event-stream-sources/ruby-write-key-new.png" alt="Ruby source write key" />
...
The <strong>Setup</strong> tab in the RudderStack dashboard (seen above) has an SDK installation snippet containing both the write key and the data plane URL. You can use it to integrate the Ruby SDK into your application.
</div>
