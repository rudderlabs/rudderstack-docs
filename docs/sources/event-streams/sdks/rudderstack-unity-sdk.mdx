...
Refer to the <a href ="https://www.rudderstack.com/docs/event-spec/application-lifecycle-events-spec/#application-updated">Application Lifecycle Events Specification</a> guide for more information.
</div>
