...
The **RudderStack Unity SDK** is a wrapper for the RudderStack [**Android SDK**](https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-android-sdk/) and [**iOS SDK**](https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-ios-sdk/) and is used for tracking game event data. After integrating this SDK with your game, you will be able to track your game event data and send it to your specified destinations via RudderStack.
...
- Once signed up, <Link to="/dashboard-guides/sources/#adding-a-source">set up a Unity source</Link> in the dashboard. You should be able to see a **Write Key** for this source, as shown below:

<img src="../../../assets/event-stream-sources/unity-write-key-new.png" alt="Unity source write key" />
...
- Select `rudder-sdk-unity.unitypackage` from the downloaded location and click **Open**, as shown:
