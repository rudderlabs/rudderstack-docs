...
description: Ingesting your event data from Iterable into RudderStack.
aliases: ["Iterable source", "Iterable webhook source", "Iterable event stream"]
---

<div class="infoBlock">
For ingesting your Iterable records and sending them to your warehouse destinations via RudderStack, refer to the <Link to="/docs/sources/extract/iterable/">Iterable Cloud Extract</Link> documentation.
</div>
