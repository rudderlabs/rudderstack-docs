...
<div class="infoBlock">
For ingesting your Iterable records and sending them to your warehouse destinations via RudderStack, refer to the <Link to="/sources/extract/iterable/">Iterable Cloud Extract</Link> documentation.
</div>
...
5. Click **Create Webhook** and enter the webhook URL obtained in **Step 3** in the **Endpoint URL** field, as shown:
