...
3. Specify the **Rudder Server URL** to which Looker forwards the user looks data. The URL is `https://hosted.rudderlabs.com/v1/batch`.
...
<div class="infoBlock">
The column names in your looks are transformed as <code class="inline-code">view name.column name</code> in the payload sent to RudderStack. If you want to change the names as per your end-destination, you can do so using RudderStack's <Link to="/transformations/">Transformations</Link> feature.
</div>