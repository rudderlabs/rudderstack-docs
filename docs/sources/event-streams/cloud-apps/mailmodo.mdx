...
| :------------------ | :------------- |:------------- |
| `mailmodoUserId`  | `context.externalId[0].type`    | If `triggerData.userId` is present |
| `triggerData.userId`/`userId`        | `context.externalId[0].value`        | - |
| SHA-256 hash of `triggerData.email`/`recipientData.email`/`recipientEmail` | `anonymousId`        | -|
| `email`/`recipientData`    | `context.traits`  | - |
| `triggerData`/`eventData`     | `properties`   |- |
