...
1. Go to your [RudderStack dashboard](https://app.rudderstack.com/) and click **Add Source**. From the list of **Event Stream** sources, select **Auth0**.
2. Assign a name to your source and click **Continue***.
3. Your Auth0 source is now configured. Note the source **Write key** required to configure the endpoint URL.

<img src="../../../assets/event-stream-sources/auth0-write-key.png" alt="Auth0 source write key" />
