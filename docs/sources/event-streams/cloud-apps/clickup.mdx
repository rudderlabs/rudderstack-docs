...
To do this, set up a ClickUp source by following the steps in the <Link to="#getting-started">Getting started</Link> section above. Then, connect this source to the <Link to="https://www.rudderstack.com/docs/destinations/streaming-destinations/hubspot-v2/">HubSpot destination</Link>.
