...
| :---| :---- | :---- | :---- |
| `revenue` |  Yes | Yes | `/suppression/blocks` |
| `funnels` | Yes | Yes |  `/suppression/bounces` |
| `export` | Yes | Yes |  `/marketing/campaigns`|
| `engage` | Yes | No |  `/marketing/contacts` |
| `cohorts` | Yes | Yes |  `/suppression/unsubscribes`|
| `cohort_members` | Yes | No | `/suppression/invalid_emails` |
| `annotations` | Yes | No |  `/marketing/lists`|
