...
This version of the HubSpot source will be deprecated soon. Refer to the <a href="https://www.rudderstack.com/docs/sources/extract/hubspot-v2/">HubSpot v2</a> guide for the latest documentation.
</div>
...
* **HubSpot software**: Select the appropriate HubSpot software from the dropdown, as shown:

<img src="../../assets/cloud-extract-sources/hubspot-blendo-connection-settings-1.png" alt="HubSpot connection settings" />

* **Choose an account**: Click **Connect with HubSpot** and grant RudderStack the necessary permissions to access your HubSpot data.

<img src="../../assets/cloud-extract-sources/hubspot-blendo-connection-settings-2.png" alt="HubSpot connection settings" />
...
<img src="../../assets/cloud-extract-sources/hubspot-blendo-connection-settings-3.png" alt="Selecting the data to import" />
