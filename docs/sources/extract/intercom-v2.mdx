...
The Intercom v2 source supports <strong>Intercom API v2.1 and above</strong>. For the older versions of Intercom, refer to <a href="https://rudderstack.com/docs/sources/extract/intercom/">this</a> documentation.
</div>
