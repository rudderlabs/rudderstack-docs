...
[Zendesk Support](https://support.zendesk.com/hc/en-us) is one of the popular Zendesk platforms which lets you handle customer support operations by offering support through various mediums such as email, mobile, social media, and voice.
...
<img src="../../assets/cloud-extract-sources/zendesk-support-connection-settings.png" alt="Zendesk Support connection settings" />
...
- **Subdomain**: Enter the subdomain from your Zendesk account's URL. For example, if your Zendesk account URL is `example.zendesk.com`, the subdomain would be `example`.
...
<img src="../../assets/cloud-extract-sources/zendesk-support-resources.png" alt="Selecting the data to import" />

The below table mentions the syncs supported by these resources from Zendesk Support to your warehouse destination:
