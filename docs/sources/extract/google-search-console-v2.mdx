...
| `search_analytics_by_page` | No | No |  `/searchAnalytics/query` |
| `search_analytics_by_device` | No | Yes |  `/searchAnalytics/query`|
| `search_analytics_by_date` | No | No | `/searchAnalytics/query` |
| `search_analytics_by_country` | No | No |  `/searchAnalytics/query`|
| `search_analytics_all_fields` | No | No |  `/searchAnalytics/query`|
