...
<img src="../../assets/cloud-extract-sources/Iterablev2-6.png" alt="Configuring the source" />
...
### Sync errors for older Iterable API versions

For Iterable versions less than **2.1**, data syncs to the warehouse destination will fail and throw an error. This is because many Iterable resources are not supported by the older API versions.

In such a scenario, it is highly recommended to updated your Iterable API.

<div class="infoBlock">
For more information on updating your Iterable API version, refer to this <a href="https://developers.Iterable.com/building-apps/docs/update-your-api-version">Iterable support page</a>.
</div>
