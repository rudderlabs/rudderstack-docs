...
RudderStack does not support creating a custom GAQL query for the <code class="inline-code">click_view</code> resource as it requires a <a href="https://developers.google.com/google-ads/api/fields/v11/click_view">filter limiting the results to one day</a>. You can use the <code class="inline-code">clickView</code> predefined stream instead.
</div>
