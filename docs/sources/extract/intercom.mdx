...
<div class="infoBlock">
The Intercom source supports <strong>Intercom API v2.1 and above</strong>.
</div>
...
- At the panel on the left, select **Sources**. Then, click **Add Source**.

- Next, go to **Cloud Extract** and select **Intercom**.

<img src="../../assets/cloud-extract-sources/intercomv2-1.png" alt="Intercom source" />
...
- Optionally, you can also specify the time of the sync by selecting the time under **Sync Starting At**. Then, click **Next**.
...
<div class="successBlock">
  ...
  Use the <strong>Use Existing Destination</strong> option if you have already configured a data warehouse destination in RudderStack. To configure a data warehouse destination from scratch, click the <strong>Create New Destination</strong> button.
</div>
