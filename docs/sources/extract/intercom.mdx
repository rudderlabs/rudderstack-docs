...
- Authenticate RudderStack with Intercom by clicking the **Connect with Intercom V2** button.
...
| Resource | Full Refresh sync | Incremental sync | Endpoint | Primary key |
| :---| :---| :----| :----| :----|
| `admins` | Yes | No | `/admins` | `id` |
| `companies` | Yes | Yes |  `/companies/scroll` | `id` |
| `company segments` | Yes | Yes | `/companies/<id>/segments` | `id` |
| `company attributes` | Yes | No | `/data_attributes?model=company` | `name` |
| `conversations` | Yes | Yes | `/conversations` | `id` |
| `conversation parts` |  Yes | Yes | `/conversations/<id>` | `id` |
| `contacts` | Yes | Yes | `/contacts` | `id` |
| `contact attributes` |Yes | No | `/data_attributes?model=contact` | `name` |
| `segments` | Yes | Yes | `/segments` | `id` |
| `tags` | Yes | No | `/tags` | `name` |
| `teams` | Yes | No | `/teams` | `name` |
