...
This source will be deprecated soon. Refer to the <Link to="/sources/extract/bing-ads-v2/">Bing Ads V2</Link> guide for the latest documentation.
</div>
...
<img
  src="../../assets/1 (15) (1) (1).png"
  alt="Log into your RudderStack Dashboard"
/>

- Then, click the **Directory** option on the left navigation bar and go to **Cloud Extract** under **Sources**. From the list of sources, click **Bing Ads**.

<!--<img src="../../assets/1 (26).png" />-->

<img src="../../assets/1 (26).png" alt="Directory" />

- Assign a name to your source, and click **Next**.
- Then, click the **Connect with Bing Ads** option. Give RudderStack the required permissions to access your Bing Ads account.

<!--<img src="../../assets/2 (30).png" />-->

<img src="../../assets/2 (30).png" alt="Connect with Bing Ads" />
...
<!--<img src="../../assets/6 (24).png" />-->

<img src="../../assets/6 (24).png" alt="Add Destination" />
