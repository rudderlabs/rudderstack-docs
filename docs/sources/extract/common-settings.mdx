...
<div class="infoBlock">
If a resource supports the <strong>Incremental</strong> sync mode, it supports the <strong>Full Refresh</strong> sync mode by default. However, RudderStack syncs the data using the <strong>Incremental</strong> mode for such resources. If you want to use the <strong>Full Refresh</strong> sync mode, <a href="mailto:%20support@rudderstack.com">contact the RudderStack team</a>.
</div>
