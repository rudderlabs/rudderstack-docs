...
description: Configure cloud extract sources with these common settings.
---
...
To trigger a sync manually, go to the **Syncs** tab in your Cloud Extract source details page and click **Sync Now**, as shown:
...
1. Go to the **Settings** tab in your Cloud Extract source details page and click **Edit sync schedule** option, as shown:
