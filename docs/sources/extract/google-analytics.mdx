...
This guide will help you set up Google Analytics as a source in RudderStack. Once configured, RudderStack automatically ingests your specified Google Analytics data and routes it to your data warehouse.

<div class="dangerBlock">
This source will be deprecated soon. Refer to the <Link to="/sources/extract/google-analytics-v2/">Google Analytics V2</Link> guide for the latest documentation.
</div>
