...
This source will be deprecated soon. Refer to the <Link to="/sources/extract/salesforce-v2/">Salesforce V2</Link> guide for the latest documentation.
</div>
...
<div class="warningBlock">
Salesforce’s API enforces a strict usage limit. A high <strong>Run Frequency</strong> may exceed your Salesforce’s API and result in failure when RudderStack tries to sync your data.
</div>
