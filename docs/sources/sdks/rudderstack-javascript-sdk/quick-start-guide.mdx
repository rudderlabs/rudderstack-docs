...
- To get the source write key, follow [**this guide**](https://docs.rudderstack.com/rudderstack-open-source/installing-and-setting-up-rudderstack/sending-test-events/#get-the-source-write-key).
- To get the data plane URL, follow [**this guide**](https://docs.rudderstack.com/rudderstack-open-source/installing-and-setting-up-rudderstack/#what-is-a-data-plane-url-where-do-i-get-it).
...
For more information on the JavaScript SDK API methods, refer to the <a href="https://docs.rudderstack.com/sources/sdks/rudderstack-javascript-sdk/#supported-apis">JavaScript SDK APIs</a> section of the SDK documentation.
</div>
