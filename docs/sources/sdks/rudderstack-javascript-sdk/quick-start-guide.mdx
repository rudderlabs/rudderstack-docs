...
- Makes the `page()`call to track the page view. It auto-captures properties such as `path`, `referrer`, `search`, `title`, and `URL`. If you want to override them, refer to the [**`page`**](https://rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/#page) API method.
...
For more information, refer to the <a href="https://rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/#identify">Identify</a> section of the SDK documentation.
