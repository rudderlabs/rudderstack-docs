...
title: "Data Storage"
description: >-
  Detailed technical documentation on how the JavaScript SDK stores persistent user data in cookies or local storage.
---

The JavaScript SDK stores persistent user data in the cookies by default. If the cookies are not supported, local storage is used instead. 
