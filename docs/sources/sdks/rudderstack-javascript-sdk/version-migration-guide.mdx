...
3. If none of the above options are applicable, uses the default CDN URL: [https://cdn.rudderlabs.com/v1.1/js-integrations/](https://cdn.rudderlabs.com/v1.1/js-integrations/).
