...
The latest **JavaScript SDK (v1.1)** is the latest lightweight, efficient, and optimized version of the SDK. Its size is reduced by approximately 70% which considerably increases its loading speed.
