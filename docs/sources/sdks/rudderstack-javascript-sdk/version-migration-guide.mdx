...
The **JavaScript SDK  v1.1** is a lightweight, more efficient, and optimized version of the [RudderStack JavaScript SDK](https://rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/) and offers the following features:
