...
RudderStack supports a few canonical names for destinations. You can find more information regarding these canonical names in the <a href="https://www.rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk#common-destination-names">common destination names</a> section of the SDK documentation.
...
<img
  src="../../../assets/requireintegration-call-flow.png"
  alt="requireIntegration call flow"
/>
