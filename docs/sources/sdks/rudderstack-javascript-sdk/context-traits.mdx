...
description: >-
  Detailed technical documentation on capturing event-specific and use-specific data using the context and trait dictionaries.
---

RudderStack provides you with the option to automatically capture certain event-specific and user-specific data, based on the type of the event.

The `context` and `traits` dictionaries are included in the [`options`](#options) parameter of the API methods.
