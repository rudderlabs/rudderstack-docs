...
To quickly set up and start using the RudderStack JavaScript SDK, go through our [**quick start guide**](https://docs.rudderstack.com/sources/sdks/rudderstack-javascript-sdk/quick-start-guide).
...
For more information on the consent managers supported by RudderStack, refer to <a href="https://rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/consent-managers/">this section</a>.
</div>
