...
| `cookieConsentManagers` | Object | Refer to the [cookieConsentManager](https://www.rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/#cookieconsentmanager) section for more information. | - |
