...
- Once signed up, you need to [set up a Flutter source](https://www.rudderstack.com/docs/destinations/sources/#adding-a-source) in the dashboard.  You should then see a **Write Key** for this source, as shown:
