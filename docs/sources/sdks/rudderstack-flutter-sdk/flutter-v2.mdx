...
To install and use the Flutter SDK in your web app, follow the above steps to add the Flutter SDK. Additionally, you need to <Link to="/sources/sdks/rudderstack-javascript-sdk/quick-start-guide/#step-1-install-javascript-sdk">install the RudderStack script</link> in the `<head>` section of your web page.
...
| `cookieConsentManagers` | Object | Refer to the <Link to="/sources/sdks/rudderstack-javascript-sdk/load-js-sdk/#cookieconsentmanager">cookieConsentManager</Link> section for more information. | - |
