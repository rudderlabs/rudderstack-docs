...
We've released a new, beta version of the <a href="https://www.rudderstack.com/docs/sources/sdks/rudderstack-flutter-sdk/flutter-v2/" target="_blank">Flutter SDK (v2)</a> with an enhanced architecture that also supports the <strong>web</strong>.
</div>

<div class="infoBlock">

If you are using an older version of the Flutter SDK (<1.2.0), then refer to the <a href="https://rudderstack.com/docs/sources/sdks/rudderstack-flutter-sdk/flutter-v1/">SDK v1</a> guide. <strong>Note that this SDK version will soon be deprecated.</strong>
</div>
