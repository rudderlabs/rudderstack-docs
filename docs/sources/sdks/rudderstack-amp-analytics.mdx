...
- Once signed up, <Link to="/dashboard-guides/sources/#adding-a-source">set up an AMP source</Link> in the dashboard.  You should then see a **Write Key** for this source, as shown below:
