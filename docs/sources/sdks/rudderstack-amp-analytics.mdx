...
* You need a data plane URL. Follow [**this section**](https://www.rudderstack.com/docs/get-started/rudderstack-open-source/#what-is-a-data-plane-url-where-do-i-get-it) for more information on the data plane URL and where to get it.
