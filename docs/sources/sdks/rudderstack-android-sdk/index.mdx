...
- Once signed up, set up an Android source in the dashboard. For more information, follow [**this guide**](https://www.rudderstack.com/docs/rudderstack-cloud/sources/#adding-a-source).  You should then see a **Write Key** for this source, as shown below:
...
Follow our guide on <a href="https://rudderstack.com/docs/sources/sdks/rudderstack-android-sdk/add-an-application-class-to-you-android-application">Adding an Application Class to Your Android Application</a> for more information.
</div>
...
Follow our guide on [How to Add an Application Class to Your Android App](https://rudderstack.com/docs/sources/sdks/rudderstack-android-sdk/add-an-application-class-to-you-android-application/) to add an `Application` class.
