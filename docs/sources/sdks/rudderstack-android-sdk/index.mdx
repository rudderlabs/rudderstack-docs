...
Follow our guide on <a href="https://rudderstack.com/docs/sources/sdks/rudderstack-android-sdk/adding-an-application-class">Adding an Application Class to Your Android Application</a> for more information.
</div>
...
Follow our guide on [How to Add an Application Class to Your Android App](https://rudderstack.com/docs/sources/sdks/rudderstack-android-sdk/adding-an-application-class/) to add an `Application` class.
...
For more information on the `optOut` API, refer to the [**Enabling/Disabling User Tracking via optOut API**](https://rudderstack.com/docs/sources/sdks/rudderstack-android-sdk/#enabling-disabling-user-tracking-via-the-optout-api-gdpr-support) section above.
</div>
