...
- Once signed up, <Link to="/dashboard-guides/sources/#adding-a-source">set up a Rust source</Link> in the dashboard. You should then see a **Write Key** for this source, as shown below:

<img src="../../assets/event-stream-sources/rust-write-key.png" alt="Rust source write key" />
