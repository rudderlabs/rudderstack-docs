...
- Once signed up, set up a Rust source in the dashboard. For more information, see <Link to="/dashboard-guides/sources/#adding-a-source">Adding a source</Link>. You should then see a **Write Key** for this source, as shown below:
