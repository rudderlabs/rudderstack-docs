...
- Set up an iOS source in the dashboard. For more information, refer to the <Link to="/dashboard-guides/sources/">Sources</Link> guide.  You should then see a **Write Key** for this source, as shown:

<img src="../../../assets/event-stream-sources/ios-sdk-1.png" alt="iOS source write key" />

- You also need a data plane URL. Follow <Link to="/dashboard-guides/overview#data-plane-url">Data plane URL</Link> section for more information on the data plane URL and where to get it.
...
<div class="infoBlock">
Refer to the <Link to="/sources/sdks/event-filtering/">Client-side Event Filtering</Link> guide for more information on this feature.
</div>
