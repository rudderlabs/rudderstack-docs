...
- Once signed up, set up a Cordova source in the dashboard. For more information, follow [this guide](https://www.rudderstack.com/docs/dashboard-guides/sources/#adding-a-source).  You should then see a **Write Key** for this source, as shown below:

<img src="../../assets/event-stream-sources/cordova-sdk-1.png" alt="Cordova source write key" />

- You will also need a data plane URL. Follow [**this section**](https://www.rudderstack.com/docs/get-started/rudderstack-open-source/#what-is-a-data-plane-url-where-do-i-get-it) for more information on the data plane URL and where to get it.
