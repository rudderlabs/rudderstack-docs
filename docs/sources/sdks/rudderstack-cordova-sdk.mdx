...
- Once signed up, set up a Cordova source in the dashboard. For more information, follow [this guide](https://www.rudderstack.com/docs/rudderstack-cloud/sources/#adding-a-source).  You should then see a **Write Key** for this source, as shown below:
