...
No. The SDK is a React Native module, and currently, the expo doesn't support adding native modules. You can still [**eject**](https://docs.expo.dev/expokit/eject/) your Expo application and use the RudderStack [<Link to="/sources/sdks/rudderstack-android-sdk/">Android</Link> and <Link to="/sources/sdks/rudderstack-ios-sdk/">iOS</Link> SDKs.
