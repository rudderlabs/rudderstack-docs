...
Use the [`analytics.js`](https://github.com/rudderlabs/rudder-sdk-js) library to track customer event data from your websites and send it to your specified destinations via RudderStack.
