...
In the following sections we'll provide a bit more detail on the available source types, with links to the setup guides for each source. If you're new to RudderStack, we recommend going through our <Link to="/tmp-get-started/quickstart/">Quickstart</Link> guide to create your first source using our JavaScript SDK.
...
These integrations rely on webhooks to track event data from user interactions.
