...
The following sections provide more detail on the available source types, with links to the setup guides for each source. If you're new to RudderStack, it is recommended going through the <Link to="/get-started/quickstart/">Quickstart</Link> guide to create your first source using the <Link to="/sources/sdks/rudderstack-javascript-sdk/">JavaScript SDK</Link>.

## Event Streams

Collect event data from all your sites and applications and route it to a wide array of customer tools and data warehouses.
...
Ingest event data from your cloud apps and route it to the desired destinations.
