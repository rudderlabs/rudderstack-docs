...
Use the [`analytics.js`](https://github.com/rudderlabs/rudder-sdk-js) library to track your customer event data from your websites and send it to your specified destinations via RudderStack.
...
These sources stream event data asynchronously via webhooks and let you track the event data from user interactions.
