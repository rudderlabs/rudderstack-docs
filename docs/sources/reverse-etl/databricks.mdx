...
###  Does Rudderstack spin the Databricks cluster/sql end point everytime it needs to write?

No, it is something providede by the Databricks. We need to configure automatic termination in the Auto Termination field in the Autopilot Options box on the cluster creation page. Refer to <Link to="https://docs.databricks.com/clusters/clusters-manage.html#automatic-termination-1">Databricks documentation</Link> for more information.
