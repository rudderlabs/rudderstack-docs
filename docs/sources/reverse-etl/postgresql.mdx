---
title: "PostgreSQL"
description: Sync data from PostgreSQL to your preferred destination via RudderStack.
---
...
## Setting up the PostgreSQL source

1. Log into your [RudderStack dashboard](https://app.rudderstack.com).
2. From the left panel, go to **Directory** > **Sources** > **Reverse ETL**. Then, select **PostgreSQL**.
...
Specify the **Schedule Settings** to schedule the data syncs from your PostgreSQL source.
...
Once you successfully set up your PostgreSQL source, you can connect it to your preferred destination by clicking the **Add Destination** button, as shown:
