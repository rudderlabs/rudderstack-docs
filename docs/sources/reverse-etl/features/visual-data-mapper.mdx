...
RudderStack supports two modes for syncing your data - <strong>Upsert</strong> and <strong>Mirror</strong>. For more information on these modes, refer to the <a href="https://www.rudderstack.com/docs/sources/reverse-etl/common-settings/sync-modes/">Sync Modes</a> guide.
</div>
