...
To use this feature, you can use a <a href="https://rudderstack.com/docs/reverse-etl/">Reverse ETL source</a> and then connect it to a VDM-supported destination.
</div>
...
1. Set up a [Reverse ETL](https://rudderstack.com/docs/reverse-etl/) source and connect it to a destination. You should then see the following screen:
