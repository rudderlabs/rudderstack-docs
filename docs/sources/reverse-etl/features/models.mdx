---
title: "Models"
description: Create, update, and fetch details from custom SQL models.
---
...
3. Select the Reverse ETL source for the model and click **Next**.

<img src="../../../assets/warehouse-actions-sources/select-source-model.png" alt="Add Model"/>

4. Enter a name for the model.
5. Select your existing warehouse credentials or click **Create Credentials from Scratch** and enter the warehouse-specific details.
...
<div class="infoBlock">
Once you select or add your warehouse credentials and click <strong>Next</strong>, RudderStack will validate them before you can proceed with the setup. For more information on these validations, refer to the <a href="#faq">FAQ</a> section below.
</div>

6. Next, enter the **Description** for the model. Then, add your custom SQL query in the **Query** section. 
7. Click **Run Query** to preview the result.
...
8. Click **Next** to create the model.
...
- **Sources**: Displays the sources associated with the model. To learn more on how to use a model with a source, refer to the <Link to="/sources/reverse-etl/features/models/">Setting Up Connections Using Models</Link> guide.
