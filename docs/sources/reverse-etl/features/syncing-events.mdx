...
Some key features for syncing the event data from Reverse ETL sources are listed below:
...
2. Connect the source to the required downstream destination by configuring the destination settings as listed in either of the following guides:
- <Link to="/sources/reverse-etl/common-settings/importing-data-using-tables/">Importing Data using Tables</Link>: If you have configured your source using the Table option.
- <Link to="/sources/reverse-etl/common-settings/importing-data-using-models/">Importing Data using Models</Link>: If you have configured your source using the Models option.
