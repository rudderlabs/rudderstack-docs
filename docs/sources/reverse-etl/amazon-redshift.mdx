...
<ul>
<li><a href="https://www.rudderstack.com/docs/sources/reverse-etl/common-settings/importing-data-using-tables/">Importing Data using Tables</a></li>
<li><a href="https://www.rudderstack.com/docs/sources/reverse-etl/common-settings/importing-data-using-models/">Importing Data using Models</a></li>
</ul>
</div>
