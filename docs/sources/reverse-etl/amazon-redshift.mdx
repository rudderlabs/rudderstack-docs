...
description: Sync data from Amazon Redshift to your preferred destination via RudderStack.
---
...
## Setting up the Redshift source

1. Log into your [RudderStack dashboard](https://app.rudderstack.com).
2. From the left panel, go to **Directory** > **Sources** > **Reverse ETL**. Then, select **Redshift**.
...
Specify the **Schedule Settings** to schedule the data syncs from your Redshift source.
...
Once you successfully set up your Redshift source, you can connect it to your preferred destination by clicking the **Add Destination** button, as shown:
