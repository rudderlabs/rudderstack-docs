...
To trigger a sync manually, go to the **Syncs** tab in your Reverse ETL source details page and click **Sync Now**, as shown:
...
1. Go to the **Syncs** tab in your Reverse ETL source details page and click the settings button as shown:
...
Alternatively, you can also go to the **Settings** tab and click the **Edit sync schedule** button to define your new schedule type.
