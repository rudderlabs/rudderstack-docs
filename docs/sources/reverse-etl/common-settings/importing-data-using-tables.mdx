...
description: Import data from reverse ETL sources using a table configuration.
---
...
The best combination for a primary key is the <code class="inline-code">timestamp</code> and <code class="inline-code">user_id</code>.
</div>
