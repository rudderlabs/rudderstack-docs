...
This guide is applicable for Reverse ETL sources configured using the <strong>Table</strong> option. If you have configured your Reverse ETL source using the <strong>Model</strong> option, refer to the <a href="https://www.rudderstack.com/docs/sources/reverse-etl/common-settings/importing-data-using-models/">Importing Data using Models</a> guide.
</div>
