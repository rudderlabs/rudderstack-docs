...
RudderStack gives you two options to map your columns to specific destination fields while importing the data:

- Map with <Link to="/sources/reverse-etl/features/visual-data-mapper/">Visualizer</Link> (Currently supported only for selective destinations)
- Map with JSON
...
- **Primary Key**: Select the column to uniquely identify your records in the warehouse.
