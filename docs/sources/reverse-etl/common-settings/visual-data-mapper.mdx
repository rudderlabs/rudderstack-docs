...
Visual Data Mapper is supported for the following destinations:

- <Link to="/destinations/streaming-destinations/amplitude/">Amplitude</Link>
...
- <Link to="https://www.rudderstack.com/docs/destinations/streaming-destinations/google-adwords-remarketing-list/">Google Adwords Remarketing Lists (Customer Match)</Link>
...
- <Link to="/destinations/streaming-destinations/iterable/">Iterable</Link>
- <Link to="/destinations/streaming-destinations/klaviyo/">Klaviyo</Link>
- <Link to="/destinations/streaming-destinations/mailchimp/">Mailchimp</Link>
- <Link to="https://www.rudderstack.com/docs/destinations/streaming-destinations/marketo/">Marketo</Link>
- <Link to="/destinations/streaming-destinations/salesforce/">Salesforce</Link>
