...
### Which event types are supported by the Reverse ETL sources?

Reverse ETL sources support the `identify` and `track` events. Refer to the <Link to="/sources/reverse-etl/features/visual-data-mapper/">Sending Event Data</Link> guide for more information on sending these event types.
...
For more information, refer to the <a href="https://www.rudderstack.com/docs/sources/reverse-etl/common-settings/sync-schedule-settings/" target="_blank">Sync Schedule Settings</a> guide.
</div>
...
For more information, refer to the <a href="https://www.rudderstack.com/docs/sources/reverse-etl/common-settings/sync-modes/" target="_blank">Sync Modes</a> guide.
</div>
