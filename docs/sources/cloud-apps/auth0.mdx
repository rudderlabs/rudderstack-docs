...
<div class="infoBlock">
Refer to the <a href="https://auth0.com/docs/customize/extensions/auth0-authentication-api-webhooks#troubleshoot-webhooks">Auth0 documentation</Link> for more information on troubleshooting your webhook.
</div>
