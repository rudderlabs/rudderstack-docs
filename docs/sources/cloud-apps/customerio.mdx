...
<div class="infoBlock">
 ...
 Refer to the <Link to="/rudderstack-open-source/installing-and-setting-up-rudderstack/#what-is-a-data-plane-url-where-do-i-get-it">data plane URL</Link> section for more information.
</div>
