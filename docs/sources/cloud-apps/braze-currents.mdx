...
3. Your Braze source is now configured. Note the source **Write key** as it will be required in the later steps.

<img src="../../assets/event-stream-sources/braze-2.png" alt="Braze source write key" />

4. To complete the setup, contact Braze's support team to activate Currents in your Braze account.
...
Braze uses RudderStack's [Event Stream](https://www.rudderstack.com/docs/sources/cloud-apps/#rudderstack-event-streams) functionality to send events to RudderStack. These events can then be transformed and routed to your preferred destinations, including your data warehouse.
