...
<div class="infoBlock">
RudderStack SDKs do not calculate the value for any of the above properties like `revenue`, value, total, etc. These are provided by the customer when they trigger the track API as per their business logic. the fields are calculated separately with business logic and dev work.
</div>
