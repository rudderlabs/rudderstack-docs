---
title: "Wishlist"
description: Understand how ecommerce wishlis events work in RudderStack.
---

Product wishlist events are associated with the key activities that a customer might perform while adding a product to their shopping wishlist. This is useful if your website/app supports a wishlisting feature.
