...
| <Link to="/event-spec/standard-events/merge/">Merge</Link> | Lets you perform identity resolution by associating different identifiers to a given customer profile in the warehouse. | 
