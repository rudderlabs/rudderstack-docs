...
RudderStack follows the <a href="https://www.rfc-editor.org/rfc/rfc7159#section-6">RFC 7159 standards</a> which has an upper limit of 2 <sup>53</sup> for integers. If the values you pass in your events exceed this number, <strong>they may lose precision</strong>. Furthermore, certain downstream destinations might have their own limitations on parsing such integer values.
</div>