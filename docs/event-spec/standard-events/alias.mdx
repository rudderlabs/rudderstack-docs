...
<div class="successBlock">
  ...
  <ul>
    ...
    <li>
      <Link to="/tmp-destinations/streaming-destinations/amplitude/">Amplitude</Link> (only
      supported by the <Link to="/sources/sdks/rudderstack-javascript-sdk/">JavaScript SDK</Link> via <Link to="/tmp-destinations/rudderstack-connection-modes/#cloud-mode">cloud mode</Link>)
    </li>
    <li>
      <Link to="/tmp-destinations/streaming-destinations/mixpanel/">Mixpanel</Link>
    </li>
  </ul>
</div>
