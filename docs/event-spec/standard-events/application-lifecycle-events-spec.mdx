...
<div class="infoBlock">
To disable the auto-tracking of these events, set the <code class="inline-code">withTrackLifecycleEvents</code> parameter to <code class="inline-code">false</code> while initializing the <Link to="/sources/sdks/rudderstack-android-sdk/">Android</Link> / <Link to="/sources/sdks/rudderstack-android-sdk/">Android</Link> SDK.
</div>
...
<div class="infoBlock">
For the Unity SDK, you need to perform the required steps for the Android and iOS platforms to trigger the <strong>Application Updated</strong> lifecycle event. For more information on these steps, refer to the <Link to="/sources/sdks/rudderstack-unity-sdk/#triggering-application-updated-lifecycle-event">Triggering Application Updated lifecycle event</Link> section.
</div>
