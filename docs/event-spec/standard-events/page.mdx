...
<div class="successBlock">
  ...
  The <a href="https://rudderstack.com/docs/sources/sdks/rudderstack-javascript-sdk/">RudderStack JavaScript SDK</a> includes a <code class="inline-code">page</code> call in its snippet just after the <code class="inline-code">rudderanalytics.load</code> method.
</div>
