...
The contextual fields give additional useful context about a particular event. The following table lists all the contextual fields with their detailed description:
...
<strong>All of the above contextual fields are not automatically collected by the RudderStack SDKs.</strong> Refer to the following section for more information on which SDK automatically populates what contextual fields.
</div>
...
| `network.bluetooth` | - | Yes (if permission is granted) | No | Bluetooth information about the network connection. |
...
```json
{
  ...
  "context": {
    ...
    "library": {
      "name": "com.rudderstack.javascript.sdk.core",
      "version": "1.0.0"
    },
    "locale": "en-US",
    "page": {
    ...
    "screen": { "density": 420, "height": 1794, "width": 1080, "innerHeight": 200, "innerWidth": 100 },
...
<div class="infoBlock">
<code class="inline-code">screen.density</code>, <code class="inline-code">ip</code>, <code class="inline-code">network.bluetooth</code>, and <code class="inline-code">userAgent</code> fields are only applicable for the Android SDK whereas the <code class="inline-code">device.adTrackingEnabled</code> field is only applicable for the iOS SDK in the above sample payload.
</div>
      </TabPanel>
    </TabPanels>
</Tabs>
