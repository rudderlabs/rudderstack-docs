...
| `device.type`      | -   | Yes | Yes   |
| `device.id`        | -   | Yes | Yes |
| `device.advertisingId` | - | Yes | Yes |
| `device.adTrackingEnabled` | - | - | Yes |
| `device.manufacturer` | - | Yes | Yes |
| `device.model` | - | Yes | Yes |
| `device.name` | - | Yes | Yes |
| `library.name` | Yes | Yes | Yes |
| `library.version` | Yes | Yes | Yes |
| `ip` | - | Yes | - |
| `locale` | Yes | Yes | Yes |
| `network.bluetooth` | - | Yes (if permission is granted) | No | 
| `network.carrier` | - | Yes | Yes |
| `network.cellular` | - | Yes | Yes |
| `network.wifi` | - | Yes | Yes |
| `os.name` | - | Yes | Yes |
| `os.version` | - | Yes | Yes |
| `page.path` | Yes | - |  - |
| `page.initial_referrer` | Yes | - |  - |
| `page.initial_referring_domain` | Yes | - |  - |
| `page.referrer` | Yes | - |  - |
| `page.referring_domain` | Yes | - |  - |
| `page.search` | Yes | - |  - |
| `page.title` | Yes | - |  - |
| `page.url` | Yes | - |  - |
| `screen.density` | Yes | Yes | - |
| `screen.height` | Yes | Yes | Yes |
| `screen.width` | Yes | Yes | Yes |
| `screen.innerWidth` | Yes |   -   |   -   |
| `screen.innerHeight` | Yes |   -   |   -   |
| `traits` | - | Yes | Yes |
| `userAgent` | Yes | Yes | - |
| `timezone` | - | Yes | Yes |
