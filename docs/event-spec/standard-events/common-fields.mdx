...
<strong>Not all of the above contextual fields are automatically collected by the RudderStack SDKs.</strong> Refer to the following sections for more information on which SDK automatically populates what contextual fields.
</div>
