...
The contextual fields give additional context about a particular event. This section lists all the contextual fields with their detailed description.

The RudderStack SDKs **automatically collect** and populate the following contextual fields:
...
The RudderStack SDKs **do not automatically collect** the following contextual fields:
