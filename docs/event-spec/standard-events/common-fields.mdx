...
All of the above contextual fields are <strong>not</strong> automatically collected by the RudderStack SDKs.
</div>

The following section highlights the contextual fields that are **automatically collected** and populated by each of the RudderStack SDKs:
