...
Once you have completed these steps above successfully, <Link to="/tmp-get-started/rudderstack-open-source/sending-test-events/">send test events</Link>  to verify your installation.
...
<div class="infoBlock">
Refer to the <Link to="/tmp-get-started/rudderstack-open-source/data-plane-setup/kubernetes/#configuration">Configurable parameters</Link> section for information on the parameters that can be configured during deployment.
</div>
...
Once you have completed these steps above successfully, <Link to="/tmp-get-started/rudderstack-open-source/sending-test-events/">send test events</Link> to verify the installation.
