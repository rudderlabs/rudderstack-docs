...
If you have self-hosted the control plane using the open-source <Link to="/tmp-get-started/rudderstack-open-source/control-plane-lite/">Control Plane Lite</Link> utility, follow the <Link to="/tmp-get-started/rudderstack-open-source/control-plane-lite/#developer-machine-setup">Developer Machine Setup instructions</Link> to set up the RudderStack data plane in your development environment.
