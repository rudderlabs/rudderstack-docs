...
The Docker etup is the easiest and the fastest way to get up and running with RudderStack.
</div>
...
If you have self-hosted the control plane using the open-source <Link to="/tmp-get-started/rudderstack-open-source/control-plane-lite/">Control Plane Lite</Link> utility, follow <Link to="//tmp-get-started/rudderstack-open-source/control-plane-lite/#docker">Docker instructions</Link> to set up the data plane.
