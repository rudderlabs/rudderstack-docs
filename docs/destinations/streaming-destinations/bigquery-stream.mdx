...
description: Stream your event data from RudderStack to BigQuery via Google's streaming API.
---
...
- Optionally, you can select a transformation to apply to the events before sending them to the destination. If you do not wish to apply any transformation, select  **No transformation needed** and click **Next** to complete the setup.
...
4. In the **Select a role** field, search and select the **BigQuery User** role and click **CONTINUE**.
