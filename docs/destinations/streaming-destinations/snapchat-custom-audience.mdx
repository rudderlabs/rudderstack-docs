...
- **Account ID**: Enter your Snapchat account ID. For more information on getting your account ID, refer to this <a href="https://businesshelp.snapchat.com/s/article/biz-acct-id?language=en_US">Snapchat support page</a>.
- **Audience ID**: 
- **Schema**: 
...
<div class="infoBlock">
RudderStack supports both <a href="https://marketingapi.snapchat.com/docs/#adding-users">additions</a> and <a href="https://marketingapi.snapchat.com/docs/#removing-users">deletions</a> to an audience list.
</div>
...
For detailed steps on creating a Snapchat Customer List Audience, refer to this <a href="https://businesshelp.snapchat.com/s/article/create-sam-audience?language=en_US">Snapchat support page</a>.