...
<div class="infoBlock">
When sending events via device mode, RudderStack lets you specify which events should be discarded or allowed to flow through. For more information, refer to the <Link to="/sources/event-streams/sdks/event-filtering/">Client-side Event Filtering</Link> guide.
</div>
...
3. Under the **AdRoll Pixel** section, click **View Pixel**, as shown:
