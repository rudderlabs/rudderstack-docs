...
For the Ecommerce track events, if the events fall under the following mapping they will be sent accordingly. Otherwise, the mapping should be done in the dashboard.

<div class="infoBlock">
For more info on the RudderStack Ecommerce Spec, follow the <Link to="/event-spec/ecommerce-events-spec/">Ecommerce Events Specification</Link> guide.
</div>
