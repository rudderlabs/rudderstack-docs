...
```
2. **Create your own CA**: Follow these steps to create your own CA:
...
```
   ...
   ```
3. **Sign the certificate**: Follow the steps below:
...
To summarize, the script to create the CA as well as the broker and client truststores and keystores is obtained with the following commands:
...
5. Add RudderStack's CA certificate to your truststore, as shown:
...
The resulting CA certificate that you need to add to your trust store is shown below:
