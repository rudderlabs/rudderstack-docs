...
<div class="infoBlock">
If <code class="infoBlock">email</code> already exists, the contact details are updated. Otherwise, RudderStack creates a new user in Freshmarketer.
</div>
...
<img src="../../assets/event-stream-destinations/freshsales-api-key.png" alt="Freshmarketer API key" />
