...
[User.com](https://user.com/en/) is a marketing automation platform that helps boost customer engagement and improve conversion. It also provides robust tools for marketing, sales, management, and support teams.
...
<div class="infoBlock">
This algorithm to look up a user is applicable only for the <code class="inline-code">identify</code>, <code class="inline-code">track</code>, and <code class="inline-code">page</code> calls.
</div>
...
Only one of the above (<code class="inline-code">email</code> or <code class="inline-code">phone</code>) must be passed in <code class="inline-code">lookup</code>. Also, the <code class="inline-code">email</code> or <code class="inline-code">phone</code> (whichever is passed) must have unique values in User.com.
</div>
...
| RudderStack property | User.com property | | Presence | 
| :-------| :--------| :------| 
| `userId` | `custom_id`(user) | Required  | 
