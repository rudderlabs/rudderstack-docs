...
RudderStack also supports Mailmodo as a data source. For more information, refer to the <a href ="/sources/event-streams/cloud-apps/mailmodo/">Mailmodo source documentation</a>.
</div>
...
<div class="infoBlock">
Any property apart from the above is sent as a custom property inside <code class="inline-code">traits/context.traits</code> and is mapped to <code class="inline-code">values.data</code> before being sent to Mailmodo.
</div>
