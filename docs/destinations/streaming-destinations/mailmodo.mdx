...
RudderStack supports Mailmodo as a destination where you can seamlessly send your event data.
...
<div class="warningBlock">
To know more about the <code class="inline-code">accepted-param</code> and their mappings, refer to the Github repository.
</div>
