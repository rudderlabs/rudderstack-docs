...
- **Role Based Authentication**: Enable this setting to use role-based AWS authentication for this destination. If this setting is enabled, you can configure the following fields:
