...
- **Track Dynamic Remarketing**: Enable this setting to send your [dynamic remarketing](https://support.google.com/google-ads/answer/7305793) events. When enabled, the following setting is visible:
