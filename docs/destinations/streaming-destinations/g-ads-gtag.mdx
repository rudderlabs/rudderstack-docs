...
- **Send Page View**: Enable this setting to configure Google Ads to automatically send your `page` events.
...
- **Disable Ad Personalization**: Enable this setting to programmatically disable ad personalization. Refer to the [Google Ads documentation](https://developers.google.com/analytics/devguides/collection/gtagjs/display-features#disable_advertising_personalization) for more information on disabling the advertising personalization feature.
...
- **Dynamic Remarketing**: Enable this setting to allow RudderStack to leverage Google Ads' Dynamic Remarketing feature for event tracking. Dynamic Remarketing lets you tailor your ads based on your users' previous interactions with your website. Refer to the [Google Ads documentation](https://support.google.com/google-ads/answer/7305793) for more information on this feature.
