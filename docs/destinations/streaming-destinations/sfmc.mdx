...
description: >-
  Step-by-step guide on sending your event data from RudderStack to Salesforce Marketing Cloud.
---
...
- **Do not create or update contacts**: This setting is disabled by default. Toggle it on to disable creating or updating contacts via an `identify` call.
...
<img src="../../assets/sfmc-2.png" alt="Salesforce Connection Settings for Track" />
