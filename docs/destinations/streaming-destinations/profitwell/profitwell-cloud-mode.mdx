...
<div class="infoBlock">
For more information on sending events via the RudderStack Cloud mode, refer to the <Link to="/destinations/rudderstack-connection-modes/">RudderStack Connection Modes</Link> guide.
</div>
