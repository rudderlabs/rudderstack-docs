...
RudderStack lets you send your event data to ProfitWell via the <Link to="/destinations/rudderstack-connection-modes/#device-mode">web device mode</Link>, that is, using the native web SDK.
