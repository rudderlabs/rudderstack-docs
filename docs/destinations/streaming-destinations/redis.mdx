...
2. Give your destination a name and then click **Continue**.
3. Next, in the **Connection Settings**, fill all the fields with the relevant information and click **Next**.
