...
To update the user's email, you need to provide the <Link to="/destinations/streaming-destinations/engage/setting-up-engage/#connection-settings">**Engage Private Key**</Link> in the dashboard settings.
...
### How does RudderStack use the Engage Private Key?

RudderStack requires the <Link to="/destinations/streaming-destinations/engage/setting-up-engage/#connection-settings">Engage Private Key</Link> to delete a user or update their email in Engage.