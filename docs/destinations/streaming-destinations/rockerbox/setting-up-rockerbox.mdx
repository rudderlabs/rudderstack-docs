...
- **Map your event property to Rockerbox custom property**: Enter the RudderStack event property you want to map to Rockerbox as a custom property. You can send the properties defined here in the `track` call.
