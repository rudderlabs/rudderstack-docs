...
- **Map your traits to Marketo custom fields**: This setting lets you map your event traits to custom Marketo fields **apart from** the mappings specified in the <Link to="#supported-mappings">Identify trait mappings</Link> section below.
