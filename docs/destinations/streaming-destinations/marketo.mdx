...
<div class="infoBlock">
You can find the Munchkin Account ID by logging into your Marketo instance and going to <strong>Admin</strong> &gt; <strong>Integration</strong> &gt; <strong>Munchkin</strong>. Your Munchkin ID will be listed in the <strong>Tracking Code</strong> section in the main screen. For more information, refer to the <a href="https://nation.marketo.com/t5/knowledgebase/how-to-find-your-munchkin-id-for-a-marketo-instance/ta-p/248432">Marketo documentation</a>.
</div>
...
- **Map your traits to Marketo custom fields**: This setting lets you map your event traits to custom Marketo fields **apart from** the mappings specified in the <Link to="#supported-mapping">Identify trait mappings</Link> section below.
...
<div class="infoBlock">
For rest of the fields that you want to sync with Marketo, you need to create a mapping of your traits and custom Marketo fields in the RudderStack dashboard, as specified in the <Link to="#lead-mapping-settings">Lead Mapping settings</Link> section.
</div>
