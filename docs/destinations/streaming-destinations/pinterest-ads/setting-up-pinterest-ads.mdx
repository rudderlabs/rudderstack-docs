...
<li> If not specified, the <Link to="/destinations/streaming-destinations/pinterest-ads/pinterest-ads-device-mode/#ecommerce-conversion-tracking">standard ecommerce event mapping</Link> is considered.</li>
