...
<li> If none of the above qualifies, the event name is sent as it is and is shown as <code class="inline-code">unknown</code> event in the Pinterest dashboard.</li>
</ul>
</div>
