...
- **Environment**: Specify the environment in which your code is running.
- **Ignored Messages**: Rollbar will ignore the excepts matching the specific exception messages added in this field. For example, you can ignore an exception message for a third-party browser plugin that is throwing errors by specifying it here.
