---
title: "Gainsight"
description: Step-by-step guide on sending your event data from RudderStack to Gainsight CS.
---
...
For more information on generating the Gainsight Access Key, refer to their <a href="https://support.gainsight.com/SFDC_Edition/Connectors/Connectors/API_Integrations/Generate_API_Access_Key">support page</a>.
...
Refer to the <a href="#track">Track</a> section of this documentation for more details.
</div>
