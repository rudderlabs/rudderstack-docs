...
```
      ...
      <TabPanel>
        <div class="warningBlock">
          This device mode integration is supported for Braze 4.4.4 and above.
        </div>
        Follow these steps to add Braze to your iOS project:
<ol>
...
<li>To send the push notification events, refer to the <Link to="#sending-push-notification-events">Sending push notifications</Link> section below.
</li>
</ol>
      </TabPanel>
      <TabPanel>
...
<div class="infoBlock">
To delete a user, you can specify their <code class="inline-code">userId</code> or any custom identifier in the event.
</div>
...
For sending push notification events, add the following code to your <code class="inline-code">AppDelegate</code> file under the <code class="inline-code">didFinishLaunchingWithOptions</code> method:
