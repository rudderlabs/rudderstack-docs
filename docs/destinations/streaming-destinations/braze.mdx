...
```
      ...
      <TabPanel>
        <div class="warningBlock">
          This device mode integration is supported for Braze x.0.0 and above.
        </div>
        Follow these steps to add Braze to your iOS project:
<ol>
...
<li>For sending push notification events, add the following code to your <code class="inline-code">AppDelegate</code> file under the <code class="inline-code">didFinishLaunchingWithOptions</code> method:
<br /><br />
<span>
