...
- **Enable subscription groups in group call**: Enable this setting to send subscription groups in the <code class="inline-code">group</code> call. For more information, refer to the <Link to="#group">Group</Link> section below.
