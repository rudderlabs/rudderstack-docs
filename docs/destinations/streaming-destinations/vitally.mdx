...
<div class="infoBlock">
Find the open source transformer code for this destination in the <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/src/v0/destinations/vitally">GitHub repository</a>.
</div>
...
2. In a separate tab/window, make sure you are logged into your RudderStack account
3. Configure the RudderStack integration using the one-click "Enable with RudderStack" button. Choose the primary source of product usage data in RudderStack and RudderStack will automatically create a destination for Vitally:

  ![](images/uGHrIvX.gif)

4. You'll now be able to see and manage your Vitally Destination directly from your RudderStack workspace

  ![](images/2JQwIBK.png)

5. Once Vitally receives at least one event from RudderStack, you'll be able to proceed with the set up process and configure how to [create accounts from RudderStack](https://docs.vitally.io/managing-the-customer-lifecycle/account-hierarchy-using-vitallys-organization-object/supported-integrations-and-how-to-create-the-hierarchy#rudderstack){:target="_blank"}
