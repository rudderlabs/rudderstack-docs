...
- **Mapping to trigger the Matomo Goal ID for the respective Events**: Enter the **Event Name** and the corresponding **Goal Id** to be triggered when that event is called.
