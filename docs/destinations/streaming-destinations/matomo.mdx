...
| `properties.keyword`/`properties.search`/`message.context` | `keyword` |
...
<div class="infoBlock">
The <code class="inline-code">Product Viewed</code> event can be observed in the destination dashboard only when followed by a <code class="inline-code">page</code> call.
</div>
...
<div class="infoBlock">
The <code class="inline-code">Product Added</code> event can be observed in the destination dashboard only when followed by an <code class="inline-code">Update Cart</code> or <code class="inline-code">Order Completed</code> event.
</div>
...
<div class="infoBlock">
The <code class="inline-code">Product Removed</code> event can be observed in the destination dashboard only when followed by an <code class="inline-code">Update Cart</code> or <code class="inline-code">Order Completed</code> event.
</div>
