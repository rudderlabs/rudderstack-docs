...
- **Use as Test Destination:** Enable this setting if you are using this destination for testing purposes and enter the **Test Event Code**. This code can be found in your Facebook Pixel dashboard. If enabled, you can check your events in the Facebook Pixel dashboard in real time.
...
#### I can see my events being successful in the RudderStack dashboard but are not visible on the Facebook Pixel dashboard. What might be the reason?

It may take upto 24 hrs for your events to reflect in the Facebook Pixel dashboard. Meanwhile, you can verify if your set up is correct by enabling the **Use as Test Destination** setting in the RudderStack dashboard. It reflects the events in the Facebook Pixel dashboard in real time.
