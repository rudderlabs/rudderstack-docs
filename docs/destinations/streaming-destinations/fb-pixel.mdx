...
<div class="infoBlock">
To send <code class="inline-code">external_id</code> via the web device mode, you need to include and send it via an <code class="inline-code">identify</code> call before making any other call.
</div>
