...
<div class="infoBlock">
To send <code class="inline-code">external_id</code> via web device mode, you need to include and send it via an <code class="inline-code">identify</code> call. It will only be sent and mapped if the identify call is made before the <code class="inline-code">track</code> call.
</div>
