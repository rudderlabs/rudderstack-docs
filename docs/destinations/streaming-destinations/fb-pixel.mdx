...
1. The highest priority is given to the `content_type` provided in the `integrations` object.
2. The second highest priority is given to the `content_type` provided in the RudderStack dashboard.
