...
This HubSpot source uses the legacy API and will be deprecated soon. Refer to the <Link to="/destinations/streaming-destinations/hubspot-v2/">HubSpot (New API)</Link> guide for the latest documentation.
</div>
