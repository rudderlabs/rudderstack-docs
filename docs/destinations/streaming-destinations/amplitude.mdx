...
<TabPanel>
Follow the steps below to add Amplitude to your Flutter Project:
<ul>
...
<li>And then, import the<code class="inline-code">RudderIntegrationAmplitudeFlutter</code> in your <code class="inline-code">application</code> where you are initializing the SDK.
<span>
...
<li>On iOS Platform, Ensure the minimum deployment target for your application’s target was at least 10</li>
</ul>
      </TabPanel>
    </TabPanels>
</Tabs>
...
<div class="infoBlock">
To delete a user, you need to specify their <code class="inline-code">userId</code> in the event.
</div>
