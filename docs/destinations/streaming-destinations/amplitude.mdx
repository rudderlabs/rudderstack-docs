...
For more information on explicitly setting the <code class="inline-code">anonymousId</code>, refer to <Link to="/sources/event-streams/sdks/rudderstack-javascript-sdk/#overriding-the-anonymousid-using-setanonymousid">RudderStack's JavaScript SDK</Link> documentation.
</div>
...
Refer to the <Link to="/sources/event-streams/sdks/rudderstack-javascript-sdk/#alias">JavaScript SDK documentation</Link> for information and examples on how to call the `alias` event.
