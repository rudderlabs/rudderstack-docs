...
- **Event Key:** This value is unique to your ActiveCampaign account. Refer to the [ActiveCampaign documentation](https://help.activecampaign.com/hc/en-us/articles/221870128-An-overview-of-Event-Tracking#how-to-turn-on-event-tracking-0-3) for more information on obtaining the event key.
