...
| RudderStack property | Sendinblue property | Data type |
| :-----| :--------| :------|
| `context.traits.email` <br/> `properties.email` <br/> `context.traits.phone` <br/> `properties.phone` <br/> <span style="color: #4D4DFF;font-size:12px;">Required</span>| `email`  | String |
