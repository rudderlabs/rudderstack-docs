...
Although these fields are optional, RudderStack prioritizes **RudderStack property name** over **Default Value** if both are specified. For example, consider the following use-cases:
