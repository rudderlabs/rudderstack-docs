...
- **X-S4-Service**: Enter a category for the alert, for example, `IT`. Refer to the <Link to="#signl-categories">Signl categories</Link> section to learn more about these categories.
