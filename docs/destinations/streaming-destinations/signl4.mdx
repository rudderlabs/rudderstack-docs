...
- **Event to title mapping**: Enter the event name and alert title you want to be mapped corresponding to each other. If no value is provided, the alert title is taken same as the event name.
