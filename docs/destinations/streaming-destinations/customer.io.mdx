...
<div class="infoBlock">
For more information on this setting, refer to the <Link to="/sources/sdks/rudderstack-javascript-sdk/onetrust-consent-manager/">OneTrust Consent Manager</Link> guide.
</div>
