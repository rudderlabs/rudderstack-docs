...
<div class="infoBlock">
For more information on this setting, refer to the <Link to="/sources/event-streams/sdks/rudderstack-javascript-sdk/consent-managers/onetrust/">OneTrust Consent Manager</Link> guide.
</div>
