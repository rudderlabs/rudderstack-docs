...
If you are already using LinkedIn Insight Tag on your website, removing it is highly recommended.
</div>
...
## Supported conversion tracking methods

The LinkedIn Insight Tag supports the following two conversion tracking methods:

- Page load
- Event-specific

<div class="infoBlock">
For more information on these tracking methods, refer to the <a href="https://www.linkedin.com/help/lms/answer/a425606?trk=hc-articlePage-peopleAlsoViewed">LinkedIn support page</a>.
</div>
