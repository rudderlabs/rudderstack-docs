---
title: "Autopilot"
description: Step-by-step guide on sending your event data from RudderStack to Autopilot.
---
...
You can retrieve the API key from the settings page of the [Autopilot](https://login.autopilothq.com/login?redirect=%2Fselect) dashboard. For more information, refer to the [Autopilot documentation](https://autopilot.docs.apiary.io/#reference:~:text=request%20is%20fulfilled.-,Getting%20an%20API%20key,-To%20get%20an).
