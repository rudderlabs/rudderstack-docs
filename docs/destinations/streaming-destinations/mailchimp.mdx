...
| `properties.is_syncing` | `is_syncing` | Set `false` if you want to [trigger targeted automations](https://mailchimp.com/developer/marketing/guides/track-outside-activity-events/#trigger-automations-with-events). |
| `originalTimestamp` | `occured_at` |  - |
