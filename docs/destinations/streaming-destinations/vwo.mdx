...
<div class="infoBlock">
If you enable both the <strong>Send experiment viewed as track</strong> and <strong>Send experiment viewed as identify traits</strong> dashboard settings, then RudderStack independently captures the experiment details as <code class="inline-code">track</code> and <code class="inline-code">identify</code> events.
</div>
