---
title: "Leanplum"
description: Step-by-step guide on sending your event data from RudderStack to Leanplum.
---
...
<TabPanel>
Follow the steps below to add Leanplum to your Flutter Project:
<ul>
...
<li>And then, import the<code class="inline-code">RudderIntegrationLeanplumFlutter</code> in your <code class="inline-code">application</code> where you are initializing the SDK.
<span>
...
<li>On iOS Platform, Leanplum needs to be linked as either a dynamic/static Framework with your app, which can be done by adding the below to your iOS/Podfile:
<span>
