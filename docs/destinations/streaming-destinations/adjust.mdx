...
<TabPanel>
Follow the steps below to add Adjust to your Flutter Project:
<ul>
...
<li>And then, import the<code class="inline-code">RudderIntegrationAdjustFlutter</code> in your <code class="inline-code">application</code> where you are initializing the SDK.
<span>
