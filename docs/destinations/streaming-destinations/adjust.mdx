...
<ul>
  <li><Link to="/sources/sdks/rudderstack-android-sdk/#configuring-your-rudderstack-client">Android</Link></li>
  <li><Link to="/sources/sdks/rudderstack-ios-sdk/#configuring-the-rudderstack-client">iOS</Link></li>
</ul>
</div>
