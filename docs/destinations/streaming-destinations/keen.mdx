...
Before configuring your source and destination in RudderStack, please verify if the source platform is supported by Keen, by referring to the table below:
