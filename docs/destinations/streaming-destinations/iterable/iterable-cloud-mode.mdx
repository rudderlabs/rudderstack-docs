...
You can find the relevant details of the ecommerce events in the <Link to="/event-spec/ecommerce-events-spec/">Ecommerce Events Specification</Link> guide.
