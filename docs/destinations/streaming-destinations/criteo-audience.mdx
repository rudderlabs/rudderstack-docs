...
- **Audience Id**: Enter the audience ID for which you want to sync the data. Refer to the [Criteo Audience documentation](https://developers.criteo.com/marketing-solutions/docs/audience#creating-a-new-audience) for more information on obtaining the audience ID.
