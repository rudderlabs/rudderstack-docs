...
- **Audience Id**: Enter the audience ID of the audience to which you want to sync the data. Refer to the [Criteo Audience](https://developers.criteo.com/marketing-solutions/docs/audience#creating-a-new-audience) documentation for more information on obtaining the audience ID.
- **Audience Type**: 
...
In the above snippet, the `identifierType` can be:
- `email`: Email Address
- `madid`: Mobile Ad Identifier)
- `identityLink`: LiveRamp Identity Link
- `gum`: Criteo GUM cookie identifier. `gumCallerId` is a required field.
