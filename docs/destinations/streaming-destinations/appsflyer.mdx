...
<div class="infoBlock">
To delete a user, you need to specify either of the AppsFlyer ID, <Link to="#advertising-id">iOS advertising ID, or Android advertising ID</Link>(depending on your platform) in the event.
</div>
...
<div class="infoBlock">
To delete a user using the Data Regulation API, the following dashboard settings are required:
<ul>
  <li>If you're providing the AppsFlyer ID in the regulation request, then either of <Link to="#connection-settings"><strong>Android App ID</strong> or <strong>iOS App ID</strong></Link> must be specified in the settings.</li>
  <li>If you're providing the iOS advertising ID, then <strong>iOS App ID</strong> must be specified.</li>
  <li>If you're providing the Android advertising ID, then <strong>Android App ID</strong> must be specified in the dashboard.</li>
</ul>
</div>
