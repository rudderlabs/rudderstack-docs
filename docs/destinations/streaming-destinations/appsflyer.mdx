...
<div class="infoBlock">
To delete a user, you need to specify either the AppsFlyer ID or the <Link to="#advertising-id">iOS advertising ID/Android advertising ID</Link>(depending on your platform) in the event.
</div>
