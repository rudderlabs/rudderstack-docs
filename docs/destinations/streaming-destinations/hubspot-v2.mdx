...
- **RudderStack Event Name**: Enter the custom behavioral RudderStack event name you want to map to the HubSpot event.
- **HubSpot Event Name**: Enter the custom behavioral HubSpot event name you want to map to the above-mentioned RudderStack event.
