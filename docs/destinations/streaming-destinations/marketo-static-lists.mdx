...
description: Step-by-step guide on sending your event data from RudderStack to Marketo Static Lists.
...
The following table details the mapping of the RudderStack `audienceList` properties and Markerto Static Lists properties:
