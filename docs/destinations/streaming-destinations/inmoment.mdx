...
- [Retrieve a user by email](https://docs.wootric.com/api/#get-a-specific-end-user-by-email)

    | RudderStack property | InMoment property | Presence | Data type | 
    |:---------------------|:-------------|:--------------|:--------------|
    | `traits.email`/`context.traits.email`/ `properties.email` / `context.externalId.0.id` | `email` | Required | String |

- [Retrieve a user by phone](https://docs.wootric.com/api/#get-a-specific-end-user-by-phone-number)

    | RudderStack property | InMoment property | Presence | Data type |
    | :---------------------|:-------------|:--------------|:--------------|
    | `traits.phone`/ `context.traits.phone` / `properties.phone` | `phone_number` | Required | String |
