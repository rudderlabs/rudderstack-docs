...
RudderStack updates the user if the `external_id` field exists, otherwise creates a new one.
...
<div class="warningBlock">
If the difference between the event's <code class="inline-code">timestamp</code> and <code class="inline-code">createdAt</code> is greater than 24 hours, RudderStack creates a new survey response for the user. Otherwise, it updates the last response.
</div>
...
<div class="warningBlock">
If the difference between the event's <code class="inline-code">timestamp</code> and <code class="inline-code">createdAt</code> is greater than 24 hours, RudderStack creates a new survey decline for the user. Otherwise, it updates the last decline.
</div>
