...
- **API Key**: Enter your API key from the InMoment dashboard.
...
- **Mapping to trigger InMoment Events for the respective Event**: Enter the event name and choose the InMoment event from the dropdown to be triggered when that event is called.

<div class="successBlock">
You can specify multiple <strong>InMoment Events</strong> for one <strong>Event Name</strong> and vice versa.
</div>
