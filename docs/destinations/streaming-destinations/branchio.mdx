...
RudderStack does not support sending data to Branch via both the web device or cloud mode.
</div>
...
To successfully configure Branch as a destination, you will need to add your Branch key by going to the **Settings** page of your Branch [dashboard](https://dashboard.branch.io/#/settings).
...
You can retrieve the Branch key from the settings page of your [Branch dashboard](https://dashboard.branch.io/#/settings). For more information, refer to the [Getting Started](#getting-started) section above.