...
- **Client-side Events Filtering**: This optional setting lets you specify which events should be blocked or allowed to flow through using the SDK's <Link to="/sources/sdks/event-filtering/">client-side event filtering</Link> feature.
