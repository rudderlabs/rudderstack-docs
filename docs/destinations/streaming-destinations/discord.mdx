...
- **Embed Flag**: Enable this setting to set an embed message for Discord. If enabled, also specify the following:
    - **Title Template**: Enter the template for building the title of the embed message. If not provided, RudderStack uses the default title as: `{{name}}`.
    - **Description Template**: Enter the template for building the description of the embed message. If not provided, RudderStack uses the default description as: `{{traits}}`.
