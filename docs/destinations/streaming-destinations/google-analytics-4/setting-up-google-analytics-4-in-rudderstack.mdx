...
<div class="infoBlock">
The settings in this section are only applicable for the <strong>cloud mode</strong>.
</div>
...
- **Enable Server Side Identify**: Enable this setting to make an <Link to="/event-spec/standard-events/identify/">`identify`</Link> call and configure the following settings:
  ...
  <div class="infoBlock">
  It is recommended to enable this setting in order to send the <code class="inline-code">identify</code> call successfully.
  </div>
...
<div class="infoBlock">
The settings in this section are only applicable for the< strong>device mode</strong>.
</div>
