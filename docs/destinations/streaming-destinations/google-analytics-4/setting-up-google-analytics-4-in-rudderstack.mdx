...
Refer to the <Link to="/destinations/streaming-destinations/google-analytics-4/google-analytics-4-cloud-mode/#identify"><code class="inline-code">identify</code></Link> call payload for more information on sending `identify` events to GA4 via cloud mode.
</div>
...
This setting exhibits the following behavior:
