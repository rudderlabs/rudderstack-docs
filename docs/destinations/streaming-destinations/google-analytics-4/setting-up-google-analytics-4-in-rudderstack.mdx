...
<ul>
<li>For device mode, it utilizes the `debug_mode` parameter in the GA4 script. Refer to the <Link to="https://support.google.com/analytics/answer/7201382?hl=en#zippy=%2Cglobal-site-tag-websites">Google documentation</Link> for more information.</li>
