...
RudderStack supports ecommerce tracking for Google Analytics 4. You can refer to the <Link to="/event-spec/ecommerce-events-spec/">Ecommerce Events Specification</Link> guide for sending events while instrumenting your site with the RudderStack SDK.
