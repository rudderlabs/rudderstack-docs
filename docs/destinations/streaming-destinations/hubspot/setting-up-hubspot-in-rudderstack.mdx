...
To successfully configure HubSpot as a destination using the **New API**, all the above-mentioned settings (<Link to="#legacy-api">Legacy API</Link>) are applicable except you need to select the **New API (v3)** in **API Version**, as shown:
