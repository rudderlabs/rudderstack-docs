...
RudderStack supports making the following API calls while sending data to Hubspot's [legacy](https://legacydocs.hubspot.com/docs/overview?_ga=2.34803302.670362313.1663315856-97001172.1658910392) API in <Link to="/destinations/rudderstack-connection-modes/#cloud-mode">cloud mode</Link>.
