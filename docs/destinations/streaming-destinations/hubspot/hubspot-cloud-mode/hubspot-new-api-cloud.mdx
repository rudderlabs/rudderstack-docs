...
RudderStack supports making the following API calls while sending data to Hubspot's [new](https://developers.hubspot.com/docs/api/overview) API in <Link to="/destinations/rudderstack-connection-modes/#cloud-mode">cloud mode</Link>.
