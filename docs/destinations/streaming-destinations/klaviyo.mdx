---
title: "Klaviyo"
description: Step-by-step guide on sending your event data from RudderStack to Klaviyo.
---
...
<div class="infoBlock">
The <code class="inline-code">screen</code> calls are only supported in the RudderStack cloud mode. To know more about the RudderStack cloud mode, refer to the <Link to="/destinations/rudderstack-connection-modes/">RudderStack Connection Modes</Link> guide.
</div>
...
Adding or subscribing users to a specific list is only available in cloud mode integration. To know more about the RudderStack cloud mode, read the <Link to="/destinations/rudderstack-connection-modes/">RudderStack Connection Modes</Link> guide.
</div>
...
Adding or subscribing users to a specific list via the <code class="inline-code">group</code> event is only available in cloud mode integration. To know more about the RudderStack cloud mode, read the <Link to="/destinations/rudderstack-connection-modes/">RudderStack Connection Modes</Link> guide.
</div>
