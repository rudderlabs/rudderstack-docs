...
- **Use Native SDK to send Events**: Enable this option if you want to send events using the <Link to="/destinations/rudderstack-connection-modes/#device-mode">web device mode</Link>.
