...
<div class="infoBlock">
Refer to the <a href="https://developers.google.com/doubleclick-advertisers/rest/v4/conversions/batchinsert">batchinsert</a> and <a href="https://developers.google.com/doubleclick-advertisers/rest/v4/conversions/batchupdate">batchupdate</a> methods of the Campaign Manager 360's Conversions API for more information on profile ID.
</div> 

- **Limit ad tracking**: Enable this setting to report a conversion and not target it.
- **Child directed treatment**: Enable this setting if you want to allow requests from users under the age of 13 (under COPPA compliance).
- **Non personalized ad**: Enable this setting if the conversion is for a non personalized ad.
- **Treatment for underage**: Enable this setting if you want to allow requests from users under the age of 16 (under  European Union's GDPR compliance).

<div class="infoBlock">
Refer to the <a href="https://developers.google.com/doubleclick-advertisers/rest/v3.5/Conversion">Campaign Manger 360 documentation</a> for more information on these settings.
</div> 
...
<ul>
  <li>Apart from the above-mentioned properties which are marked as required, you must send <code class="inline-code">properties.requestType</code> in the conversion event with value as <a href="https://developers.google.com/doubleclick-advertisers/rest/v4/conversions/batchinsert"><code class="inline-code">batchinsert</code></a> or <a href="https://developers.google.com/doubleclick-advertisers/rest/v4/conversions/batchupdate"><code class="inline-code">batchupdate</code></a>.</li>
