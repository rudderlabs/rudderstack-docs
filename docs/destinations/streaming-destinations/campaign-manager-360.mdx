...
<div class="infoBlock">
You can pass values for all these dashboard settings in the <Link to="#track">track</Link> call as well which will take precedence over the values passed in the dashboard. Refer to the <a href="https://developers.google.com/doubleclick-advertisers/rest/v3.5/Conversion">Campaign Manager 360 documentation</a> for more information on these settings.
</div> 
