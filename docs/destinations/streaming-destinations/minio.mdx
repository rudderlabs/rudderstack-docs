...
- Next, in the **Connection Settings**, fill all the fields with the relevant information \(please refer to the [Setting up MinIO](#setting-up-minio) section above\) and click **Next**.
