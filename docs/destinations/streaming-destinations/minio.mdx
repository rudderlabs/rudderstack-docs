---
title: "MinIO"
description: Step-by-step guide on sending your event data from RudderStack to MinIO.
---
...
- Next, in the **Connection Settings**, fill all the fields with the relevant information \(please refer to the [Setting up MinIO](#setting-up-minio) section above\) and click on **Next**.
