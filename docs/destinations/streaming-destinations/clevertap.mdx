...
<div class="infoBlock">
CleverTap does not support nested objects or arrays for custom attributes in the <code class="inline-code">page</code> events. Hence, Rudderstack converts the nested objects or arrays to string before sending them to CleverTap.
</div>
...
<div class="infoBlock">
CleverTap does not support nested objects or arrays for custom attributes in the <code class="inline-code">screen</code> events. Hence, Rudderstack converts the nested objects or arrays to string before sending them to CleverTap.
</div>
...
<div class="infoBlock">
CleverTap does not support nested objects or arrays for custom attributes in the <code class="inline-code">track</code> events. Hence, Rudderstack converts the nested objects or arrays to string before sending them to CleverTap.
</div>
...
<div class="infoBlock">
CleverTap does not support nested objects or arrays for custom attributes in the <code class="inline-code">identify</code> events. Hence, Rudderstack converts the nested objects or arrays to string before sending them to CleverTap.
</div>
