...
You can send a `track` call to impact.com to send event data via the [`Conversions` endpoint](https://integrations.impact.com/impact-brand/reference/submit-a-conversion) or [`PageLoad` endpoint](https://integrations.impact.com/impact-brand/reference/create-a-pageload).
...
<div class="infoBlock">
At least one of the <code class="inline-code">CustomerId</code>, <code class="inline-code">CustomProfileId</code>, <code class="inline-code">GoogAId</code>, <code class="inline-code">AndroidId</code>, <code class="inline-code">AppleIfa</code>, <code class="inline-code">AppleIfv</code> properties is required while making a <code class="inline-code">screen</code> call.
</div>
