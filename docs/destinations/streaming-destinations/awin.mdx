...
- **Events to Track**: Enter the event names for which you want to track conversions. 
...
| `properties.cks`<br/> `properties.awc`  | `awc` | Default value is `awc` |
...
To obtain your Awin advertiser ID, login to your [Awin dashboard](https://ui.awin.com/idp/en/awin/login) to see the advertiser ID in the top right corner as well as in the URL, as shown:
