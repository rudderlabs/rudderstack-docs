...
RudderStack accepts a phone number with the correct country code that's not `+86`. Also, it does not support any non-numeric values in the phone number. For more information, refer to this [TikTok Documentation](https://ads.tiktok.com/marketing_api/docs?id=1701890979375106).
