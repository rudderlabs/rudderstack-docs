...
### How does RudderStack validate the phone number?

RudderStack accepts the phone number with correct country code where it's not `+86`. Also, RudderStack doesn't support any non-numeric values in the phone number. You can read more about it in this [TikTok Documentation](https://ads.tiktok.com/marketing_api/docs?id=1701890979375106).
