...
- **Mapping to trigger the TikTok Ads standard events for the respective Events**: Enter the event name and pick the <Link to="https://ads.tiktok.com/marketing_api/docs?id=1701890972233730">TikTok Ads standard event</Link> from the dropdown to be triggered when that event is called.
