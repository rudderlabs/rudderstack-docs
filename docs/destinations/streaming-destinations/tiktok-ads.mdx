...
RudderStack maps the following event properties to the corresponding TikTok Ads fields:

| RudderStack property | TikTok Ads property | Presence | 
| :-------------- | :------------------| :------|
| `properties.eventId` | `event_id` | Optional | 
| `timestamp` | `timestamp` | Optional | 
| `properties.testEventCode` | `test_event_code` | Optional | 
| `properties.contents` | `properties.contents` | Optional | 
| `properties.currency` | `properties.currency` | Optional | 
| `properties.value` | `properties.value` | Optional | 
| `properties.description` | `properties.description` | Optional | 
| `properties.query` | `properties.query` | Optional | 
| `properties.context.ad` / `context.ad` | `context.ad` | Optional | 
| `properties.context.page` / `context.page` | `context.page` | Optional | 
| `properties.context.user` | `context.user` | Optional | 
| `context.ip` | `context.ip` | Optional | 
| `context.userAgent` | `context.user_agent` | Optional | 
