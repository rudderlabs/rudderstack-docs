...
Any user-provided cookie must be mapped to either <code class="inline-code">email</code> or <code class="inline-code">cv_id</code>. Otherwise, RudderStack will be unable to send this information to Woopra.
</div>
