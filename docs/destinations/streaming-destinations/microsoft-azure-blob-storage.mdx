...
<div class="infoBlock">
Note the your storage account name, container as well as the access key. This information will be required to set up Azure Blob Storage as a destination in RudderStack.
</div>
...
<div class="infoBlock">
For more information on using shared access signatures (SAS), refer to this <a href="https://docs.microsoft.com/en-us/azure/storage/common/storage-sas-overview">Azure documentation</a>.
</div>
...
- **Azure Blob Storage Account Key**: Enter the access key associated with your Blob Storage account.
- **Use shared access signature (SAS) Tokens**: Enable this setting to use a shared access token to grant limited access to your Azure storage resources.
