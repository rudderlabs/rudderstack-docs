...
2. Select **Customer list** as your Custom Audience source and click **Next**.

<img src="../../assets/event-stream-destinations/fb-custom-audience-source.png" alt="Audience source" /> 

3. If your list includes a column for customer value, then select the **Yes** option, else select **No** and click **Next**.
...
6. Once your list is added and ready for use, click **Upload and Create**.
...
- Then, click **All Audience** and select the specific custom audience from the list.
- Finally, click the **History** tab. Here, you will find the audience ID under the **Item Changed** column, as shown:
...
4. Next, in the left navigation click bar, click the **Tools** option under **Marketing API** , as shown:

<img src="../../assets/event-stream-destinations/fb-custom-audience-api-tools.png" alt="Marketing API tools" /> 

5. Under **Get Access Token**, select **ads_management** and **ads_read** as the token permissions and click **Get Token**:
