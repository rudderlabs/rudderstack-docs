...
| :----------------------- | :------------------ | :------- |
| `userId` <br/> `traits.userId` <br/> `traits.id` <br/> `context.traits.userId` <br/> `context.traits.id` <br/> `anonymousId` <br/> <span style="color: #4D4DFF;font-size:12px;">Required</span> | tracking_id | |
...
| **RudderStack property** | **Accoil property** | **Note** |
| :----------------------- | :------------------ | :------- |
| `userId` <br/> `traits.userId` <br/> `traits.id` <br/> `context.traits.userId` <br/> `context.traits.id` <br/> `anonymousId` <br/> | tracking_id | |
