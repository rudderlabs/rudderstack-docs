...
You can use Podsights' <a href="https://podsights.com/docs#alias">alias</a> event to match the Podsights internal cookie ID with your hashed internal user IDs. To do so, follow these steps:
