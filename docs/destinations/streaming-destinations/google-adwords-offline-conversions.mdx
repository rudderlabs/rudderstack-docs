...
[Google Adwords Offline Conversions](https://support.google.com/google-ads/answer/2998031?hl=en&ref_topic=7280668) lets you measure your sale conversions in the offline mode after a user clicks your ad but does not directly proceed to sale in the online mode.
...
| RudderStack property | Google AdWords Offline Conversions property | Presence |
| :-----| :--------| :--------| 
