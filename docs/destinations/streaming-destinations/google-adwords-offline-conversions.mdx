...
- **Map your variable names to custom Google Ads variables**: Enter the custom variable name you want to map to the Google Ads custom variable. Refer to the <Link to="#faq">FAQ</Link> section for more information on creating custom variables in your Google Ads dashboard.
...
- **Default user identifier for click conversions**: Select the default user identifier from `email` or `phone`.
