...
RudderStack supports sending event data to PersistIQ via the following <a href="https://rudderstack.com/docs/destinations/rudderstack-connection-modes/">connection modes</a>:
