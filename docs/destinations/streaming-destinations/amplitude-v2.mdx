...
Before configuring Amplitude as a destination in RudderStack, confirm that your source is supported by Amplitude by referring to the table below. See <Link to="/rudderstack-cloud/rudderstack-connection-modes/">connection modes</Link> for details.
