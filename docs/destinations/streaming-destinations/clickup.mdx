...
<div class="infoBlock">
For more information on the above-mentioned fields, refer to the the <a href="https://clickup.com/api/clickupreference/operation/GetAccessibleCustomFields/">ClickUp Custom Fields API reference</a>.
</div>
