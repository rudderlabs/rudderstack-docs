...
<div class="infoBlock">
While using the RudderStack <Link to="/sources/event-streams/sdks/rudderstack-javascript-sdk/load-js-sdk/#allowlist-destination-domain">JavaScript SDK </Link> source with Bugsnag, you need to allowlist this <code class="inline-code">https://d2wy8f7a9ursnm.cloudfront.net/v6/bugsnag.min.js</code> domain to load the Bugsnag SDK successfully.
</div>
