...
RudderStack supports Google Tag Manager as a destination and enables you to send events to the **GTM dataLayer** using the <Link to="/sources/sdks/rudderstack-javascript-sdk/">RudderStack JavaScript SDK</Link>.
