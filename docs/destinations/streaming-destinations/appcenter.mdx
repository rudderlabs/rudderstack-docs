...
```
  ...
  <TabPanel>
Follow the steps below to add App Center to your Flutter Project:
<ul>
...
<li>And then, import the<code class="inline-code">RudderIntegrationAppcenterFlutter</code> in your <code class="inline-code">application</code> where you are initializing the SDK.
<span>
...
<li>On Android Platform, Open <code class="inline-code">android/app/build.gradle</code> and ensure that <code class="inline-code">android.defaultConfig.minSdkVersion</code> is set to atleast <code class="inline-code">21</code>
<li>On iOS Platform, If you want to link Appcenter as a framework instead of library to your app, you would be able to link it statically but not dynamically as Appcenter requires it which can be achieved by the below:
<span>
