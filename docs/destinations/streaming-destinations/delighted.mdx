...
To change its value manually, go the Delighted <a href="https://app.delighted.com/dashboard">dashboard</a>, select your **Project** from top left corner and click the settings icon beside **Project Name**.
