...
Firebase device mode support is not available for the <Link to="/sources/event-streams/sdks/rudderstack-cordova-sdk/">Cordova</Link> and <Link to="/sources/event-streams/sdks/rudderstack-flutter-sdk/">Flutter</Link> SDKs.
</div>
...
<li>Finally, navigate to your app's <code class="inline-code">iOS</code> folder and follow these steps:
  ...
  <TabPanel>
Follow the steps below to add Firebase to your Flutter Project:
<ul>
...
<li>And then, import the<code class="inline-code">RudderIntegrationFirebaseFlutter</code> in your <code class="inline-code">application</code> where you are initializing the SDK.
<span>
...
<li>Add the <code class="inline-code">mavenCentral()</code> as a repository under <code class="inline-code">buildscript.repositories</code> and <code class="inline-code">allprojects.repositories</code> to your project level <code class="inline-code">build.gradle</code> file, as shown:
<span>
