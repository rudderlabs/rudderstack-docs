...
<div class="infoBlock">
If you pass the <code class="inline-code">name</code> in the group <code class="inline-code">traits</code>, then the group is created in PostHog with that <code class="inline-code">name</code>. Otherwise, it is created by the <code class="inline-code">groupId</code>.
</div>
