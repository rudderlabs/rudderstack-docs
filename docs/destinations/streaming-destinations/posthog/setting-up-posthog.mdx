...
<div class="infoBlock">
For more information on obtaining your PostHog Team API Key, refer to the <Link to="#faq">FAQ</Link> section below.
</div>
...
<div class="infoBlock">
It is strongly recommended to enable this setting to send all your <code class="inline-code">group</code> events to PostHog correctly.
</div>
...
- **Disable session recording**: Enable this setting to stop PostHog from recording the user sessions. 
