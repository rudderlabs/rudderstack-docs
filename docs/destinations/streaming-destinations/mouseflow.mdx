...
The <Link to="/event-spec/standard-events/page/">`page`</Link> call lets you record your website's page views with any additional relevant information about the viewed page, such as its title, category, URL, etc.
...
| RudderStack property          | Mouseflow property | Presence |
| :-------------------- | :---------------------- | :-------------|
| `properties.path` / `context.path` | `_virtualPath` |  Optional |
