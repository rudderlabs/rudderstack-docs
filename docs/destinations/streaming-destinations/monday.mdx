...
- **Group Title**: Enter the group title of your board from Monday dashboard.
...
<div class="infoBlock">
The column names provided in the mapping should be existing in your board. Only the column names provided in the mapped will be updated.
</div>
...
1. Log into [Monday dashboard](https://auth.monday.com/auth/login_monday).
...
Follow these steps to find the same:
