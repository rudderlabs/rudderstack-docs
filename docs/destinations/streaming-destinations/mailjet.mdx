...
- **Mailjet Contact List ID**: Enter your Mailjet contact list ID. RudderStack will use this ID if the list ID is not provided via the `externalId` field in the event's payload. For more information on obtaining your contact list ID, refer to the <Link to="#faq">FAQ</Link> section below.
...
To get your Mailjet contact list ID, follow these steps:

1. Log into your [Mailjet dashboard](https://app.mailjet.com/account).
2. Go to **Contacts** > **Contact Lists**.
3. You can find your contact lists and the associated IDs listed here, as shown:
