...
<div class="infoBlock">
Please note that this setting will <strong>NOT</strong> work for new users. For new users, the subscription status will always be set as <code class="inline-code">pending</code> or <code class="inline-code">subscribed</code>, depending on the set <code class="inline-code">doubleOptIn</code> setting.
</div>
