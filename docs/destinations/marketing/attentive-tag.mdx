...
- **API Key**: Enter the API key present in the app created by you in Attentive dashboard.
...
To obtain the Attentive Tag Sign Up Source Id, go to **Sign-up Units** option in the Attentive dashboard. You will be able to locate the ID across Sign-up method, as shown:
