...
<ul>
  <li>Either <code class="inline-code">userId</code> or <code class="inline-code">anonymousId</code> must be present in the <code class="inline-code">track</code> call.</li> 
  <li>If both <code class="inline-code">userId</code> and <code class="inline-code">anonymousId</code>are present, RudderStack will ignore <code class="inline-code">anonymousId</code>.</li>
  </ul>
</div>
...
RudderStack internally transforms the `page` call into a `track` call before sending it as a custom event to WebEngage. It sends the event/category name by transforming it in the format `Viewed ${name} ${category} ${page}`.
...
RudderStack internally transforms the `screen` call into a `track` call before sending it as a custom event to WebEngage. It sends the event/category name by transforming it in the format `Viewed ${name} ${category} ${screen}`.
