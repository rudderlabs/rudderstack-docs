...
<div class="successBlock">
RudderStack also supports the removal of the device (identified by <code class="inline-code">device_id</code>) whenever the <code class="inline-code">Application Uninstalled</code> lifecycle event is called.
</div>
