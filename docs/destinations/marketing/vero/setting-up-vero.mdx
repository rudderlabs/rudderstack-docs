...
<div class="infoBlock">
For more information on this option, refer to the <Link to="/sources/sdks/event-filtering/">Client-side Event Filtering</Link> guide.
</div>
...
<div class="infoBlock">
For more information on this option, refer to the <Link to="/sources/sdks/rudderstack-javascript-sdk/consent-managers/onetrust/">OneTrust Consent Manager</Link> guide.
</div>
