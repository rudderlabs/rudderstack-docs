...
- **Client-side Events Filtering**: This optional setting lets you specify which events should be blocked or allowed to flow through using the SDK's <Link to="/stream-sources/rudderstack-sdk-integration-guides/event-filtering/">client-side event filtering</Link> feature.
...
- **OneTrust Cookie Categories**: This setting lets you map <Link to="/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/consent-managers/onetrust/">OneTrust cookie</Link>/consent groups to RudderStack's consent purposes.
