...
RudderStack lets you send your event data to Vero via the <Link to="/rudderstack-cloud/rudderstack-connection-modes/#cloud-mode">cloud mode</Link>.
...
The <Link to="/rudderstack-api/api-specification/rudderstack-spec/screen/">`screen`</Link> call lets you record whenever your user views their mobile screen, with any additional relevant information about the screen. 

A sample `screen` call sent via the <Link to="/stream-sources/rudderstack-sdk-integration-guides/rudderstack-android-sdk/">Android SDK</Link> is as shown:
