    ...
    <TabPanels>
      <TabPanel>
        <ol>
          ...
          <li>In the target app turn on App Groups and enable one of the App group ids, in case if you don't have an App Group ID then create one. The name of your app group should be <code class="inline-code">group.<bundle_id>.MoEngage</code>.</li>
      ...
      <TabPanel>
        <ol>
         <li>To send push notifications in iOS, an APNS certificate needs to be created and converted to a <code class="inline-code">.pem</code> file. This <code class="inline-code">.pem</code> file needs to be uploaded in the MoEngage dashboard.
...
<div class="infoBlock">
For more information, refer to the [MoEngage documentation](https://developers.moengage.com/hc/en-us/articles/4403943988756-Push-Notifications) on push notifications.
</div>
    </ol>
      </TabPanel>
      <TabPanel>
