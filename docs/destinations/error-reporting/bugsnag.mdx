...
Once you add Bugsnag as a destination in the [RudderStack dashboard](https://app.rudderstack.com/), follow these steps to add Bugsnag to your mobile project depending on your integration platform:
