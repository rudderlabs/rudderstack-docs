...
Refer to the <a href="https://www.rudderstack.com/docs/sources/sdks/event-filtering/">Client-side Event Filtering</a> guide for more information on this setting.
</div>
