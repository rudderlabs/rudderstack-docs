...
title: "Attribution"
description: Step-by-step guide to send event data from RudderStack to Attribution
---

# Attribution

[Attribution](https://attributionapp.com) is an attribution and marketing analytics platform, provided as a Software-as-a-Service \(SaaS\). It offers intuitive dashboards and data reports.

RudderStack supports Attribution as a destination to which you can seamlessly send your customer data.

<div class="successBlock">

  Find the open-source transformer code for this destination in our <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/attribution">GitHub repository</a>.
</div>
...
- From the list of destinations, select **Attribution**.
- Then, assign a name to the destination and click on **Next**.
- Select the data source and click on **Next**.
- Enter the Attribution Project key to configure the destination.
- Your Attribution destination is now configured and enabled.
