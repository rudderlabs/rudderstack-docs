...
<ol>
<li><a href="https://cocoapods.org">RudderAdjust</a> is available through <a href="https://cocoapods.org">CocoaPods</a>. To install it, add the following line to your <code class="inline-code">Podfile</code>:
<span>
...
<li>Import the <code class="inline-code">RudderAdjust</code> SDK, as shown:
<span>
...
<li>Then, initialize the RudderStack client <code class="inline-code">RSClient</code>, as shown:
<span>
