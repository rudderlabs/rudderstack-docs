...
<ol>
<li>Add Adjust as a destination in the [RudderStack dashboard](https://app.rudderstack.com/).</li>
...
<li>Add the imports to your <code class="inline-code">AppDelegate</code> file under <code class="inline-code">didFinishLaunchingWithOptions</code> method, as shown:
<span>
