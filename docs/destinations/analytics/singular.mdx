...
This device mode integration is supported for Singular v11.0.4 and above.
        ...
        To add Singular to your iOS app, follow these steps:
<ol>
<li><code class="inline-code">RudderSingular</code> is available through <a href="https://cocoapods.org/">CocoaPods</a>. To install it, add the following dependency in your <code class="inline-code">Podfile</code>:
<span>
...
<li>Add the following imports to your <code class="inline-code">AppDelegate</code> file:
<span>
...
<li>Then, initialize your RudderStack client <code class="inline-code">RSClient</code>, as shown:
<span>
