...
Firebase device mode support is not available for the <a href="https://www.rudderstack.com/docs/sources/sdks/rudderstack-cordova-sdk/">Cordova</a> and <a href="https://www.rudderstack.com/docs/sources/sdks/rudderstack-flutter-sdk/">Flutter</a> SDKs.
</div>
...
- **Client-side Events Filtering**: Refer to the [Client-side Events Filtering](https://www.rudderstack.com/docs/sources/sdks/event-filtering/) guide for more information on this setting.
...
<li>Integrate the RudderStack core SDK with your project. For more information, refer to the <a href="https://rudderstack.com/docs/sources/sdks/getting-started-with-unity-sdk">RudderStack Unity SDK</a> documentation.</li>
...
<li>Add the RudderStack React Native SDK to your app by referring to the <a href="https://rudderstack.com/docs/sources/sdks/rudderstack-react-native-sdk">RudderStack ReactNative SDK</a> documentation.</li>
