...
<li><code class="inline-code">RudderFirebase</code> is available through <a href="https://cocoapods.org/">CocoaPods</a>. To install it, add the following line to your <code class="inline-code">Podfile</code>:
<span>
