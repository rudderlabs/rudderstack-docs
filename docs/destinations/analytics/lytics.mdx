...
Similarly, you can also make [`screen`](https://rudderstack.com/docs/rudderstack-api/api-specification/rudderstack-spec/screen/) calls. However, this is supported only in the [cloud mode](https://rudderstack.com/docs/rudderstack-cloud/rudderstack-connection-modes/#cloud-mode).
