...
- **Use device mode to send events**: Use this setting to send events via the device mode. Then, follow the <Link to="/destinations/analytics/singular/singular-device-mode/">Singular Device Mode</Link> guide for steps on adding Singular to your project.
