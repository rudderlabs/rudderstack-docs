...
The following table lists the mapping of the attributes **automatically captured** by RudderStack for the **mobile platforms** (<Link to="/stream-sources/rudderstack-sdk-integration-guides/rudderstack-android-sdk/">Android</Link> and <Link to="/stream-sources/rudderstack-sdk-integration-guides/rudderstack-ios-sdk/">iOS</Link>):
...
| <Link to="/rudderstack-api/api-specification/rudderstack-spec/common-fields/#clock-skew-considerations"><code class="inline-code">timestamp</code></Link> | `utime` | Optional | The session time (in UNIX time). |
...
<div class="infoBlock">
RudderStack supports <code class="inline-code">fcm</code> over  <code class="inline-code">gcm</code> (legacy) for mapping two values to one key.
</div>
...
| `context.os.name` | `p` | Required | The source platform (Android or iOS). |
| `context.app.namespace` | `i` | Required | The package name (Android) or bundle ID (iOS) of your app. |
| `request_ip` | `ip` | Required | The user's IP address. |
| `context.device.advertisingId` | `idfa` | Required | The raw [`IdentifierForVendor`](https://developer.apple.com/library/ios/documentation/UIKit/Reference/UIDevice_Class/Reference/UIDevice.html#//apple_ref/occ/instp/UIDevice/identifierForVendor) in upper case with dashes. This is applicable for iOS apps only. |
| `context.device.id` | `idfv` | Required | The raw [`IdentifierForVendor`](https://developer.apple.com/library/ios/documentation/UIKit/Reference/UIDevice_Class/Reference/UIDevice.html#//apple_ref/occ/instp/UIDevice/identifierForVendor) in upper case with dashes. This is applicable for iOS apps only. |
...
| RudderStack property | Singular attribute | Presence | Description |
| :----| :----| :----| :----|
| `properties.price` | `amt` | Optional | The currency amount. |
...
| `properties.purchase_transaction_id` | `purchase_transaction_id` | Optional | The transaction identifier. |
