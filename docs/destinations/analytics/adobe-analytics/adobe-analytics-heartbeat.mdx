...
The <a href="https://rudderstack.com/docs/destinations/analytics/adobe-analytics/setting-up-adobe-analytics-in-rudderstack/">RudderStack dashboard settings</a> also has a toggle for SSL which, if enabled, will send the Heartbeat Tracking URL in the HTTPS mode.
</div>
...
For more information on any of the sections covered in this documentation, you can [**contact us**](mailto:%20docs@rudderstack.com) or start a conversation in our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) community.
