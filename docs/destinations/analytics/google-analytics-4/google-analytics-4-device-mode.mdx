...
Google Signals feature helps you understand the interaction of users with your website across multiple devices and sessions. In order to capture the user data, the following conditions must be true:
...
Refer to the [Google documentation](https://support.google.com/analytics/answer/9445345?hl=en#zippy=%2Cin-this-article) for more information on activating Google Signals.

You can enable Google Signals feature in GA4 to reflect all the data collected for a user in your GA4 reports.

Follow the below steps to enable Google Signals in GA4:

1. Log in to [Google Analytics dashboard](https://analytics.google.com/) 
2. Open the Admin panel by clicking on the gear icon at the bottom-left.
3. Select the property that you want to enable Google Signals for.

<img src="../../assets/event-stream-destinations/Google-signals-1.png" alt="Google Signals" />

4. go to Data Settings --> Data Collection.
<img src="../../assets/event-stream-destinations/Google-signals-2.png" alt="Google Signals" />
5.  click on the "Get Started" button" In the "Enable signals data collection"
<img src="../../assets/event-stream-destinations/Google-signals-3.png" alt="Google Signals" />
6. Click the "Continue" button on the next screen".
<img src="../../assets/event-stream-destinations/Google-signals-4.png" alt="Google Signals" />
7. Make sure to read the content on the next screen and if everything looks good then click on "Activate".
<img src="../../assets/event-stream-destinations/Google-signals-5.png" alt="Google Signals" />
8. Now you will be back in the "Data Collection" setting with "Enable Google signals data collection" turned on.
9. After 24 hours you should see the Age, Gender, and interest data in Demographics reports in Google Analytics 4.
## Contact us
