...
<div class="infoBlock">
Refer to <Link to="/destinations/analytics/google-analytics-4/setting-up-google-analytics-4-in-rudderstack/#identify">Identify</Link> section for more information on its dashboard settings.
</div>
...
<table>
  ...
  <tr>
   ...
   <tr>
    <td>Product Added<br />Product Removed</td>
    <td><code class="inline-code">properties.total</code><br /><code class="inline-code">properties.value</code><br /><code class="inline-code">properties.revenue</code><br /><code class="inline-code">properties.price X properties.quantity</code></td>
    <td><code class="inline-code">value</code></td>
  </tr>
  <tr>
    <td>Product Viewed<br />Product Added to Wishlist</td>
    ...
    <tr>
    <td>Cart Viewed<br />Checkout Started<br />Generate Lead<br />Order Completed<br />Order Refunded<br />Payment Info Entered</td>
    ...
    <tr>
    <td>Product Shared</td>
    <td><code class="inline-code">properties.product_id</code><br /><code class="inline-code">properties.sku</code><br /><code class="inline-code">properties.item_id</code></td>
