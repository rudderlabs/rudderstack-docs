...
| :-------------| :-----------------|
| `client_id`         |  from `externalID` `ga4ClientId`  or `messageId` or `anonymousId` |
...
<table>
  ...
  <tr>
   ...
   <tr>
    <td>Product Viewed<br />Product Added<br />Product Removed<br />Product Added to Wishlist</td>
    ...
    <td><code class="inline-code">properties.total</code><br /><code class="inline-code">properties.value</code><code class="inline-code">properties.revenue</code></td>
