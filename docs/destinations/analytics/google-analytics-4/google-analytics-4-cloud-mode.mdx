...
| :-------------| :-----------------|
| `context.page.path`/`properties.path`          | `path`        |
| `context.page.referrer`/`properties.referrer`               | `referrer`      |
| `context.page.search`/`properties.search`               | `search`      |
| `context.page.title`/`properties.title`            | `title`          |
| `context.page.url`/`properties.url`         | `url`          |
