...
This device mode integration is supported for App Center v4.4.1 and above.
        ...
        Follow these steps to add App Center to your iOS project:
<ol>
<li>Go to your <code class="inline-code">Podfile</code> and add the <code class="inline-code">RudderAppCenter</code> extension:
<span>
...
<li>Then, run the <code class="inline-code">pod install</code> command. </li>
<li>Next, import the SDK as shown:
<span>
...
<li>Finally, initialize the RudderStack client <code class="inline-code">RSClient</code>, as shown:
<span>
