...
By adding the above policy, the RudderStack user `arn:aws:iam::422074288268:user/s3-copy` has the permission to write into your bucket.

<div class="infoBlock">
The above approach works <strong>only if</strong> you are using RudderStack Cloud. 
</div>
