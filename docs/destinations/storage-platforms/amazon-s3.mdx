...
<div class="infoBlock">
The above approach works <strong>only if</strong> you are using the RudderStack Cloud (dashboard). 
</div>
...
If you're using your S3 bucket as an **intermediary object storage** for a <Link to="/data-warehouse-integrations/">warehouse destination</Link>, then you will need to set the following bucket permissions:
