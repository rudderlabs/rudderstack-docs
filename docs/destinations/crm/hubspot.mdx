...
This option is applicable only if you're sending events to HubSpot via the web device mode. Refer to the <a href="https://www.rudderstack.com/docs/sources/sdks/event-filtering/">Client-side Event Filtering</a> guide for more information on this feature.
</div>
...
If you have enabled screen views in your [Android](https://rudderstack.com/docs/sources/sdks/rudderstack-android-sdk) or [iOS](https://rudderstack.com/docs/sources/sdks/rudderstack-ios-sdk) app implementation, RudderStack will send this information to HubSpot.
