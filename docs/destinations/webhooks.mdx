...
Webhooks let you send the events generated via RudderStack's <Link to="/sources/sdks/">SDKs</Link>, <Link to="/sources/cloud-apps/">Cloud Apps</Link>, and <Link to="/sources/reverse-etl/">Reverse ETL</Link> sources. It is useful in cases where you want to apply some custom logic on the event payload before sending it to your preferred destination platforms.
...
<div class="infoBlock">
RudderStack also supports adding a dynamic header for your events through user transformation. For more information, refer to this <a href="https://github.com/rudderlabs/sample-user-transformers/blob/master/AddDynamicHeader.js">user transformation code</a>.
</div>

<div class="infoBlock">
You can also add a dynamic path to your base URL. For more information on how to do this, refer to this <a href="https://github.com/rudderlabs/sample-user-transformers/blob/master/DynamicPathtoBaseURL.js">user transformation code</a>.
</div>
