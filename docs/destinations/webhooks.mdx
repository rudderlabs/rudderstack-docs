...
Webhooks let you send the events generated via RudderStack's **Event Streams** and <Link to="/sources/reverse-etl/">Reverse ETL</Link> sources. It is useful in cases where you want to apply some custom logic on the event payload before sending it to your preferred destination platforms.
