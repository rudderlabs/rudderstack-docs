...
You can choose to skip the creation of `tracks` table by setting the `skipTracksTable` option to `true`. The following sample snippet shows how to skip its creation for Delta Lake destination:
