...
RudderStack drops the non-standard properties(link) declared at the top level of an event. You can rather add such properties in the `context` or properties section.
