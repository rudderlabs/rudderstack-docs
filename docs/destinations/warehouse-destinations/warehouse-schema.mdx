...
RudderStack treats the warehouse schema as the source of truth. If you manually make any changes to the schema, for example, add or modify a column, or update a column's data type, RudderStack honours the modified schema and and sends the data to the warehouse accordingly.
</div>
