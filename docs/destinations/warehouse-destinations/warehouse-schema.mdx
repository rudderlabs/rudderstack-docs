...
<table>
  ...
  <tbody>
    <tr>
      <td>DELETE and then INSERT</td>
      <td><ul><li>PostgreSQL</li>
...
<li>Microsoft SQL Server</li></ul>
    ...
    <tr>
      ...
      <td><ul><li>Snowflake</li>
<li>Databricks Delta Lake Merge Mode (To be given)</li>
<li>Google BigQuery Merge Mode (To be given)</li></ul>
      </td>
    </tr>
    <tr>
      <td>INSERT data</td>
      <td><ul><li>ClickHouse</li>
<li>Google BigQuery</li>
<li>Databricks Delta Lake</li></ul>
      </td>
    </tr>
     <tr>
      <td>RS only generates load files and store them in respective storage. Data loading is not done.</td>
      <td><ul><li>Azure Data Lake</li>
<li>Google Cloud Storage Data Lake</li>
<li>Amazon S3 Data Lake</li></ul>
      </td>
    </tr>
    <tr>
      <td>Table schema is generated in glue catalog i.e. users table is created.</td>
      <td>Amazon S3 Data Lake + AWS Glue
      </td>
    </tr>
  </tbody>
</table>
