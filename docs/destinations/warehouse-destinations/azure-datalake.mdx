...
<img src="../../assets/dw-integrations/data-lake-connection-settings-1.png" alt="Azure data lake destination settings in RudderStack" />
<img src="../../assets/dw-integrations/data-lake-connection-settings-2.png" alt="Azure data lake destination settings in RudderStack" />
...
<img src="../../assets/dw-integrations/sas-token.png" alt="Azure Blob Storage SAS token" />
