...
The following additional permissions are required to enable the <a href="https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-catalog-partitions.html">AWS Glue partitions</a>:
<ul>
