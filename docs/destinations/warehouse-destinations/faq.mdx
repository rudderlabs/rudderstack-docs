...
| :------------ | :---------- |
| `skipTracksTable`     | Skips the creation of `tracks` table. <Link to="/destinations/warehouse-destinations/warehouse-schema/#skip-creation-of-tracks-table">Reference</Link>.         |
