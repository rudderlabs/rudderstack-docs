...
You can modify the warehouse schema once it is created by adding or altering the columns, or changing the column data type. **RudderStack honors the updated warehouse schema** and send the incoming data to the warehouse accordingly.
