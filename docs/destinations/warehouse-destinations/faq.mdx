...
When using Azure Blob Storage as the intermediate object storage for your warehouse destinations, you can use the shared access signatures (SAS) to delegate specific permissions to your storage account resources. This gives you granular control over how users can access your data.
