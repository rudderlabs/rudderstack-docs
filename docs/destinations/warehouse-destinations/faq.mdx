...
| :----| :------| :------|
| All data types **except** String, Text, or JSON | String or Text | RudderStack automatically stringifies the incoming data. |
| Integer <br /> BigInt | Float | - | 
| Float | Integer <br /> BigInt | - |
