...
RudderStack automatically handles the data type conversion for some common scenarios **depending on the warehouse column data type**.

| Incoming data type | Warehouse column data type | Notes |
| :----| :------| :------|
| Integer <br /> Float <br /> JSON | String | RudderStack automatically stringifies the non-string data. |
| Integer | Float | - | 
| Float | Integer | - |
| Int <br /> Float <br /> Boolean | JSON | RudderStack automatically stringifies the incoming data. |
