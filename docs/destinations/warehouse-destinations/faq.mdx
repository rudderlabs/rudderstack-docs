...
<div class="warningBlock">
The incoming data which <strong>cannot</strong> be typecasted into the warehouse column-specific data type is sent to the <code class="inline-code">rudder_discards</code> table.
</div>
