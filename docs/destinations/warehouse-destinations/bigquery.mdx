...
Find the open source code for this destination in the <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/src/v0/destinations/bq">GitHub repository</a>.
</div>
...
- All the other skipped views are not regenerated. You can either manually create those views or [contact us](mailto:support@rudderstack.com) to get them created.
