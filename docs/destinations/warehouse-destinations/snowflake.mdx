---
title: "Snowflake"
description: Setting up Snowflake as a destination in RudderStack.
---

RudderStack supports Snowflake as a destination. [Snowflake](https://www.snowflake.com/) is a cloud-based data warehouse.
