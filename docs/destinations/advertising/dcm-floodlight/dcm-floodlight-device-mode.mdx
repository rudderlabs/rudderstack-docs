...
| `properties.ord` | `ord` | Optional | Counter |
| `properties.orderId` | `ord` | Optional | Sales |
| `properties.quantity` | `qty` | Optional | Sales |
| `properties.revenue` | `value` | Optional | Sales |
| `properties.matchId` | `matchId` | Optional | Sales |
| `properties.num` | `num` | Optional | Sales |
