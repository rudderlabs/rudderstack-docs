...
This option is applicable only if you're sending events to DCM Floodloght via the web device mode. Refer to the <a href="https://www.rudderstack.com/docs/sources/sdks/event-filtering/">Client-side Event Filtering</a> guide for more information on this feature.
</div>
