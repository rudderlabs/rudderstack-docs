...
<div class="infoBlock">
You can send up to 50k <code class="inline-code">email</code>, <code class="inline-code">deviceId</code>, or <code class="inline-code">ipAddress</code> fields within one API call.
</div>
