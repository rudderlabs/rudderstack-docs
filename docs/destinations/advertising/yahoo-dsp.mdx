...
```
<div class="infoBlock">
Note that the <code class="inline-code">email</code> field in the above snippet can be replaced with <code class="inline-code">deviceId</code> and <code class="inline-code">ipAddress</code> for the respective audience types.
</div>
