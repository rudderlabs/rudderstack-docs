...
[**Azure Blob Storage**](https://azure.microsoft.com/en-in/services/storage/blobs/) is Microsoft's cloud-based object storage solution. It allows you to store massive amounts of unstructured data without conforming to any specific data model.
