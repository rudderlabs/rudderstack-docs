...
Follow these steps to grant RudderStack access to your S3 bucket:
...
* You can then provide the configuration directly while setting up the Delta Lake destination in RudderStack, as shown:
...
## Step 2: Granting Databricks access to your staging bucket
...
Follow these steps to grant Databricks access to your S3 bucket:

#### Case 1

<div class="infoBlock">

Follow the steps listed in this section if you don't want to specify the AWS access key and secret access key while configuring Delta Lake in the RudderStack dashboard.
</div>

This section contains the steps to configure your AWS account to [**create an instance profile**](https://docs.databricks.com/administration-guide/cloud-configurations/aws/instance-profiles.html) which will be attached with the Databricks cluster later. Follow these steps in the exact order:
...
Follow the steps listed in this section if you are specifying the AWS access key and secret access key while configuring Delta Lake in the RudderStack dashboard.
</div>
