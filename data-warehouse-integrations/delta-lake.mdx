...
Follow the steps listed in this section if <strong>Use STS Token to copy staging files</strong> is disabled, i.e. you <strong>don't want to specify</strong> the AWS access key and secret access key while configuring your Delta Lake destination in RudderStack.
</div>
...
Follow the steps listed in this section if <strong>Use STS Token to copy staging files</strong> is enabled, i.e. you are specifying the AWS access key and secret access key in the dashboard while configuring your Delta Lake destination in RudderStack.
</div>
