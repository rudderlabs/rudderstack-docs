...
### How to avoid lags in data sync while a heavy load is running on a warehouse?

You can use either of the following ways to avoid lags in warehouse data sync while a heavy load is running:
...
- If you are performing only writes/updates to your data warehouse, set up a read replica of your database and connect it to your load generation tool. Connect the read/write replica to RudderStack, as shown:
