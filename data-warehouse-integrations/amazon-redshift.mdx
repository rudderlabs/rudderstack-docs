...
<img src="../../../images/assets/1 (3).png" alt="Redshift Console" /><span class="imageTitle">Redshift Console</span>

- Click on the **Create Cluster** option as shown:

<img src="../../../images/assets/2 (5).png" alt="Create Cluster" />

- Enter the cluster details**.** First, fill in the **Cluster identifier** and choose the instance type as shown:

<img src="../../../images/assets/3 (4) (1) (1).png" alt="Cluster Identifier" /><span class="imageTitle">Redshift cluster configuration settings</span>

- Enter the number of nodes for your cluster. This will primarily depend on the amount of data you expect to work with.

<img src="../../../images/assets/4 (1) (1).png" alt="Enter the number of nodes" />

- Enter the database name, and create the admin user with the name of your choice.

<img src="../../../images/assets/5 (7).png" alt="Add Source" />
...
<img src="../../../images/assets/6 (1).png" alt="Query editor" />
...
<img src="../../../images/assets/14.png" alt="Select Redshift" /><span class="imageTitle">Connection Settings for adding Redshift as a destination in RudderStack</span>
