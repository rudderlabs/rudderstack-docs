...
- Once you have set up the source, select **Redshift** from the list of destinations. Give your destination a name, and then click on **Next**.
...
- Enter the following credentials in the **Connection Settings**:
  ...
  - **Database -** The database name in your Redshift instance where the data is to be sent goes here.
