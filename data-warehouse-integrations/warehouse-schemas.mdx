...
RudderStack uses the source name (written in snake case, e.g., `source_name`) to create a schema in your data warehouse (dataset, in the case of Google BigQuery).
