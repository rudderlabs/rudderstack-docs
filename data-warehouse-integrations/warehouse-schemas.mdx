...
<code class="inline-code">sent_at</code> &gt; <code class="inline-code">original_timestamp</code> is <strong>always true</strong>. However, <code class="inline-code">timestamp</code> can be more or less than the <code class="inline-code">original_timestamp</code>.
</div>

### `original_timestamp` < `received_at`
