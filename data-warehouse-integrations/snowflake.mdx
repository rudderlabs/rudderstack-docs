...
```
  ...
  <code class="inline-code">&lt;sf_role&gt;</code> is the role in Snowflake you want to grant access to.
      ...
      <TabPanel>
        If you have Google Cloud Platform (GCP) as your cloud provider and want to leverage Google Cloud Storage as your object storage, you will need to follow a few more steps to configure your Snowflake destination. Detailed instructions can be found in this <a href="https://docs.snowflake.com/en/user-guide/data-load-gcs-config.html#configuring-an-integration-for-google-cloud-storage">Snowflake documentation</a>.
