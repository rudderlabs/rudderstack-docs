...
You can add a new source by clicking on the <strong>Add Source</strong> button. For more details on adding a source in RudderStack, refer to the <a href="https://rudderstack.com/docs/connections/adding-source-and-destination-rudderstack/">Adding a Source and Destination in RudderStack</a> guide.
</div>
...
You can add a new destination by clicking on the <strong>Add Destination</strong> button. For more details, refer to the <a href="https://rudderstack.com/docs/connections/adding-source-and-destination-rudderstack/">Adding a Source and Destination in RudderStack</a> guide.
</div>
