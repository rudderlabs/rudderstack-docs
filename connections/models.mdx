...
The warehouse account must have the necessary permissions to be integrated with RudderStack. For more information on these permissions, refer to the <a href="https://www.rudderstack.com/docs/warehouse-actions/">Granting Permissions</a> section of the relevant Warehouse Actions source.
...
7. Click **Next** to configure the model succesfully.
...
If you update a model's <strong>Query</strong>, you also need to check or update the <a href="https://www.rudderstack.com/docs/warehouse-actions/visual-data-mapper/">Visual Data Mapper</a> mapping to trigger the full sync and validate a sync by manually triggering it.
</div>
