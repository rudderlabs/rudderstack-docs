...
4. Provide a name for the model.
5. Select from the existing credentials or create a new warehouse account.
 
<div class="infoBlock">

The Warehouse Actions source must have the necessary permissions to be integrated with RudderStack. For more information on these permissions, refer to the <a href="https://www.rudderstack.com/docs/warehouse-actions/">Granting Permissions</a> section of the relevant Warehouse Actions source.
