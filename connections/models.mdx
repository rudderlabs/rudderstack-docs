...
For more information on setting up your Warehouse Actions sources using RudderStack models, refer to the <a href="https://www.rudderstack.com/docs/warehouse-actions/features/models/">Setting Up Connections Using RudderStack Models</a> guide.
</div>
...
<div class="infoBlock">
Once you select or add your warehouse credentials and click on <strong>Next</strong>, RudderStack will validate them before you can proceed with the setup. For more information on these validations, refer to the <a href="https://www.rudderstack.com/docs/connections/models/#faq">FAQ</a> section below.
</div>
