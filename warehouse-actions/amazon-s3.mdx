...
2. From the left panel, select go to **Source** > **New Source** > **Warehouse Actions**. Then, select **S3**, as shown:
...
1. Enter the relevant settings in the **Connection Credentials** sections as shown below:
   ...
   - **AWS Secret Access Key** - Enter your AWS access key secret.
...
- **S3 Bucket Name**:  Enter the name of the S3 bucket from which you want RudderStack to import the data.
- **Prefix**: Enter the prefix associated with the above S3 bucket.

<img src="../assets/warehouse-actions-sources/s3-bucket-settings" alt="Bucket configuration settings" />

<div class="warningBlock">

Your S3 bucket should consist of Apache Parquet files only. Currently, Rudderstack can extract only Parquet files.
</div>
