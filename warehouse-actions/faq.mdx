...
The Warehouse Actions feature supports only source-driven configuration of your pipeline. So, you need to configure a Warehouse Actions source in RudderStack and then connect it to an existing destination. This destination should not be connected to any other source.
