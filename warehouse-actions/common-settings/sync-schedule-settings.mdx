...
### I'm unable to run a manual sync and get the message "Your pipeline is paused. Make sure that the source and at least one destination is enabled". What do I do?
