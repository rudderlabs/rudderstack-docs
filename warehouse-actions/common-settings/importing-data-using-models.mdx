...
When updating an existing configuration, you can only change the existing mappings. The <strong>Model</strong>, <strong>Sync mode</strong>, and the <strong>Choose user identifier</strong> fields are not editable. 
</div>
