...
<div class="infoBlock">
  ...
  This guide is applicable for Warehouse Actions sources configured using the <strong>Model</strong> option. If you have configured your Warehouse Actions source using the <strong>Table</strong> option, refer to the <a href="https://www.rudderstack.com/docs/warehouse-actions/common-settings/importing-data-using-tables/">Importing Data using Tables</a> guide.
</div>
...
The dropdown will only display the list of models corresponding to the Warehouse Actions source you have configured. For example, only the BigQuery models will be listed for a BigQuery warehouse source.
</div>
