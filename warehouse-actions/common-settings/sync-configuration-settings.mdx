...
When updating an existing configuration, you can only change the existing JSON mappings. The <strong>Schema</strong>, <strong>Table</strong>, and the <strong>Choose user identifier</strong> fields are not editable. 

Note that this is applicable for <a href="https://www.rudderstack.com/docs/warehouse-actions/features/visual-data-mapper/">Visual Data Mapping</a> as well, where <strong>Object</strong> along with the above-mentioned fields cannot be changed.
</div>
