...
4. Once the source is set up, you can connect it to an existing or a new destination by using the **Add Destination** button.  
<img src="../assets/add-destination.png" />

5. Select the required destination and configure its connection settings.

6. Next, select the required model from the dropdown list.
