...
4. Also, select the destination **Object** where you want to sync the data. An example in case of [HubSpot](https://rudderstack.com/docs/destinations/crm/hubspot/) destination is as shown:
