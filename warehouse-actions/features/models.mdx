...
title: "Models"
description: Detailed technical description of the Models feature in RudderStack.
---
...
<div class="infoBlock">
  ...
  For more information on creating and managing models in RudderStack, refer to the <a href="https://www.rudderstack.com/docs/connections/models/">Models</a> guide.  
</div>

<div class="infoBlock">

Currently, this feature is supported for the following Warehouse Actions sources:
<ul>
...
## Setting up connections using models
...
Be sure whether you want to configure the source with the <strong>Model</strong> or <strong>Table</strong> option. Once configured, this setting cannot be changed. For more information on these options, refer to the <a href="#faq">FAQ</a> section below.
</div>
...
<div class="infoBlock">
You can use the <strong>Add Constant</strong> option to add a constant key and value pair which is always sent in the JSON payload.
</div>

<img src="../../assets/warehouse-actions-sources/add-constant.png" />

10. Click on **Continue** to successfully configure the model with the source and destination.
