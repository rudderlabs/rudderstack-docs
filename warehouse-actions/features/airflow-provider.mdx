...
RudderStack's Airflow Provider lets you programmatically schedule and trigger your [Warehouse Actions](https://rudderstack.com/docs/warehouse-actions/) syncs from outside RudderStack and integrate them with your existing Airflow workflows.
...
### Where can I find the source ID for my warehouse source?

The source ID is a unique identifier for any source set up in RudderStack. 

To obtain the source ID, go to the configured Warehouse Actions source in your RudderStack dashboard and navigate to the **Settings** tab.

<img src="../../assets/warehouse-actions-sources/source-id.png" alt="Source ID for warehouse sources" />
