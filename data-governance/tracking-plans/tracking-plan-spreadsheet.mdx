...
2. Specify the following settings under **Global Settings** (applicable for **all** events):
...
<img src="../../assets/data-governance/tracking plan-permissions.png" alt="Google Apps permissions" />
