...
**Refer to the <a href="https://rudderstack.com/docs/data-governance/rudderstack-data-governance-api/">RudderStack Data Governance API</a> reference for the detailed technical documentation.**
...
For more information on the RudderStack Data Governance API, please feel free to [contact us](mailto:%20docs@rudderstack.com). You can also start a conversation in our [Slack](https://rudderstack.com/join-rudderstack-slack-community) community, and we will be happy to help you.
