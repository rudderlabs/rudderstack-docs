...
- **Missing fields**
- **Capitalization/Casing errors** - e.g., one event sets the product name in the lower case, while another sets it in the upper case.
- **Unit errors** - e.g., one event tracks the revenue in pounds, while another tracks it in dollars.
...
Refer to this <a href="https://rudderstack.com/blog/rudderstacks-data-governance-api">RudderStack Blog</a> for step-by-step explanation and usage of the Data Governance API.
</div>
