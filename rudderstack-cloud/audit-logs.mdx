---
# slug: "/docs/get-started/audit-logs"
title: "Audit Logs"
...
**Audit Logs** provides you with complete transparency of the user activities happening within your RudderStack workspace. These activities include user actions related to creating and modifying sources, destinations, transformations, teams, and multi-factor authentication (MFA).

<div class="infoBlock">
The Audit Logs feature is only available for the users with enterprise-only plan. For more information on this plan and its features, refer to the RudderStack <a href="https://rudderstack.com/pricing/"><strong>pricing</strong></a> page.
</div>
...
- **User**: Name and email of the user in the existing RudderStack workspace.
- **Action**: User action performed on the entity.
- **Target**: Entity name, that is, name assigned to the source, destination, transformation, etc.
