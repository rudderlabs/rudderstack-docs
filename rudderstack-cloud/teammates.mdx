...
Teammates feature in RudderStack Cloud lets you add and manage other users in your current workspace. It also enables easier collaboration between you and other members of your team or organization.

The below table specifies the number of teammates you can add to your workspace in each RudderStack Cloud plan:
...
<div class="successBlock">
  ...
  complete list of the supported features or upgrade the <a href="https://app.rudderstack.com/profile/billing">free plan</a>.
</div>
...
1. Click on the **Teammates** option in the left navigation bar and click on **Invite Teammate** button:
...
| [Connections](https://rudderstack.com/docs/connections/)     | Yes  | No  | No     | No     |
...
A user with the read-write privileges has all the permissions as a view-only user. Additionally, (s)he has permissions for different workspace features and options, as mentioned below:
...
| [Connections](https://rudderstack.com/docs/connections/)      | Yes  | Yes | Yes    | Yes    |
| [Transformations](https://rudderstack.com/docs/transformations/) | Yes  | Yes | Yes    | Yes    |


### Admin

This user role has complete access to the RudderStack workspace, including all the options and features in the current plan. The permissions for this role are listed below:
...
| Option          | View-only | Read-write | Admin |
| :-------------- | :--- | :-- | :----- | :----- |
...
| Delete pending inviation | No  | No | Yes  |
