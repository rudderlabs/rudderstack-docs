...
Teammates feature lets you add and manage other users in your current workspace. It also enables easier collaboration between you and other members of your team or organization.
...
A read-write user has all the permissions of a view-only user. Additionally, (s)he has permissions for different workspace features and options, as mentioned below:
