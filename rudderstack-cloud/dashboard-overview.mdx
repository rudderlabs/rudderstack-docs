...
As the name suggests, this option helps you in getting started with your RudderStack journey by adding a source, cloud destination or warehouse destination using the respective options.
