...
As the name suggests, this option helps you in getting started with your RudderStack journey by adding a source, destination or a warehouse destination by using the respective options.
