...
This option provides certain details related to your RudderStack account and also lets you edit that information.

<img src="../assets/rs-cloud/settings-dashboard.png" alt="Settings in RudderStack dashboard" />

### General

It displays your account general settings like name, email and password. You can also change the name and password from here. 

### Teammates

This option displays all your teammates with their access permissions in the current RudderStack workspace. You can also invite your teammates by using the **Invite Teammate** button.
...
It lets you see and edit your workspace and company name associated with RudderStack.
