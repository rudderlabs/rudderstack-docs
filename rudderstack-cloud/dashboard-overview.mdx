...
This option lets you configure and connect different sources and destinations to build efficient data pipelines across your entire customer data stack.
