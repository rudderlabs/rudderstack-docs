...
A **source** refers to a platform or an application (web, mobile, server-side, or a third-party cloud app) from where RudderStack can track and collect the event data.
