...
In RudderStack, a **source** refers to a platform or an application (web, mobile, server-side, or a third-party cloud app) from where RudderStack can track and collect the event data.
...
<div class="successBlock">
  ...
  RudderStack classifies its sources into the following
  categories:
  <ul>
    <li>
...
<img src="../assets/rs-cloud/rudderstack-source-details.png" alt="RudderStack source details" />
