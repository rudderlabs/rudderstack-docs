...
To contribute to the docs, you may need to install RudderStack on your machine. You can do so by following our [**docs**](https://docs.rudderstack.com/rudderstack-open-source/installing-and-setting-up-rudderstack) and set up RudderStack in no time.
