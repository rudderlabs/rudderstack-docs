...
| `originalTimestamp` | DateTime | Required | Records the time when the event was emitted in the SDK. Make sure it conforms to the ISO 8601 date format `yyyy-MM-ddTHH:mm:ss.SSSZ`. For e.g., `2022-02-01T19:14:18.381Z`.                                                                            |
...
<code class="inline-code">sentAat</code> &gt; <code class="inline-code">originalTimestamp</code> is <strong>always true</strong>. However, <code class="inline-code">timestamp</code> can be more or less than the <code class="inline-code">originalTimestamp</code>.
</div>
