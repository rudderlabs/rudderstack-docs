...
* Set up a source and destination in RudderStack by following [**this guide**](https://www.rudderstack.com/docs/rudderstack-cloud/destinations/#adding-a-destination). 
