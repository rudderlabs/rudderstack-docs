...
The **RudderStack Test API** offers two endpoints to verify successful event transformation and delivery for a given source-destination setup, without having to refer to the [**Live Events**](https://rudderstack.com/docs/rudderstack-cloud/live-events/) tab.
...
* You need to set up a source-destination connection in RudderStack. For more details, refer to [**this guide**](https://rudderstack.com/docs/rudderstack-cloud/connections/).
