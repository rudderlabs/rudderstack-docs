...
* You need to set up a source-destination connection in RudderStack. For more details, refer to [**this guide**](https://www.rudderstack.com/docs/rudderstack-cloud/destinations/#adding-a-destination).
