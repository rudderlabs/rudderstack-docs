...
The **RudderStack Test API** offers two endpoints to verify successful event transformation and delivery for a given source-destination setup, without having to refer to the [**Live Events**](https://www.rudderstack.com/docs/rudderstack-cloud/live-events/) tab.
...
* You need to set up a source-destination connection in RudderStack. For more details, refer to [this guide](https://www.rudderstack.com/docs/get-started/).

* You need to generate a [**Personal Access Token**](https://rudderstack.com/docs/rudderstack-api/personal-access-tokens/) to authenticate the API successfully.
...
* [**Amazon Kinesis**](https://rudderstack.com/docs/destinations/streaming-platforms/amazon-kinesis/)
* [**Apache Kafka**](https://rudderstack.com/docs/destinations/streaming-platforms/kafka/)
* [**Azure Event Hub**](https://rudderstack.com/docs/destinations/streaming-platforms/azure-event-hubs/)
* [**Amazon Kinesis Firehose**](https://rudderstack.com/docs/destinations/streaming-platforms/amazon-kinesis-firehose/)
* [**Amazon EventBridge**](https://rudderstack.com/docs/destinations/streaming-platforms/amazon-eventbridge/)
* [**Amazon Personalize**](https://rudderstack.com/docs/destinations/analytics/aws-personalize/)
* [**Confluent Cloud**](https://rudderstack.com/docs/destinations/streaming-platforms/confluent-cloud/)
* [**Google Pub/Sub**](https://rudderstack.com/docs/destinations/streaming-platforms/google-pub-sub/)
