...
When developing a new integration for RudderStack, you need to submit a pull request (PR) to a couple of RudderStack repositories. For more details on submitting these PRs, refer to our [**step-by-step guide**](https://rudderstack.com/docs/user-guides/how-to-guides/how-to-submit-an-integration-pull-request).

## Contact us

For more information on any of the sections covered in this guide, feel free to [**contact us**](mailto:%20docs@rudderstack.com) or start a conversation in our [**Slack**](https://rudderstack.com/join-rudderstack-slack-community) community.
