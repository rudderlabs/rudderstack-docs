...
This feature is supported for all the destinations that support sending data via the <a href="https://rudderstack.com/docs/rudderstack-cloud/rudderstack-connection-modes/#cloud-mode">cloud mode</a>, including <a href="https://rudderstack.com/docs/data-warehouse-integrations/">warehouse destinations</a>.
</div>
...
<img src="../../assets/user-guides/dynamic-config-field-mapping.png" />
...
Follow our guide on <a href="https://rudderstack.com/docs/rudderstack-cloud/destinations/#adding-a-destination">Adding a Destination</a> guide for more information.
</div>
