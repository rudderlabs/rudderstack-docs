...
You can set the default configuration value as per your requirement. In case of a string, set the value within double quotes.
...
<div class="successBlock">
  ...
  You can also pass <strong>mapped fields</strong> as the default configuration value.
</div>
