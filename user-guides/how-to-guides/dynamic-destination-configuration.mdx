...
<div class="successBlock">
  ...
  This feature is supported for all the destinations in <a href="https://rudderstack.com/docs/rudderstack-connection-modes/#cloud-mode">cloud mode</a>, including <a href="https://rudderstack.com/docs/data-warehouse-integrations/">warehouse destinations</a>.
</div>
...
<div class="infoBlock">
  ...
  You will need to add a transformation that populates the configuration values for the payload path. Refer to the <a href="https://rudderstack.com/docs/user-guides/how-to-guides/dynamic-destination-configuration/#use-case">use-case</a> below for more information.
</div>

### Default value format

You can set the default configuration value as per your requirement. Note that in case of a string, you need to set the value within double quotes.
...
<div class="infoBlock">
  ...
  This feature is currently supported only for text fields. Support for mapped fields is coming soon.
</div>
...
Follow our guide on <a href="https://rudderstack.com/docs/rudderstack-cloud/connections/">Adding a source and destination in RudderStack</a> guide for more information.
</div>
