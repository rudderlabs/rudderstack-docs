...
This feature is supported for all the destinations that support sending data via the <a href="https://rudderstack.com/docs/connections/rudderstack-connection-modes/#cloud-mode">cloud mode</a>, including <a href="https://rudderstack.com/docs/data-warehouse-integrations/">warehouse destinations</a>.
</div>
...
You can set the default configuration value as per your requirement. In case of a string, you need to set the value within double quotes.

<div class="successBlock">
  
  You can pass <strong>strings</strong> or <strong>custom mappings</strong> as the default value.
</div>
