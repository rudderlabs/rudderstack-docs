...
<div class="successBlock">
  ...
  You can use this feature for all RudderStack destinations in cloud mode - including <a href="https://rudderstack.com/docs/data-warehouse-integrations/">warehouse destinations</a>.
</div>
...
<div class="infoBlock">
  ...
  This is now supported only for text fields. Mapped fields support is coming soon.
</div>
