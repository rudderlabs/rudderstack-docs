...
This feature is currently supported only for cloud mode integrations. For more information on the cloud mode, refer to the <a href="https://rudderstack.com/docs/rudderstack-connection-modes/">RudderStack Connection Modes</a> guide.
</div>
