...
Check if the destination is already available in RudderStack destinations. If not, add a new destination by following our <a href="https://rudderstack.com/docs/rudderstack-cloud/connections/">Adding a New Destination Definition</a> tutorial.
