...
Check if the destination is already available in RudderStack destinations. If not, add a new destination by following our <a href="https://www.rudderstack.com/docs/rudderstack-cloud/destinations/#adding-a-destination">Adding a New Destination Definition</a> tutorial.
