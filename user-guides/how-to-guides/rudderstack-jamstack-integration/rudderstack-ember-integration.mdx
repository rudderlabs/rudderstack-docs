...
This guide assumes you have installed and set up your Ember.js app. Refer to the [Ember.js documentation]() for more information.
...
1. Deploy your Ember.js app. Then, open the local URL on your browser to view the app.
