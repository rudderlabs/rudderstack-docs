...
description: >-
  Step-by-step guide to integrate RudderStack with your Nuxt.js app for event tracking.
---

# How to Integrate Rudderstack with Your Nuxt.js App

This guide will help you integrate RudderStack with your Nuxt.js app using the [JavaScript SDK](https://rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/). On successful integration, you can track and send real-time user events to your preferred destinations via RudderStack.

To set up the event stream on your Nuxt.js app, you need to perform the following steps:

1. [Integrate the JavaScript SDK with your Nuxt.js app and set up the tracking code](#integrating-the-javascript-sdk-with-your-hugo-site)
...
1. Include the following snippet in the `nuxt.config.js` file in your app's folder:
...
2. Open the local server URL on your browser to view the app.
...
4. Click on various links on the app to track different events.
