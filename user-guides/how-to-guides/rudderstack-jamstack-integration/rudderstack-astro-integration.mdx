...
This guide assumes you have installed and set up your Astro site. Refer to the [Astro documentation]() for more information.
...
1. Deploy your Astro site. Then, open the local URL on your browser to view the app.
