...
This source will be used to track the events from your Next.js appFollow these steps to set up a JavaScript source in your [**RudderStack dashboard**](https://app.rudderstack.com/):
