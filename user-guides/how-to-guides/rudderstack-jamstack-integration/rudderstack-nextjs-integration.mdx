...
- [Integrating the JavaScript SDK with your Next.js app](#step1)

- [Configuring a destination in RudderStack](#step2)

- [Deploying your Next.js app and verifying the events](#step3)
...
## <a name="step1">Integrating the JavaScript SDK with your Next.js app</a>

Integrating the JavaScript SDK with your Next.js app involves the following steps:

- [Creating a JavaScript source in RudderStack](#step1.1)
- [Installing and configuring the JavaScript SDK in your app](#step1.2)

### <a name="step1.1">Creating a JavaScript source in RudderStack</a>

The JavaScript source will be used to track the events from your Next.js app. Follow these steps to set it up in your [**RudderStack dashboard**](https://app.rudderstack.com/):
...
### <a name="step1.2">Installing and configuring the JavaScript SDK in your app</a>
...
4. Select the JavaScript source configured in the above section and integrated with your Next.js app.
...
## <a name="step3">Deploying your Next.js app and verifying the events</a>
