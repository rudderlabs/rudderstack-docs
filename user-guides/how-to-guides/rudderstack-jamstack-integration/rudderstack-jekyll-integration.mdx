...
You must have installed and set up your Jekyll site already. You can also refer to the official [**Jekyll documentation**](https://jekyllrb.com/docs/installation/) for more information on setting up the site.
...
### Installing the JavaScript SDK in your Jekyll site
