...
This guide assumes you have installed and set up your Vue app. Refer to the [Vue documentation]() for more information.
...
1. Deploy your Vue app. Then, open the local URL on your browser to view the app.
...
3. Click on the various links or pages in your app for RudderStack to track these actions.
