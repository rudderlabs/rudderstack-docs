...
1. Open your `index.html` file and add the following code within the `head` tag:
...
1. From your terminal, navigate to the folder containing your Eleventy site.
2. Deploy your site by running the following command:

```bash
npx @11ty/eleventy --serve
```

3. Open your Eleventy site by going to the local server URL (generally `http://localhost:8080/`) on your browser.
...
5. Click on various links on the app to track different events.
