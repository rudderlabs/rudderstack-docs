...
<div class="successBlock">
  ...
  You can use the rest of your code without any changes as the RudderStack API is fully compatible with Segment.
      ...
      <TabPanel>
      <ul>
      <li>Change your .NET project's <strong>Dependencies</strong> to include the <code class="inline-code">RudderAnalytics</code> package via <a href="https://docs.microsoft.com/en-us/nuget/consume-packages/install-use-packages-powershell">NuGet</a>, as shown:  
      
      <img src="../../assets/user-guides/segment-rudder-migration-dotnet-dependencies.png" alt=".NET dependencies" />
      </li>
