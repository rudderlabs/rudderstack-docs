...
description: Step-by-step guide to migrate from Segment to RudderStack.
---
...
Start with creating an account in [RudderStack](https://app.rudderstack.com/signup?type=freetrial). You will then see the following dashboard containing your data plane URL required to [set up your data plane](#setting-up-the-rudderstack-data-plane):

<img src="../../assets/rudderstack-dashboard.png" alt="RudderStack dashboard" />
...
RudderStack requires a data plane for the events to flow through. By [signing up](https://app.rudderstack.com/signup?type=freetrial) for RudderStack, ‌you get a RudderStack-hosted data plane which you can use to update your existing SDK implementations.
...
<div class="successBlock">
  ...
  You can use the rest of your code as is, as RudderStack SDK API is fully compatible
  with Segment.
</div>
      </TabPanel>
      <TabPanel>
...
You can use the rest of your code as is, as the RudderStack SDK API is fully compatible with Segment.
</div>        
      </TabPanel>
      <TabPanel>
<ul>
...
Stuck somewhere in the migration process? [Contact us](mailto:%20support@rudderstack.com) or start a conversation in our [Slack](https://rudderstack.com/join-rudderstack-slack-community) community.
