...
Start with creating an account in [RudderStack](https://app.rudderstack.com/signup?type=freetrial). You will then see the following dashboard containing your data plane URL:
