...
For more information on how to enable the <code class="inline-code">anonymousIdOptions</code> object, refer to the [Capturing anonymousId automatically](https://www.rudderstack.com/docs/stream-sources/rudderstack-sdk-integration-guides/rudderstack-javascript-sdk/#capturing-anonymousid-automatically) section.
</div>
