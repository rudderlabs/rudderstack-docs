...
Follow the guide on <a href="https://rudderstack.com/docs/rudderstack-cloud/connections/">How to Add a Source and Destination in RudderStack</a> for more details on adding a source in RudderStack.
</div>
