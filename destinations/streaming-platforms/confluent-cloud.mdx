...
<img src="../../assets/screenshot-2020-11-27-at-1.28.49-pm.png" /><span class="imageTitle">Confluent Cloud connection settings</span>
...
If you come across any issues while configuring Confluent Cloud with RudderStack, please feel free to [contact us](mailto:%20docs@rudderstack.com) or start a conversation in our [Slack](https://rudderstack.com/join-rudderstack-slack-community) community. We will be happy to help you.
