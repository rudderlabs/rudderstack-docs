...
- **Use device-mode to send events**: Enable this option to send events via the [**Device mode**](https://rudderstack.com/docs/connections/rudderstack-connection-modes//).
