...
- **API Key**: Enter your Airship token which is required by RudderStack to communicate with your Airship project and authenticate all the supported event calls, i.e.[`identify`](#identify), [`track`](#track), and [`group`](#group).
