...
Find the open-source transformer code for this destination in our <a href="https://github.com/rudderlabs/rudder-transformer/tree/master/v0/destinations/airship">GitHub repository</a>.
</div>
...
- **API Key**: Enter your Airship token which is required by RudderStack to communicate with your Airship project.
...
- **App Key**: Enter your Airship project's app key by going to **Settings** > **Project Details** in the Airship dashboard.
- **App Secret**: Enter your Airship project's app secret by going to **Settings** > **Project Details** in the Airship dashboard.
...
You will find your project's app key listed here. To obtain the app secret, click on **Click to reveal**, as shown:
