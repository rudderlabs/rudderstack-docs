...
The <code class="inline-code">page</code> calls are only supported in the RudderStack device mode. For more information on the RudderStack device mode, refer to the <a href="https://rudderstack.com/docs/rudderstack-cloud/rudderstack-connection-modes/">RudderStack Connection Modes</a> guide.
...
The <code class="inline-code">screen</code> calls are only supported in the RudderStack cloud mode. To know more about the RudderStack cloud mode, refer to the <a href="https://rudderstack.com/docs/rudderstack-cloud/rudderstack-connection-modes/">RudderStack Connection Modes</a> guide.
</div>
...
Adding or subscribing users to a specific list is only available in cloud mode integration. To know more about the RudderStack cloud mode, read the <a href="https://rudderstack.com/docs/rudderstack-cloud/rudderstack-connection-modes/">RudderStack connection modes</a> guide.
</div>
