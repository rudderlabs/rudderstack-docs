...
<div class="infoBlock">
 ...
 You can also send the subject via the <code class="inline-code">integrations</code> object in the <code class="inline-code">track</code> call. For more information on the <code class="inline-code">integrations</code> object, refer to the <strong>Track</strong> section below.
</div>
...
You can also set the Template ID via the <code class="inline-code">integrations</code> object in the <code class="inline-code">track</code> call. Note that the template ID passed via the <code class="inline-code">integrations</code> object will override the ID specified in the RudderStack dashboard.
</div>
...
This option is only useful when the <code class="inline-code">integrations</code> object is empty. SendGrid also requires either the <code class="inline-code">templateId</code> or <code class="inline-code">content</code> to be present for a successful event delivery. 
</div>
...
You can also send the email and name inside <code class="inline-code">replyTo</code> via the <code class="inline-code">integrations</code> object. Note that these fields will override the <strong>Reply To Email</strong> and <strong>Reply To Name</strong> fields set in the RudderStack dashboard.
</div>
...
You can additionally include <code class="inline-code">email</code> and <code class="inline-code">name</code> inside the <code class="inline-code">from</code> object via the <code class="inline-code">integrations</code> object (shown below). Note that this will override the fields specified in the RudderStack dashboard.
</div>
...
The <code class="inline-code">content</code> array can also be sent via <code class="inline-code">integrations</code> object (shown below), which will override the dashboard settings.
</div>
...
SendGrid requires that each attachment element must contain <strong>content</strong> and <strong>filename</strong> The attachments can also be sent via the <code class="inline-code">integrations</code> object (shown below) which will override the dashboard settings.
</div>
...
The footer can also be sent via <code class="inline-code">integrations</code> object (shown below), which will override the dashboard settings.
</div>
...
The sandbox mode can also be enabled or disabled via the <code class="inline-code">integrations</code> object (shown below), which will override the dashboard setting.
</div>
