...
<div class="infoBlock">
 ...
 You can also send the subject via the <code class="inline-code">integrations</code> object in the <code class="inline-code">track</code> call. For more information on the <code class="inline-code">integrations</code> object, refer to the <strong>Track</track> section below.
</div>
