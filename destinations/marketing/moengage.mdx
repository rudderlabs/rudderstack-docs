...
```
 ...
 <li>Add the following in <code class="inline-code">buildscript</code> dependencies in <code class="inline-code">android/build.gradle</code> (Module: Project) file:
<span>
...
```
 ...
 <li>Also, add the below plugin to the top of the <code class="inline-code">android/app/build.gradle</code> (Module: app):
<span>
