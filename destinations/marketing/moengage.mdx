...
```
      ...
      <TabPanel>
Follow these steps to add MoEngage to your Android project and enable its full functionality, like push notifications:
<ol>
...
<li>Initialize the MoEngage SDK in the <code class="inline-code">Application</code> class's <code class="inline-code">onCreate()</code> method as following:
<span>
...
<li>Add the following under the dependencies section of the <code class="inline-code">app/build.gradle</code> (Module: Project) file in the Android folder of your React Native project:
<span>
...
<li>In the <code class="inline-code">app/build.gradle</code> (Module: Project) file, add the following:
<span>
...
```
 ...
 <li>Add the following in <code class="inline-code">buildscript</code> dependencies in <code class="inline-code">build.gradle</code> (Module: Project) file:
<span>
