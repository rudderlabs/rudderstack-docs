...
This destination is ideal for your <a href="https://rudderstack.com/docs/warehouse-actions/">Warehouse Actions</a> sources, as it only accepts <code class="inline-code">identify</code> events.
</div>
...
This field should be present in all the events sent to Marketo Lead Import for de-duplication to happen properly.
</div>
