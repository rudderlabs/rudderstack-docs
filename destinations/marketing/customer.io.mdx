...
<img src="../../assets/customerio-device-token.png" alt="Customer.io device token settings" />
...
<img src="../../assets/customerio-siteid-apikey.png" alt="Customer.io site ID and API key" />
