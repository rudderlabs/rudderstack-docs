...
[**Post Affiliate Pro**](https://https://www.postaffiliatepro.com/) is a popular affiliate marketing software that lets you manage your affiliate programs, track their performance, and boost your lead generation efforts.
...
If you set the <strong>Affiliate Link ID</strong> value to <code class="inline-code">affiliateId</code> and the <strong>AffiliateId Parameter Name</strong> to <code class="inline-code">aff_id</code>, then the anchor link of the domain where you want to send the affiliate/referrer ID of the affiliate will be converted to:  <code class="inline-code">http://abcd.com/?aff_id=<your_affiliate_id>"id="affiliateId"</code>.
</div>

#### Cookie to Link settings

* **Cookie Link ID**: Enter your cookie link ID here, e.g. `cookieLinkId`. This refers to the ID of the DOM object where the cookie ID is added.

* **Cookie Parameter Name**:  Enter the cookie parameter name here, e.g. `PAPcookie`.
