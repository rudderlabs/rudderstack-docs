...
If you set the <strong>Affiliate Link ID</strong> value to <code class="inline-code">affiliateId</code> and the <strong>AffiliateId Parameter Name</strong> to <code class="inline-code">aff_id</code>, then the anchor link of the domain where you want to send the affiliate/referrer ID of the affiliate will be converted to:  <code class="inline-code"><a href=“http://abcd.com/?aff_id=<the affiliate Id>” id=“affiliateId”></a></code>.
</div>
