...
Yes, you can. Both the integrations are the sub-features of Google Ads and hence you can use the same Google Ads account to configure them as destinations in RudderStack.
