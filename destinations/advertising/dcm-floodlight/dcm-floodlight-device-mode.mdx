...
if category and name is passed in page we have to slightly modify the event name in webapp config. i.e Instead of Viewed PAGE NAME Page which we pass for normal page call, enter it as: Viewed CATEGORY NAME PAGE NAME **Page
