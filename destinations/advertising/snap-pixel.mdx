...
To know more about the difference between Cloud mode and Device mode in RudderStack, refer to the [**RudderStack connection modes**](https://rudderstack.com/docs/rudderstack-connection-modes/) guide.
</div>
