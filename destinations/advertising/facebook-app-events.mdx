...
The above <code class="inline-code">page</code> call is directly passed on to Facebook as a <code class="inline-code">track</code> event via its <code class="inline-code">logEvent</code> API, with the event name as <code class="inline-code">Viewed Page</code> along with the the associated properties.
</div>
