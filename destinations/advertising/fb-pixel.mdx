...
A string is the only valid data type for the <code class="inline-code">category</code> field. However, you can pass an array of string values by concatenating them using a delimiter ( , ).
</div>
