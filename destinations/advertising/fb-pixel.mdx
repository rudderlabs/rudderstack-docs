...
<img src="../../assets/event-stream-destinations/fb-pixel-connection-settings-1.png" alt="Facebook Pixel connection settings" />
...
<img src="../../assets/event-stream-destinations/fb-pixel-connection-settings-2.png" alt="Facebook Pixel connection settings" />
...
<img src="../../assets/event-stream-destinations/fb-pixel-connection-settings-3.png" alt="Facebook Pixel connection settings" />
...
<img src="../../assets/event-stream-destinations/fb-pixel-connection-settings-4.png" alt="Facebook Pixel connection settings" />
...
<img src="../../assets/event-stream-destinations/fb-pixel-connection-settings-5.png" alt="Facebook Pixel connection settings" />
...
A <code class="inline-code">string</code> is the only valid data type for <code class="inline-code">category</code> field. However, you can pass an array of string values by concatenating them using a delimiter ( , ).
</div>
