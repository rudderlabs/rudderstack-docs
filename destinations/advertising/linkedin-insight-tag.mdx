...
This integration is a Device mode-only destination for the web (JavaScript) source. For more information on what a Device mode is, refer to the <a href="https://rudderstack.com/docs/rudderstack-connection-modes/">RudderStack Connection Modes</a> guide.
...
Follow our <a href="https://rudderstack.com/docs/rudderstack-cloud/connections/">How to Add a Source and Destination in RudderStack</a> for more details.
