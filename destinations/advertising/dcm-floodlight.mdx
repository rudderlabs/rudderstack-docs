...
In your Campaign Manager dashboard, go to **Floodlight** > **Activities**. Here you can see the all the activity names along with their **Activity tag string** (`cat`) and Group tag string (`type`), as shown:
