...
There are two types of tags:
    ...
    <li><strong>Sales tag</strong>: Used to count the number of conversions. It is supposed to be placed on the confirmation page after a sale with information about the sales, like `cost`,`qty`, or `ord` properties passed to the tag.</li> 
        </ul>
</div>
...
```
The following table details the mapping of `integrations` object (in the above code snippet), for DCM Floodlight:

| **RudderStack Property** | **DCM Floodlight Property** |
| :--- | :--- |
| `COPPA`| `tag_for_child_directed_treatment`  |
| `GDPR` | `tfua` | 
| `npa` | `npa` | 
