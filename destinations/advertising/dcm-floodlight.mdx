...
There are two types of tags as explained below:
<ul>
<li>Counter tag - Used to count the number of conversions.</li>
<li>Sales Tag - Same as counter tag except it is supposed to be placed on the confirmation page after a sale with information about the sale like <code class="inline-code">cost</code>,class="inline-code">qty</code> , class="inline-code">ord</code> passed to the tag.</li>
</div>
...
```
Accepted names for Integrations object:
