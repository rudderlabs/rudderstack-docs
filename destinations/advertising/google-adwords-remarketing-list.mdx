...
- **Developer Token**: Enter the developer token required to connect your app to the Google Ads API. 

<div class="infoBlock">

To get the developer token, you need to sign in to your <a href="https://ads.google.com/home/tools/manager-accounts">manager account</a>. For more information on obtaining the developer token, refer to the <a href="https://developers.google.com/google-ads/api/docs/first-call/dev-token">Google Ads</a> documentation.
</div>
...
The Google Adwords Remarketing Lists destination supports only <code class="inline-code">audiencelist</code> calls.
</div>
...
### Where can I find the Google Adwords developer token?

To obtain your developer token, sign in to your [manager account](). Then, navigate to **Tools & settings** > **Setup** > **API Center**. You will find the token under the **API Access** section, as shown:

<img src="../../assets/event-stream-destinations/google-adwords-remarketing-lists-developer-token.png" alt="Google Adwords Remarketing Lists (Customer Match) connection settings" />

<div class="infoBlock">

This option appears only for the manager accounts in Google Ads.
</div>
