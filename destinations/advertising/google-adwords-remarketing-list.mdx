...
For the integration to be successful, make sure the account used for OAuth verification has **Standard** or higher (**Administrative**) access levels in Google Ads. 

For more information, refer to this [Google Ads support page](https://support.google.com/google-ads/answer/9978556?visit_id=637611563637058259-4176462731&rd=1).
