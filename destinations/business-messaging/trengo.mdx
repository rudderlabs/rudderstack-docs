...
Follow our guide on <a href="https://www.rudderstack.com/docs/rudderstack-cloud/destinations/#adding-a-destination">How to Add a Source and Destination in RudderStack</a> for details on adding a source in the RudderStack dashboard.

</div>

- Assign a name to the destination and click on **Next**. You should then see the following screen:

<img src="../../assets/trengo-config.png" /><span class="imageTitle">Trengo Connection Settings</span>
