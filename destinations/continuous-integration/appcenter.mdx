...
To add AppCenter to your Cordova project:
<ul>
...
<li>Add the platforms that you want to target your app
<span>
```bash
...
<li>Run the following command to build the project for all platforms:
<span>
```bash
cordova build
```
...
<li>Add the following code in the onDeviceReady() function of your home page to initialize the SDK.
<span>
```javascript
