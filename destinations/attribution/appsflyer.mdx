...
| `products`                | We formulate the list as per List View [specification](https://support.appsflyer.com/hc/en-us/articles/115005544169#event-structure) and pass it to the property `af_content_list` |
