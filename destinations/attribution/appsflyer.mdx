...
<li><strong>If you are using AppsFlyer Android device mode version <code class="inline-code">2.0.0</code> or above</strong>, add the following lines of code in your <code class="inline-code">MainApplication()</code> class:
<span>
...
<li>If you are using the AppsFlyer React Native device mode version <strong>less than</strong> <code class="inline-code">1.1.0</code>, import the module and add it to your SDK initialization code, as shown:
<span>
...
<li>If you are using the AppsFlyer React Native device mode version <strong><code class="inline-code">1.1.0</code> or above</strong>, initialize the AppsFlyer SDK as shown:
<span>
...
// Finally, initializing the Rudder React Native SDK
await rc.setup( WRITE_KEY , config);
```
</span>
To get access to the conversion as well as the attribution data, set the properties <code class="inline-code">onInstallConversionDataListener</code> and <code class="inline-code">onDeepLinkListener</code> to <code class="inline-code">true</code> in the <code class="inline-code">setOptions</code> API, as shown in the above snippet.
</li>
...
As seen above, each of the listeners returns a function that - whenever called - removes those listeners.
</li>
<li>Depending on the React Native components you are using, you can trigger the appropriate method, as shown:
    <ul>
    <li>Trigger the <code class="inline-code">remove()</code> method in <code class="inline-code">componentWillUnMount()</code> in case of a class-based component, as shown:
<span>
...
<li>If it's a functional component, you can trigger the <code class="inline-code">useEffect()</code> hook, as shown:
<span>
