...
<li>If you are using AppsFlyer Android device mode version <code class="inline-code">2.0.0</code> or above, add the following lines of code in your <code class="inline-code">MainApplication()</code> class:
<span>
...
<li>If you are using the AppsFlyer React Native device mode version <code class="inline-code">1.1.0</code> or above, initialize the AppsFlyer SDK as shown:
<span>
...
<li>Depending on the React Native components you are using, trigger the <code class="inline-code">remove()</code> methods in <code class="inline-code">componentWillUnMount()</code> in case of a class-based component, as shown:
<span>
