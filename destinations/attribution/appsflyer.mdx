...
<li>Starting from AppsFlyer Android device mode version <code class="inline-code">2.0.0</code>, you need to add the following lines in your <code class="inline-code">MainApplication()</code> class:
<span>
...
<li>Starting from version <code class="inline-code">1.1.0</code> of the AppsFlyer React Native device mode, you need to initialize the AppsFlyer SDK as shown:
<span>
...
<li>Depending on the React Native components you are using, trigger the <code class="inline-code">remove()</code> methods in <code class="inline-code">componentWillUnMount()</code> in case of a class-based component. or in <code class="inline-code">useEffect()</code> hook if it's a functional component, as shown:
<span>
