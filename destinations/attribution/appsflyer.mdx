...
<strong>If you are using AppsFlyer iOS device mode version <code class="inline-code">2.0.0</code> or above</strong>, initialize the Appsflyer SDK before the Rudder SDK as shown below:
<span>
...
<strong>If you are using AppsFlyer Android device mode version <code class="inline-code">2.0.0</code> or above</strong>, also add the following lines of code in your <code class="inline-code">MainApplication()</code> class before initializing the Rudder SDK:
<span>
...
```
        ...
        <ol start="2">
  <strong>For AppsFlyer React Native device mode version 1.1.0 or above, follow the subsequent steps:</strong>
