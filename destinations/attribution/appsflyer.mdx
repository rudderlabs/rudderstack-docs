...
<li>Starting from AppsFlyer iOS device mode version <code class="inline-code">2.0.0</code> and above</strong>, the RudderStack SDK <strong>does not</strong> automatically initialize the AppsFlyer SDK. You need to initialize the AppsFlyer SDK as shown:
<span>
...
<ol>
<li>Add the <code class="inline-code">mavnCentral()</code> repository, as shown:
<span>
...
<li>Starting from AppsFlyer Android device mode version <code class="inline-code">2.0.0</code> and above</strong>, the RudderStack SDK <strong>does not</strong> automatically initialize the AppsFlyer SDK. You need to initialize the AppsFlyer SDK as shown:
<span>
