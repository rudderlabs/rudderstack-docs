...
| :------------------ | :------------ | :------------ | :------------ |
| **Device mode**     | -             | **Supported (Recommended)** | -             |
...
You can find more information on this field in this <a href="https://support.appsflyer.com/hc/en-us/articles/207034486-Server-to-server-events-API-for-mobile-S2S-mobile-#sharing_filter-16">AppsFlyer Help Center</a> page.
</div>
...
If you are connecting a source other than <strong>Android</strong> or the <strong>Apple</strong> sources (iOS, watchOS, iPadOS, tvOS), then you need to add a user transformation that adds the OS information needed in the events.
