...
- **App ID**: RudderStack supports all the sources for the AppsFlyer destination. If you are connecting a source other than **Android** or the **Apple** sources (iOS, watchOS, iPadOS, tvOS), then you need to add a user transformation to manipulate the OS information.
