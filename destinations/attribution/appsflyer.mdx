...
```
 ...
 <div class="infoBlock">
  ...
  <strong>If you are using AppsFlyer Android device mode version <code class="inline-code">2.0.0</code> or above</strong>, also add the following lines of code in your <code class="inline-code">MainApplication()</code> class:
<span>
