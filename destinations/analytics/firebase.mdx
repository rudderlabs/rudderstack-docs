...
<div class="warningBlock">
  ...
  Firebase is a device-mode only integration. To know more about the difference between cloud mode and device mode in RudderStack, refer to the <a href="https://rudderstack.com/docs/rudderstack-connection-modes/">RudderStack connection modes</a> guide.
</div>
...
Refer to the <a href="https://rudderstack.com/docs/rudderstack-cloud/connections/">Adding a source and destination in RudderStack</a> guide for more information.
</div>
