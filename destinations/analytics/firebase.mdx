...
RudderStack bundles <code class="inline-code">Firebase/Core</code> and <code class="inline-code">FirebaseAnalytics</code> by default with the <code class="inline-code">Rudder-Firebase</code> pod.
</div>
    </TabPanel>
    <TabPanel>
...
```
    ...
    <TabPanel>
      <div class="infoBlock">
        ...
        To add Firebase to your React Native project, follow these steps:
<ol>
...
Firebase enforces a <a href="https://firebase.google.com/docs/reference/cpp/group/event-names#summary">strict event name length limit</a>of up to 40 characters. RudderStack takes a substring of 40 characters (from the beginning) if the event names exceed this permitted value.
</div>
