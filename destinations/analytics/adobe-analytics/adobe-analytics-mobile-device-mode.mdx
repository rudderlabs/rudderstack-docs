...
<div class="successBlock">
  ...
  Mobile <a href="https://rudderstack.com/docs/rudderstack-connection-modes/#device-mode"> device mode </a> refers to using the Android or iOS SDK to send your events directly to Adobe Analytics.
</div>
