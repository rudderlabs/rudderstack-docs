...
```
      ...
      <TabPanel>
        To add Amplitude to your ReactNative project:
<ul>
...
<li>Open your <code class="inline-code">android/app/build.gradle</code> (Module: app) file, and add the following under the <code class="inline-code">compileOptions</code> in android tag :
<span>
