...
Session tracking is only supported for [device mode](https://rudderstack.com/docs/connections/rudderstack-connection-modes/#device-mode) because the integration loads Amplitude's SDK. Events from [cloud mode](https://rudderstack.com/docs/connections/rudderstack-connection-modes/#cloud-mode) connections will have Session IDs of `-1`.
