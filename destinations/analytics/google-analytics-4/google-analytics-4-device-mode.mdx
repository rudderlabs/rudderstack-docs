...
In order to send events to Google Analytics 4 via the device mode, you need to select `gtag.js` as the **Client Type** and enable **Use device-mode to send events** in the Rudderstack dashboard.
