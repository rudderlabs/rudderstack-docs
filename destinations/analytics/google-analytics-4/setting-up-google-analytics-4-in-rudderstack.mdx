...
<div class="infoBlock">
 ...
 If you are using the <code class="inline-code">gtag</code>, <strong>API Secret</strong> and <strong>Measurement Id</strong> are the required fields. However, if you are using the <code class="inline-code">firebase</code> client, <strong>Firebase App Id</strong> and <strong>API Secret</strong> are the required fields.
  </div>
