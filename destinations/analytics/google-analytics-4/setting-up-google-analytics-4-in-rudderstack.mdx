...
- **API Secret**: This field is only required for cloud mode setup and needs you to enter the API Secret generated through the Google Analytics dashboard. It can be created in the Google Analytics dashboard under **Admin > Data Streams > choose your stream > Measurement Protocol > Create**.
