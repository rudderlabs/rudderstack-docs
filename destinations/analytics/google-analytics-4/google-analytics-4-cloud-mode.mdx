...
Google Analytics 4 has some reserved events names which cannot be used. Refer to the [Google document](https://support.google.com/analytics/answer/10085872#zippy=%2Cweb%2Cin-this-article%2Creserved-prefixes-and-event-names) for complete list of reserved event names.
