...
RudderStack lets you send your event data to Google Analytics 4 destination via the Cloud mode. It supports both `gtag` and `firebase` to tag the websites in the Cloud mode.
...
<table>
  ...
  <tr>
   ...
   <tr>
    ...
    <td><code class=“inline-code”>view_item</code></br><code class=“inline-code”>add_cart</code></br><code class=“inline-code”>remove_from_cart</code></br><code class=“inline-code”>view_cart</code></br><code class=“inline-code”>begin_checkout</code></br><code class=“inline-code”>add_to_wishlist</code></td>
