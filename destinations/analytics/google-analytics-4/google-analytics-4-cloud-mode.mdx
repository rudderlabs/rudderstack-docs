...
### What are the reserved prefixes in Google Analytics?
...
### What are the reserved event names in Google Analytics?

Google Analytics 4 has some reserved events names which throw an error on being used. Hence, they cannot be used. Refer to the [Google document](https://support.google.com/analytics/answer/10085872#zippy=%2Cweb%2Cin-this-article%2Creserved-prefixes-and-event-names) for complete list of reserved event names.
