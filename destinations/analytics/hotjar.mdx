...
Before you can begin making calls to `identify`, <a href="https://insights.hotjar.com/settings/user-attributes">User Attributes</a> must be enabled in your Hotjar dashboard for each site. Refer to the [**Enabling and disabling User Attributes**](https://help.hotjar.com/hc/en-us/articles/360033640653-Identify-API-Reference#making_calls_to_identify) guide for more information.
