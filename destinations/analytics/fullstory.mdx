    ...
    <TabPanels>
      ...
      <TabPanel>
        ...
        <ul>
            ...
            <span>
              ...
              buildscript {
                repositories {
                    google()
                    jcenter()
                    mavel { url "https://maven.fullstory.com" }
                }
                depedencies {
          ...
          <li>If your Gradle file applies plugins, use the following snippet instead: </li>
