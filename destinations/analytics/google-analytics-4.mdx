...
- **API Secret**: Enter the API Secret generated through the Google Analytics UI.
- **Measuremt Id**: 

<div class="infoBlock">
  
 Refer to the <a href="#faq">FAQ</a> section for more information on how to obtain the Measurement Id.
  </div>
...
| RudderStack field    | Google Analytics 4 field |
| :------------------------ | :---------------------------- |
