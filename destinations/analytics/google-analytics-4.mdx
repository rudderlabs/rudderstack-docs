...
There are limits on the number of custom properties per event that can be sent to Google Analytics 4. RudderStack SDK <code class="inline-code">doesn't drop</code> the payload based on these limits.
</div>
