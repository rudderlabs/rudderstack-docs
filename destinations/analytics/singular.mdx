...
<li>Add the platforms you want to target for your app:
<span>
...
<li>Run the following command to build the app for all the platforms:
<span>
...
<li>Finally, add the following code in the <code class="inline-code">onDeviceReady()</code> function of your app's home page to initialize the SDK, as shown:
<span>
