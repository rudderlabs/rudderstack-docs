...
For more information on sending events via the Device mode, refer to the [**RudderStack connection modes**](https://rudderstack.com/docs/rudderstack-connection-modes/) guide.
</div>
