...
For more information on sending events via the RudderStack Cloud mode, refer to the [**RudderStack Connection Modes**](https://rudderstack.com/docs/rudderstack-cloud/rudderstack-connection-modes/) guide.
</div>
...
Follow our guide on [**Adding a Destination**](https://www.rudderstack.com/docs/rudderstack-cloud/destinations/#adding-a-destination) for more information.
</div>
