...
Please follow our guide on <a href="https://www.rudderstack.com/docs/rudderstack-cloud/destinations/#adding-a-destination">How to Add a Source and Destination</a> in RudderStack to add a source and destination in RudderStack.
