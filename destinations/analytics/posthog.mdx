...
<img src="../../assets/posthog-web-settings.png" /><span class="imageTitle">PostHog Web Settings in RudderStack</span>
...
- **Enable Local Storage for Persistence** - Enabling this will reduce the amount of data stored in cookies by storing it in Local Storage instead. This should reduce the amount of data we send to app.posthog.com for each event by 2-4kb, improving deliverability.

<div class="infoBlock">

Note that this feature is only useful in device mode.
