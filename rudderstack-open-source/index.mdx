...
Signing up for [RudderStack Open Source](https://app.rudderstack.com/signup?type=opensource) is the easiest way to set up and manage your data pipelines. The web app is only used for source/destination configuration and does not have access to your data. It also provides a [Live Events](https://rudderstack.com/docs/rudderstack-cloud/live-events/) feature for debugging purposes, only for a limited time.

**RudderStack does not persist any of your data**.

However, if you do not wish to sign up for RudderStack and want to self-host the source/destination configurations, you can use the open source [Control Plane Lite](https://rudderstack.com/docs/rudderstack-open-source/control-plane-lite/) utility. To set up the RudderStack server (backend) in your own environment, follow the steps listed in the [Data Plane Setup](https://rudderstack.com/docs/rudderstack-open-source/installing-and-setting-up-rudderstack) guide.

<div class="warningBlock">

The control plane set up using Control Plane Lite does not have features like <a href="https://rudderstack.com/docs/transformations">Transformations</a> and <a href="https://rudderstack.com/docs/rudderstack-cloud/live-events/">Live Events</a>.
</div>
...
If you're using open source RudderStack, you are required to set up your own data plane by [installing and setting up RudderStack](https://rudderstack.com/docs/rudderstack-open-source/installing-and-setting-up-rudderstack) in your preferred environment.
