...
Once you have completed the above steps successfully, refer to the [Sending Test Events](installing-and-setting-up-rudderstack/sending-test-events/) to verify the installation.
