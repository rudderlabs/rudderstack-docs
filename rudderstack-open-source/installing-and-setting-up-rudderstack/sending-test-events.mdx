...
- Set up a source and a destination in RudderStack by following this [**guide**](https://rudderstack.com/docs/rudderstack-cloud/connections/).
- You can find the write key in the dashboard, as shown:

<img src="../../assets/screen-shot-2021-07-01-at-5.27.53-pm.png" />
...
<img src="../../assets/screen-shot-2021-07-01-at-5.29.03-pm.png" />
...
- Set up a source and a destination by following this [**guide**](https://rudderstack.com/docs/rudderstack-cloud/connections/).
- You can find the write key associated with the source in the dashboard as shown:

<!-- <img src="../../assets/writekey.jpg)-->

<img src="../../assets/writekey.jpg" alt="Write Key" />
...
<!-- <img src="../../assets/test-event%20%281%29.jpg" /> -->

<img src="../../assets/test-event (1).jpg" alt="Test Event" />
...
- Set up a source in RudderStack by following this [**guide**](https://rudderstack.com/docs/rudderstack-cloud/connections/).
- You can find the write key in the dashboard, as shown:
...
- Set up a source by following this [**guide**](https://rudderstack.com/docs/rudderstack-cloud/connections/).
- You can find the write key associated with the source in the dashboard as shown:
...
Refer to the <a href="https://rudderstack.com/docs/rudderstack-api/http-api/">HTTP API
