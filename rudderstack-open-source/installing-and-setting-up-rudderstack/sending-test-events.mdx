...
Note that unlike RudderStack Open Source, the control plane set up using the <a href="https://rudderstack.com/docs/get-started/control-plane-lite/">Control Plane Lite</a> utility does not let you view live events.
</div>
