...
1. Set up a source and a destination in RudderStack. For more information, follow the [Adding a Destination](https://www.rudderstack.com/docs/rudderstack-cloud/destinations/#adding-a-destination) guide.
...
1. Set up a source and a destination. For more information, follow the [Adding a Destination](https://www.rudderstack.com/docs/rudderstack-cloud/destinations/#adding-a-destination) guide.
