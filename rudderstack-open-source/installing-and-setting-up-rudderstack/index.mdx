...
The control plane set up using Control Plane Lite does not have features like <a href="https://rudderstack.com/docs/transformations">Transformations</a> and the ability to view <a href="https://www.rudderstack.com/docs/get-started/live-events/">live events</a>.
</div>
