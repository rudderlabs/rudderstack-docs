...
<code class="inline-code">helm install</code> deploys RudderStack on the Kubernetes cluster configured with <code class="inline-code">kubectl</code>
</div>
...
1. Log into your [open source RudderStack dashboard](https://app.rudderstack.com/signup?type=opensource).
